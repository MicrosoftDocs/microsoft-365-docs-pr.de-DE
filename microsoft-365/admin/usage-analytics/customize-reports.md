...
2. Geben Sie den Bearbeitungsmodus ein, indem Sie oben über die Schaltfläche "Weitere Seite" in Power BI Schaltfläche die Schaltfläche **"Bearbeiten"** ![ ](../../media/d8da3c19-3f2d-4bf6-811e-faa804f74770.png) auswählen.
...
3. Wählen Sie oben rechts die Option **"Diese Seite duplizieren"** aus.

    ![Wählen Sie "Diese Seite duplizieren" aus](../../media/b2d18dcd-6b82-4ce7-ab79-1b24e3721309.png)

4. Wählen Sie unten rechts eines der Balkendiagramme aus, in dem die Anzahl der Benutzer angezeigt wird, die basierend auf dem Betriebssystem wie Android, iOS, Mac usw. aktiviert wurden.

5. Wählen Sie im Bereich **"Visualisierungen"** auf der rechten Seite das **X** daneben aus, um die **Mac-Anzahl** aus dem visuellen Element zu entfernen.
...
1. Wechseln Sie mit der linken Navigationsleiste zum Bericht **"Produktverwendung",** und wählen Sie die Registerkarte **Yammer** aus.

2. Wechseln Sie zum Bearbeitungsmodus, indem Sie ![ die Schaltfläche "Mehr Seiten" in Power BI ](../../media/d8da3c19-3f2d-4bf6-811e-faa804f74770.png) und **bearbeiten** auswählen.

3. Wählen Sie unten auf der Seite das ![Die Schaltfläche "Seite hinzufügen" in Power BI,](../../media/d3b8c117-17d4-4f53-b078-8fefc2155b24.png) um eine neue Seite zu erstellen.

4. Klicken Sie im Bereich **"Visualisierungen"** auf der rechten Seite auf das **Gestapelte Balkendiagramm** (oberste Zeile, zuerst von links).

    ![Balkendiagramm auswählen](../../media/214c3fed-6eae-43e6-83fb-708a2d74406e.png)

5. Wählen Sie die untere rechte Ecke dieser Visualisierung aus, und ziehen Sie, um sie zu vergrößern.
...
12. Wählen Sie direkt unterhalb der Liste der Visualisierungen **in** ![ Power BI Visualizaions das Symbol "Format" ](../../media/ee0602f3-3df5-4930-b862-db1d90ae4ae2.png) aus.
...
Sie können zunächst eine direkte Verbindung mit den ODATA-Berichterstellungs-APIs von Microsoft 365 herstellen, die diese Berichte unterstützen.

1. Navigieren Sie zu **Daten abrufen** \> **Sonstige** \> **ODATA-Feed** \> **Verbinden**.

2. Geben Sie im URL-Fenster "https:// <i></i> \<tenantid\> reports.office.com/pbi/v1.0/" ein.
...
3. Geben Sie Ihre Administratoranmeldeinformationen für Microsoft 365 (Organisation oder Schule) ein, um sich bei Microsoft 365 zu authentifizieren, wenn Sie dazu aufgefordert werden.

    In den [häufig gestellten Fragen](usage-analytics.md#faq) finden Sie weitere Informationen darüber, wer auf die App-Berichte Microsoft 365 Einführungsvorlage zugreifen darf.
...
Sie können die Power BI Vorlagendatei aus dem [Microsoft Download Center](https://download.microsoft.com/download/7/8/2/782ba8a7-8d89-4958-a315-dab04c3b620c/Microsoft%20365%20Usage%20Analytics.pbit)herunterladen. Nachdem Sie die Power BI Vorlagendatei heruntergeladen haben, führen Sie die folgenden Schritte aus, um zu beginnen:
