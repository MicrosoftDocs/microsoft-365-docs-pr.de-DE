...
Wenn Sie sich für Office 365 mit Ihrer persönlichen E-Mail-Adresse registrieren und das Hinzufügen [einer benutzerdefinierten Domäne](../get-help-with-domains/what-is-a-domain.md) vorerst überspringen, beschränken Sie Ihren Zugriff auf bestimmte Features.

Wenn Sie jetzt eine benutzerdefinierte Domäne hinzufügen möchten, erhalten Sie Zugriff auf alle premium-Features unten:

|**Feature**|**Office 365 mit persönlichen E-Mails**|**Office 365 mit benutzerdefinierter Domäne**|
|:-----|:-----|:-----|
|**OneDrive <sup>1, 2</sup>**| [Persönliche OneDrive](https://onedrive.live.com/about/plans/)| [OneDrive for Business](https://onedrive.live.com/about/en-us/business/) |
|**Office Anwendungen: Word, Excel, PowerPoint, OneNote, Outlook, Access (nur PC),**| Ja | Ja
|**Geschäftsanwendungen <sup>3</sup> : Microsoft Bookings und TextureIQ**| Nein | Ja
|**Zugriff auf Microsoft 365 Admin Center**| Beschränkter Zugriff (Abrechnung, Support und Domäneneinrichtung) | Ja
