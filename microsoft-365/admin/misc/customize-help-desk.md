...
3. Aktivieren Sie die **Kontaktinformationen zum Add your Help Desk**.
    
4. Sie als Administrator entscheiden, welche Art von Kontaktinformationen Sie für die Benutzer bereitstellen möchten. Der Titel und mindestens eine Möglichkeit zur Kontaktaufnahme sind erforderlich. Wählen Sie aus, was angezeigt werden soll, und geben Sie die entsprechenden Informationen ein.
    
  - **Titel**: Geben Sie einen Titel ein, der ihre Absicht eindeutig angibt, beispielsweise "Contoso Help Desk" oder "need help?".
    
  - **Telefon**: Geben Sie die Telefonnummer ein, die Benutzer anrufen sollten, um mit einem Mitarbeiter des technischen Supports in Ihrer Organisation zu sprechen. Vergewissern Sie sich, dass Sie alle Vorwahlnummern eingeben, die erforderlich sind, um die Verbindung herzustellen.
    
  - **E-Mail**: Geben Sie die e-Mail-Adresse für Ihre Supportabteilung ein.
