...
## <a name="watch-install-the-admin-mobile-app"></a>Watch: Installieren der mobilen Administrator-App
...
Ja, aber mit eingeschränkter Funktionalität. Sie können sich anmelden und Dienstinformationen anzeigen, die meisten Benutzerverwaltungsfunktionen sind jedoch schreibgeschützt. Sie können keine Benutzer hinzufügen, bearbeiten oder löschen. Sie können jedoch Benutzern in Ihrer Organisation Lizenzen zuweisen und Benachrichtigungen erhalten.
...
Wenn Sie einen bestimmten Dienstvorfall oder eine Nachricht auswählen, befindet sich die Freigabeoption in der oberen rechten Ecke.
...
Ja, Sie können mehrere Konten oder Organisationen einrichten.

### <a name="im-unable-to-login-or-my-app-is-acting-funny-what-can-i-do-to-troubleshoot-or-fix-the-issue"></a>Ich kann mich nicht anmelden, oder meine App wirkt komisch. Was kann ich tun, um das Problem zu beheben oder zu beheben?
