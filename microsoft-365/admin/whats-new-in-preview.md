...
---
# <a name="whats-new-in-the-microsoft-365-admin-center"></a>Neuigkeiten im Microsoft 365 Admin Center
...
Wir fügen kontinuierlich neue Features zum [Microsoft 365 Admin Center](../business-video/admin-center-overview.md)hinzu, beheben Probleme, über die wir erfahren, und nehmen basierend auf Ihrem Feedback Änderungen vor. Unten können Sie sehen, was heute schon für Sie verfügbar ist. Einige Funktionen werden für unsere Kunden mit unterschiedlicher Geschwindigkeit bereitgestellt. Wenn Sie noch kein Feature sehen, [versuchen Sie, sich selbst zur Zielversion hinzuzufügen.](manage/release-options-in-office-365.md)
...
- [Neuigkeiten im Exchange Admin Center](/Exchange/whats-new)
...
- [So überprüfen Sie Windows Releaseintegrität](/windows/deployment/update/check-release-health)

## <a name="june-2021"></a>Juni 2021

### <a name="microsoft-365-admin-center-search"></a>Microsoft 365 Admin Center-Suche

Wir haben der Suchfunktion einige neue Kategorien hinzugefügt.

- Sie können jetzt in der globalen Suche nach Microsoft 365 Administratorrollen suchen und Rollenzuweisungen schnell von einer beliebigen Seite aus anzeigen und verwalten. Suchen Sie beispielsweise nach **einem Intune-Administrator.**

- Sie finden jetzt eine vereinfachte Einrichtungsoberfläche über die globale Suche. Dies kann Ihnen und Ihrem Team helfen, schnell mit der Verwendung neuer Features zu beginnen. For example, search for **set password to never expire**.
...
### <a name="keep-track-of-support-ticket-updates-using-the-admin-mobile-app"></a>Nachverfolgen von Supportticketupdates mithilfe der mobilen Administrator-App
...
### <a name="stay-on-top-of-all-the-major-updates-to-the-app-and-your-microsoft-365-subscription"></a>Bleiben Sie auf dem Laufenden über alle wichtigen Updates für die App und Ihr Microsoft 365-Abonnement
...
### <a name="manage-licenses-and-bills-from-the-admin-mobile-app"></a>Verwalten von Lizenzen und Rechnungen aus der mobilen Administrator-App
...
### <a name="updated-message-center-feed-in-the-admin-mobile-app"></a>Aktualisierter Nachrichtencenter-Feed in der mobilen Administrator-App
...
### <a name="whats-new-features"></a>Neuerungen
...
### <a name="multi-tenant-management"></a>Mehrinstanzenfähige Verwaltung
...
- **Alle Mandanten:** Eine neue Seite, auf der Sie schnell den Status aller Dienste Ihrer Mandanten, alle offenen Serviceanfragen, Ihre Produkte und Die Abrechnung, empfohlene Einrichtungsaufgaben und die Anzahl der Benutzer in diesem Mandanten sehen können.
...
![Seite "Dienststatus" für mehrere Mandanten mit ausgewähltem Vorfall und geöffneter Registerkarte "Mandanten betroffen". Im Navigationsmenü sind alle Mandanten, Setup und Dienststatus als einzige Optionen verfügbar.](../media/MAC-WN-MTinServiceHealth.png)
...
### <a name="search-faster-and-get-better-results-from-any-page"></a>Schneller suchen und von jeder Seite bessere Ergebnisse erzielen

Wir haben mit dem Rollout einer neuen Suchumgebung für das Admin Center begonnen, und wir können nicht warten, bis Sie es ausprobieren. ![Das Suchfeld wurde in den Bannerbereich verschoben. Alt+S, um von einer beliebigen Seite aus zu suchen.](../media/MAC-WN-GlobalSearch.png)

- Das Suchfeld wurde in den Kopfbereich verschoben, in dem es "Microsoft 365 Admin Center" heißt, sodass Sie jetzt von einer beliebigen Seite suchen, nicht nur von der Startseite. Wir haben sogar eine Verknüpfung: **ALT+S**.
...
- Suchergebnisse werden nach dem Typ des Elements oder der Aktion organisiert, die Sie ausführen können.
  ...
  - **Navigation:** Ergebnisse unter Navigation können Ihnen schnell helfen, schnell zu einer Seite im Admin Center zu gelangen. Wenn Sie beispielsweise nach "Rollen" suchen, gelangen Sie zur Seite "Rollen" nach Azure AD-Rollen.
  - **Einstellungen:** Suchen Sie nach allen Einstellungen im Zusammenhang mit Ihrer Organisation, den Diensten, die Sie abonnieren, sowie sicherheits- und datenschutzbezogenen Einstellungen. 
...
### <a name="microsoft-365-admin-mobile-app"></a>mobile Administrator-App Microsoft 365

Mit [der mobilen Administrator-App Microsoft 365,](https://www.microsoft.com/microsoft-365/business/manage-office-365-admin-app)die in Ihrem Abonnement enthalten ist, können Sie Microsoft 365 von Ihrem mobilen Gerät aus verwalten, damit Sie ihren Schreibtisch verlässt, um tägliche Aufgaben auszuführen. Tatsächlich gibt es mehr als 90 Features in der App, und wir haben soeben ein paar weitere hinzugefügt:

- **Unterstützung für die Richtlinien für die mobile Anwendungsverwaltung und den bedingten Zugriff von Microsoft Intune:** Sie können jetzt Ihr persönliches Gerät verwenden, um Microsoft 365 zu verwalten, auch wenn Ihre Organisation die Mobile Anwendungsverwaltung und bedingte Zugriffsrichtlinien von Intune aktiviert hat.
...
- **Melden eines Problems:** Sie können jetzt ein Problem in der App melden oder Probleme anzeigen, die von anderen Administratoren gemeldet wurden. Besuchen Sie **den Dienststatus,** um es auszuchecken.
...
Kleine und mittelständische Unternehmen erhalten möglicherweise eine Empfehlung auf der **Startseite,** wenn einige der Personen in der Organisation nicht aktiv Teams, OneDrive oder Office-Apps verwenden. Wenn Sie die Empfehlung anzeigen, können Sie microsoft-Schulungen schnell an inaktive Benutzer senden, um ihnen bei den ersten Schritten mit der App zu helfen und sicherzustellen, dass Sie den vollen Nutzen aus Ihren Abonnements erhalten.
...
### <a name="need-help-moving-to-more-admin-centers"></a>Benötigen Sie Hilfe? Umstieg auf weitere Admin Center
...
- Ändern der Einschränkungsrichtlinie für Exchange Webdienst
...
- Brand new and just in time for Microsoft Ignite -[The Virtual Hub](https://adoption.microsoft.com/virtual-hub/). Tiefe Einblicke in die technische Schulung für IT-Spezialisten und Entwickler. Suchen Sie im Rahmen der #SIDETRACKED, dem Namen des Ignite-Administratortitels in diesem Jahr, schnell ca. 20 neue Videos.
...
### <a name="getting-ready-for-ignite-2020"></a>Vorbereiten auf Ignite 2020
...
Das nächste Update dieses Artikels ist am Ersten Tag unseres ersten reinen Online-Ignite. In diesem Jahr ist die Teilnahme kostenlos! Sehen Sie es sich an, registrieren Sie sich: [Microsoft Ignite 2020](https://www.microsoft.com/ignite).
...
[Neuigkeiten bei Microsoft 365](https://youtu.be/m1Nu8WJgCDY) Videoreihe: In diesem Monat befassen wir uns mit der neuen Yammer-Erfahrung für Web und Mobilgeräte, der Integration der Yammer Community-App für Microsoft Teams, neuen Richtlinienpaketen zur Unterstützung von Mitarbeitern und Vorgesetzten in Service und Produktion und vieles mehr.

## <a name="june-2020"></a>Juni 2020

### <a name="keeping-up-with-office-whats-new-management"></a>Keeping up with Office What's New management
...
- entwurfsprinzipale Enterprise Architektur
...
Nun, wir haben es getan! Wir haben den zweiten Schritt hin zu einer einheitlichen Rollenerfahrung gemacht, und Sie können nun Intune-Rollen im Microsoft 365 Admin Center verwalten. Sie können auch Features nutzen, z. B. die Möglichkeit, nach Rollen zu suchen und Rollenberechtigungen anzuzeigen. Dies bedeutet, dass Sie keine zwei separaten Tools zum Verwalten von Rollen für Microsoft 365 und Intune benötigen. Wenn Sie sich beim Microsoft 365 Admin Center anmelden, sehen Sie, dass auf der Seite "Rollen" zwei Pivots vorhanden sind, eines für Azure AD und eines für Intune.
...
Beim Erstellen einer Serviceanfrage wird der Chat nun zusätzlich zu Telefon und E-Mail als Option angezeigt. Wählen Sie "Chat" als bevorzugten Kommunikationskanal aus, und erstellen Sie die Anforderung. Nachdem Sie die Anforderung erstellt haben, können Sie den Chat starten, wenn Sie bereit sind, mit Microsoft-Agents zu chatten.
...
- Eine neue Empfehlungskarte auf der Admin Center-Homepage zeigt, welche Benutzer Teams 30 Tage lang nicht aktiv verwendet haben. Sie können diesen Benutzern eine Schulungs-E-Mail senden, um mit Teams zu beginnen.
- **Bringen Sie Personen mit Teams zusammen:** Wechseln Sie zum **Setup,** um eine neue Seite anzuzeigen, auf der Sie Teams für lizenzierte Benutzer aktivieren und den Gastzugriff zulassen können, damit Sie mit externen Kunden in Teams zusammenarbeiten können.
...
### <a name="productivity-score"></a>Produktivitätsbewertung
...
### <a name="featured-feedback-fix-improve-add-user-reliability-for-licensing"></a>Empfohlene Feedbackkorrektur: Verbessern der Zuverlässigkeit von "Benutzer hinzufügen" für die Lizenzierung
...
Ab dem 21. April nehmen wir Änderungen im Zusammenhang mit unseren Office 365-Abonnements für kleine und mittlere Unternehmen vor – und Office 365 ProPlus. Diese Produkte verwenden jetzt die marke Microsoft 365.
...
[Neuigkeiten in Microsoft 365 Webserie:](https://go.microsoft.com/fwlink/p/?linkid=2118096)In der Folge dieses Monats heben wir das 3-jahres-Bestehen von Microsoft Teams hervor und befassen uns mit neuen Features, einschließlich verbesserter Audioqualität in Onlinebesprechungen, gezielter Kommunikation für Manager in Service und Produktion mit der Shifts-App, Teams und Skype Interoperabilität von Verbrauchern und mehr.

## <a name="february-2020"></a>Februar 2020

### <a name="featured-feedback-fix-multi-organization-switcher"></a>Empfohlene Feedbackkorrektur: Multi-Organization Switcher
...
![Bildschirmaufnahme: oben auf der Startseite, auf der der Organisationsprofilname mit dem Switchersymbol angezeigt wird.](../media/MAC-Organization-switcher.png)

2. Wählen Sie in der Organisationswitcher die Organisation aus, die Sie verwalten möchten.
![Bildschirmaufnahme: Mandantenwechsel in meinem Unternehmen mit hervorgehobener Mandantenmandanten "Consolidated Messenger"](../media/MAC-OrgSwitcherSelected.png)
