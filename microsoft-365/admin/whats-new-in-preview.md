...
- [Erstellen Ihrer Website für Unternehmen](https://support.office.com/article/3325d50e-d131-403c-a278-7f3296fe33a9)
- [Suchen nach Antworten und Hilfe](https://support.office.com/article/7f681212-c649-4a3e-a43b-32b1d1e58988)
...
- [Vertrauen Sie auf Microsoft 365 und Microsoft Threat Protection, um Ihre Umgebung zu schützen](https://docs.microsoft.com/learn/paths/m365-security-threat-protection/)
...
> [!IMPORTANT]
> Sie können nun mit einer regulären URL zum SharePoint Admin Center gelangen:https://admin.microsoft.com/SharePoint
...
- **Office Advanced Threat Protection** – Wenn Ihre Organisation für die Verwendung von Office ATP lizenziert ist und Sie Sie noch nicht konfiguriert oder aktiviert haben, wird diese Seite angezeigt. Wechseln Sie zu **Setup** , um es zu testen.
...
- **Dienste & Add-ins** -im Oktober haben wir die **Einstellungen** \> für die **Dienste &-Add-ins** mit unserem neuen entwurfsstil aktualisiert, aber alle Einstellungsseiten waren noch im klassischen Format. In diesem Monat haben wir begonnen, die tatsächlichen Einstellungen auf das neue Design zu aktualisieren. Schauen Sie sich **Buchungen** an, um das neue Aussehen anzuzeigen.
- **Benutzerverwaltung** -Verwalten von Benutzername, Alias, primäre e-Mail-Adresse.
- Wir haben der Bibliothek zwei Heim Karten hinzugefügt. Sie können die vollständigen Beschreibungen in der Bibliothek lesen.
  - **InTune-Geräteregistrierung**
  - **Domänen**
- **Empfehlungen** – in Ihrem Admin Center wird möglicherweise ein neues Empfehlungs Popup angezeigt. Selbstverständlich werden nur Empfehlungen angezeigt, wenn wir davon ausgehen, dass Ihre Organisation davon profitiert. Aber warten Sie nicht, bis wir Ihnen die Empfehlung zeigen-Sie können Sie aus der Kartenbibliothek hinzufügen.
  - **Schützen von vertraulichen Informationen** – es wird empfohlen, eine DLP-Richtlinie (Data Loss Prevention) zu erstellen, um zu erkennen, wann Elemente mit vertraulichen Informationen für Personen außerhalb Ihrer Organisation freigegeben werden.
...
- **Hauptverbesserungen** Die Homepage wurde vollständig neu ausgeführt und wir können nicht warten, bis Sie Sie ausprobieren und sehen, was Sie denken. Dies ist Ihre persönliche Startseite, und Sie wirken sich nicht auf die Homepages anderer Administratoren in Ihrer Organisation aus. <br/>![Bildschirmaufnahme: Microsoft 365 Admin Center Preview-Startseite.](../media/d1a497f1-30e6-4c1a-9bb2-d4d7895906da.png)
  ...
  - Stellen Sie die Organisation auf die nächste Ebene, indem Sie Karten in Abschnitte gruppieren. Wir haben zwei Standardabschnitte für Sie erstellt: **Grundlagen** und **Geräte und Updates.** In Kürze können Sie Abschnitte hinzufügen, entfernen und umbenennen, um eine Startseite zu entwerfen, die für Sie geeignet ist.
