...
|3.  <br/> |Zur Sicherstellung der Datenqualität führen wir tägliche Daten Überprüfungs Prüfungen für die letzten fünf Tage durch und füllen alle entdeckten Lücken. Während des Prozesses können Unterschiede in den Verlaufsdaten feststellen.  <br/> |
...
|6.  <br/> | Im **Aktivitäts** Diagramm ist die Y-Achse die Anzahl der angegebenen Aktivität.  <br/>  Im Diagramm **Dateien** ist die Y-Achse die Anzahl der Benutzer, die an Microsoft Teams-Chats, privaten Chats, anrufen oder Besprechungen teilnehmen.  <br/>  Die X-Achse in den Diagrammen stellt den ausgewählten Datumsbereich für den jeweiligen Bericht dar.  <br/> |
