...
3. Wählen Sie **in der** Dropdownliste E-Mail-Aktivität **Exchange** \> **Postfachverwendung aus.**
...
|4.  <br/> |Das Diagramm **Speicher** zeigt die Menge des Speicherplatzes an, der von Ihrer Organisation verwendet wird. Storage Das Diagramm enthält keine Archivpostfächer. Weitere Informationen zur automatischen Erweiterung der Archivierung finden Sie [unter Overview of unlimited archiving in Microsoft 365](../../compliance/unlimited-archiving.md).<br/> |
