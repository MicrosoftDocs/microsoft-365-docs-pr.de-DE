...
|3.  <br/> |Das Diagramm " **Websites** " zeigt die Anzahl der gesamten und aktiven Websites an, einschließlich eines Standorts, an dem Benutzer innerhalb des Berichtszeitraums eine Datei angezeigt, geändert, hochgeladen, heruntergeladen, freigegeben oder synchronisiert oder eine Seite angezeigt haben.  <br/> |
