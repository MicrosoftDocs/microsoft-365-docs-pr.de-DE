...
|6.  <br/> |Sie können die im Diagramm angezeigte Datenreihe filtern, indem Sie in der Legende ein Element auswählen. Wählen Sie beispielsweise  im Diagramm Benutzer die Option **Windows**, **Mac** **,** Anrufe , **Web,** **Android-Telefon** oder Windows aus, **um** nur die informationen zu den einzelnen Telefonen zu sehen. Durch das Ändern dieser Auswahl werden die Informationen in der Gitternetztabelle nicht geändert.  <br/> ![Sie können Microsoft Teams App-Verwendungsdiagramme filtern, indem Sie den App-Typ auswählen.](../../media/64ee1cb1-ca80-4964-8234-7fc671135c3d.png)|
