...
## <a name="how-to-get-to-the-reports-dashboard"></a>Abrufen des Dashboards "Berichte"
...
## <a name="which-activity-reports-are-available-in-the-admin-center"></a>Aktivitätsberichte, die im Admin Center zur Verfügung stehen
...
- [SharePoint-Aktivität](sharepoint-activity.md)
...
- [Yammer-Aktivitäten](yammer-activity-report.md)

::: moniker-end

::: moniker range="o365-worldwide"

- [Yammer-Gerätenutzung](yammer-device-usage-report.md)

::: moniker-end

::: moniker range="o365-worldwide"

- [Yammer-Gruppenaktivitätsbericht](yammer-groups-activity-report.md)

::: moniker-end

::: moniker range="o365-worldwide"

- [Microsoft Teams-Benutzeraktivität](microsoft-teams-user-activity.md)

::: moniker-end

::: moniker range="o365-worldwide"

- [Microsoft Teams-Gerätenutzung](microsoft-teams-device-usage.md)
...
## <a name="how-to-view-usage-information-for-a-specific-user"></a>Anzeigen von Verwendungsinformationen für einen bestimmten Benutzer
...
## <a name="what-happens-to-usage-data-when-a-user-account-is-closed"></a>Was geschieht mit Nutzungsdaten, wenn ein Benutzerkonto geschlossen wird?
...
[Berichte im Security &amp; Compliance Center](https://support.office.com/article/7acd33ce-1ec8-49fb-b625-43bac7b58c5a)
