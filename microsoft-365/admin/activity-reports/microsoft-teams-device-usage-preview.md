...
---
# <a name="microsoft-365-reports-in-the-admin-center---microsoft-teams-device-usage---preview"></a>Microsoft 365-Berichte im Admin Center – Microsoft Teams-Gerätenutzung – Vorschau
...
## <a name="how-to-get-to-the-preview-microsoft-teams-app-usage-report"></a>So gelangen Sie zum Bericht "Microsoft Teams-App-Nutzungs Vorschau"

1. Wechseln Sie im Admin Center zur Seite **Berichte** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=2074756" target="_blank">Verwendung</a>. 
2. Wählen Sie in der Dropdownliste **Bericht auswählen** die Option **Microsoft Teams**aus.
  
## <a name="interpret-the-preview-microsoft-teams-app-usage-report"></a>Interpretieren des Berichts "Microsoft Teams-App-Nutzungs Vorschau"

Sie können die Verwendung des Geräts im Bericht "Vorschau Teams" anzeigen, indem Sie die Registerkarte " **Gerätenutzung** " auswählen.
