...
Sie können die Geräteverwendung im Bericht Teams anzeigen, indem Sie die Registerkarte **Geräteverwendung** auswählen.<br/>![Microsoft 365-Berichte – Microsoft Teams-Geräteverwendung.](../../media/e46c7f7c-8371-4a20-ae82-b20df64b0205.png)

Wählen **Sie Spalten auswählen** aus, um Spalten aus dem Bericht hinzuzufügen oder zu entfernen.  <br/> ![Bericht über Teams-Benutzergeräte – Spalten auswählen](../../media/3358d5d9-931b-4d30-931f-450b2f5717da.png)
...
|Windows  <br/> |Ausgewählt, wenn der Benutzer auf einem Windows-basierten Computer im Teams-Desktopclient aktiv war.  <br/> |
|Mac  <br/> |Ausgewählt, wenn der Benutzer auf einem macOS-Computer im Teams-Desktopclient aktiv war.  <br/> |
|iOS  <br/> |Ausgewählt, wenn der Benutzer auf dem mobilen Teams-Client für iOS aktiv war.  <br/> |
|Android-Smartphone  <br/> | Ausgewählt, wenn der Benutzer auf dem mobilen Teams-Client für Android aktiv war.  <br/> |
|Chrome OS  <br/> |Ausgewählt, wenn der Benutzer im Teams-Desktopclient auf einem ChromeOS-Computer aktiv war.|
