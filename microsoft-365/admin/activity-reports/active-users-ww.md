...
2. Klicken Sie auf der Dashboardhomepage auf **die** Schaltfläche Weitere Anzeigen auf der Karte Aktive Benutzer – Microsoft 365 Dienste.

## <a name="interpret-the-active-users-report"></a>Interpretieren des Berichts für aktive Benutzer

Sie können aktive Benutzer im Office 365 anzeigen, indem Sie die Registerkarte **Aktive Benutzer** auswählen.<br/>![Microsoft 365 Berichte – Microsoft Office 365 aktive Benutzer.](../../media/56fe2e54-76ad-49e5-886f-1344c2697258.png)
...
|3.  <br/> |Das **Diagramm Benutzer** zeigt Ihnen tägliche aktive Benutzer im Berichtszeitraum getrennt nach Produkt.  <br/> Das **Diagramm Aktivität** zeigt die tägliche Aktivitätsanzahl im Berichtszeitraum getrennt nach Produkt an. <br/> Das Diagramm **Dienste** zeigt Ihnen die Anzahl der Benutzer nach Aktivitätstyp und Dienst an.  <br/> |
|4.  <br/> | Im Diagramm **Benutzer** zeigt die x-Achse den ausgewählten Berichtszeitraum an, und auf der y-Achse werden die täglichen aktiven Benutzer getrennt und nach Lizenztyp codiert angezeigt.  <br/>  Im Diagramm **Aktivität** zeigt die x-Achse den ausgewählten Berichtszeitraum an, und auf der y-Achse wird die tägliche Aktivitätsanzahl getrennt und die Farbe nach   Lizenztyp codiert angezeigt. <br/> Im Aktivitätsdiagramm **Dienste** zeigt die X-Achse die einzelnen Dienste an, für die Ihre Benutzer im festgelegten Zeitraum aktiviert sind, während die Y-Achse die Anzahl der Benutzer nach farblich gekennzeichnetem Aktivitätsstatus angibt.  <br/> |
