...
Die Verwendung der mehrstufigen Authentifizierung ist eine der einfachsten und effektivsten Möglichkeiten, um die Sicherheit Ihrer Organisation zu erhöhen. Es ist einfacher, als es klingt. Wenn Sie sich anmelden, bedeutet die mehrstufige Authentifizierung, dass Sie einen Code von Ihrem Telefon eingeben, um Zugriff auf Microsoft 365. Dies kann verhindern, dass Hacker die Übernahme übernimmt, wenn sie Ihr Kennwort kennen. Die mehrstufige Authentifizierung wird auch als 2-Schritt-Überprüfung bezeichnet. Einzelpersonen können den meisten Konten problemlos zweiStufige Überprüfungen hinzufügen, z. B. zu ihren Google- oder Microsoft-Konten. Hier erfahren Sie, wie [Sie Ihrem persönlichen Microsoft-Konto eine zweistufige Überprüfung hinzufügen.](https://go.microsoft.com/fwlink/p/?linkid=2016403)

Für Unternehmen, die Microsoft 365, fügen Sie eine Einstellung hinzu, die erfordert, dass sich Ihre Benutzer mit der mehrstufigen Authentifizierung anmelden. Wenn Sie diese Änderung ändern, werden Benutzer aufgefordert, ihr Telefon bei der nächsten Anmeldung für die zweistufige Authentifizierung zu einrichten.
Ein Schulungsvideo zum Einrichten von MFA und zum Abschließen der Einrichtung durch Benutzer finden Sie unter Einrichten von [MFA](../../business-video/turn-on-mfa.md) und [Benutzer einrichten.](../../business-video/set-up-mfa.md)
...
Nachdem Sie die mehrstufige Authentifizierung für Ihre Organisation eingerichtet haben, müssen die Benutzer auf ihren Geräten die Prüfung in zwei Schritten einrichten. Weitere Informationen finden Sie unter [Einrichten der 2-Schritt-Überprüfung für Microsoft 365](https://support.microsoft.com/office/ace1d096-61e5-449b-a875-58eb3d74de14).
...
Um eine E-Mail-Transportregel zu erstellen, zeigen Sie ein [kurzes](../../business-video/prevent-ransom-in-email.md)Schulungsvideo an, oder führen Sie die folgenden Schritte aus:
...
Wählen Outlook für PC die Option **Optionen** in der E-Mail aus, und wählen Sie dann **Berechtigungen aus.**
...
Weitere Informationen finden Sie unter [Send, view, and reply to encrypted messages in Outlook for PC](https://support.microsoft.com/office/eaa43495-9bbb-4fca-922a-df90dee51980).

## <a name="8-protect-your-email-from-phishing-attacks"></a>8. Schützen Ihrer E-Mails vor Phishingangriffen
<a name="phishing"> </a>

Wenn Sie eine oder mehrere benutzerdefinierte Domänen für Ihre Microsoft 365 konfiguriert haben, können Sie gezielten Antiphishingschutz konfigurieren. Antiphishingschutz, ein Bestandteil von Microsoft Defender for Office 365, kann Ihre Organisation vor phishingbasierten Phishingangriffen und anderen Phishingangriffen durch böswilligen Identitätswechsel schützen. Wenn Sie keine benutzerdefinierte Domäne konfiguriert haben, müssen Sie dies nicht tun.
...
Um eine Antiphishingrichtlinie in Defender for Office 365 zu erstellen, zeigen Sie ein kurzes Schulungsvideo [an,](../../business-video/setup-anti-phishing.md)oder führen Sie die folgenden Schritte aus:
...
Um eine Richtlinie für sichere Anlagen zu erstellen, zeigen Sie ein [kurzes](../../business-video/safe-attachments.md)Schulungsvideo an, oder führen Sie die folgenden Schritte aus:
...
Um zu sicheren Links zu kommen, zeigen Sie ein [kurzes](../../business-video/safe-links.md)Schulungsvideo an, oder führen Sie die folgenden Schritte aus:
...
2. Geben **Einstellungen, die für** Inhalte in Office 365 gelten, eine zu blockierende URL ein, z. B. example.com , und wählen Sie  **+** aus.

3. Wählen **Einstellungen,** die für Inhalte außer E-Mail gelten, **Office 365-Anwendungen** **aus,** Nicht nachverfolgen, wenn Benutzer auf sichere Links klicken, und Lassen Sie benutzer nicht durch sichere Links zur ursprünglichen **URL klicken.**
