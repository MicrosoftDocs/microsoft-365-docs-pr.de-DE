...
Sie können ein Standarddesign hinzufügen oder aktualisieren, das für alle Benutzer in Ihrer Organisation gilt. Sie können auch bis zu vier zusätzliche Gruppenthemen erstellen, die mehreren Gruppen zugewiesen Microsoft 365 können.
...
|[Logos](#logos-specify-your-theme-logos) <br/> |Fügen Sie Ihr Designlogo hinzu, einschließlich Office dunklen Designs und mobilen Optionen.  <br/> |
...
- **Alternatives Logo:** Fügen Sie einen URL-Speicherort hinzu, der auf Ihr Logo verweist. Ihr alternatives Logo sollte für die Verwendung in dunklen designs Office optimiert werden. Dieselben Anforderungen wie das Standardlogo.
...
Das Standarddesign wird weiterhin allen Mitarbeitern angezeigt.Das Hinzufügen eines neuen Gruppendesigns wird nur den Microsoft 365 diesem Design zugeordneten Gruppen zur Verfügung stehen.
...
### <a name="can-i-use-security-groups-or-distribution-groups-instead-of-microsoft-365-groups"></a>Kann ich Sicherheitsgruppen oder Verteilergruppen anstelle von Microsoft 365 verwenden?

Nein, neue Gruppen designs müssen einer oder mehreren gruppen zugeordnet Microsoft 365 und nicht Sicherheitsgruppen oder Verteilergruppen zugeordnet werden.

> [!NOTE]
> Sie können [Verteilergruppen in Microsoft 365 in Outlook.](../manage/upgrade-distribution-lists.md)

### <a name="can-imanually-assign-a-theme-independent-ofmicrosoft-365-groups"></a>Kann ich ein Design manuell unabhängig von Microsoft 365 zuweisen?  

Nein, neue Gruppenthemen müssen einer oder mehreren Gruppen zugeordnet Microsoft 365 werden. Benutzer, die Mitglieder der Gruppe Microsoft 365, erhalten das Design, das auf ihre Gruppe angewendet wird. Sie können neue Mitglieder erstellen und einer Microsoft 365 [hinzufügen,](../create-groups/create-groups.md) indem Sie zu den Einstellungen ****   >  **Gruppen** im Admin Center gehen.
...
Stellen Sie sicher, dass das von Ihnen verwendete Logo als öffentlich adressierbare URL angegeben ist. Führen Sie die folgenden Schritte [aus,](/azure/storage/blobs/storage-upload-process-images?tabs=dotnet) um Logos in Azure Blob Storage oder Office 365 Content Delivery Network [mit SharePoint Online hochzuladen.](../../enterprise/use-microsoft-365-cdn-with-spo.md)
