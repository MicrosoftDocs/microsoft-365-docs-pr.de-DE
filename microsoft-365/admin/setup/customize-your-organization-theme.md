...
Sie können ein Standarddesign hinzufügen oder aktualisieren, das für alle Benutzer in Ihrer Organisation gilt. Sie können auch bis zu vier zusätzliche Gruppendesigns erstellen, die mehreren Microsoft 365 Gruppen zugewiesen werden können.
...
### <a name="my-organization-already-has-a-theme-for-all-employees-how-will-this-change"></a>Meine Organisation hat bereits ein Design für alle Mitarbeiter. Wie wird sich dies ändern?
...
### <a name="whydont-isee-group-themes-in-the-admin-center"></a>Warum werden gruppendesigns nicht im Admin Center angezeigt?
...
### <a name="what-happens-if-a-user-is-assigned-to-multiple-group-themes"></a>Was geschieht, wenn ein Benutzer mehreren Gruppendesigns zugewiesen ist?  
...
[Hinzufügen von benutzerdefinierten Kacheln zur Seite "Meine Apps" und zum App-Startfeld](../manage/customize-the-app-launcher.md) (Artikel)\
