...
Als Administrator einer Microsoft 365-Organisation können Sie jetzt fehlerhafte oder verzögerte e-Mail-Nachrichten überwachen, die an Ihre Benutzer mit hohem geschäftlichen Einfluss wie Ihr CEO gesendet wurden. Sie können dies aktivieren, indem Sie Benutzer zu Ihrer Liste mit Prioritäten Konten hinzufügen. Bei Prioritäts Konten handelt es sich um Konten, die für die Ausführung Ihrer Organisation unerlässlich sind. Hinzufügen von Führungskräften, Führungskräften, Managern oder anderen Benutzern, die Zugriff auf vertrauliche Informationen oder Informationen mit hoher Priorität haben

## <a name="access-priority-accounts"></a>Zugriffs Prioritäts Konten

Das in diesem Thema beschriebene Feature für die Prioritäts Konten steht nur Organisationen zur Verfügung, die die beiden folgenden Anforderungen erfüllen:
...
## <a name="monitor-your-priority-accounts"></a>Überwachen Ihrer Prioritäts Konten

Sie können den e-Mail-Status Ihrer Prioritäts Konten im Microsoft 365 Admin Center auf der Seite **Setup** überwachen. Sie können bis zu 250 Konten aktiv überwachen.

1. Wechseln Sie zum Admin Center unter <a href="https://go.microsoft.com/fwlink/p/?linkid=2024339" target="_blank">https://admin.microsoft.com</a>.

2. Wählen Sie **Setup** und dann **anzeigen** neben **Premium-Überwachung** aus, um den Status Ihrer Prioritäts Konten anzuzeigen.
