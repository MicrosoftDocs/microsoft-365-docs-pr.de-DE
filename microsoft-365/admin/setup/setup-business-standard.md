...
Sie können das Exchange Admin Center verwenden, um die E-Mails aller Benutzer zu importieren. Weitere Informationen finden Sie unter [Migrieren mehrerer E-Mail-Konten](/Exchange/mailbox-migration/mailbox-migration).
