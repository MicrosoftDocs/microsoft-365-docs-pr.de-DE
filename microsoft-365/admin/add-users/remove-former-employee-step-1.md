...
> [!IMPORTANT]
> Wenn sich der Benutzer in Outlook im Web befindet und einfach nur in sein Postfach klickt, wird er möglicherweise nicht sofort herausgeklickt. Sobald sie eine andere Kachel auswählen, z. B. OneDrive, oder ihren Browser aktualisieren, wird die Abmeldung initiiert.
...
3. Doppelklicken Sie auf den Benutzer, und wechseln Sie zur Seite **"Postfachfeatures".** Wählen Sie unter **"Mobile Geräte"** die Option **"Exchange ActiveSync deaktivieren"** und **"OWA für Geräte deaktivieren" aus,** und antworten Sie bei Aufforderung **"Ja".**
4. Wählen Sie unter **"E-Mail-Konnektivität"** die Option **"Deaktivieren"** und **"Ja"** aus, wenn Sie dazu aufgefordert werden.
