...
Sie können DNS-Einträge mithilfe der Verwaltungstools auf Ihrem Domänenhost hinzufügen und verwalten oder Microsoft die Kontrolle über Ihre Domänendatensätze geben, und wir richten sie für Sie ein.
  
Wählen Sie unten Ihren Domänenhost aus, um die genauen Schritte zu finden. Wenn Sie nicht sicher sind, wer Ihr Host ist, lesen [Sie Suchen Ihrer Domänenregistrierungsstelle](find-your-domain-registrar.md).
  

## <a name="let-microsoft-365-manage-your-dns-records"></a>Microsoft 365 ihre DNS-Einträge verwalten lassen
...
[Ich brauche allgemeine Anweisungen, da mein Domänenhost nicht in dieser Liste enthalten ist. ](create-dns-records-at-any-dns-hosting-provider.md)
