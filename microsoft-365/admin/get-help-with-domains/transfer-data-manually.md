...
description: Hier erfahren Sie, wie Sie Daten manuell zwischen zwei Microsoft 365 übertragen, wenn Sie den Plan oder firmennamen geändert oder mehrere Abonnements in einem kombiniert haben.
...
> [!CAUTION]
> Während des Vorgangs, in dem E-Mails, Skype for Business und eine öffentliche Website, die auf der Website gehostet wird, nicht Microsoft 365 funktionieren, gibt es Eine Auszeit. Benutzer erhalten neue Benutzernamen und Kennwörter und sie müssen Outlook zurücksetzen.
...
|Kündigen Sie das Abonnement für den Plan, mit dem Sie fertig sind, indem Sie den Microsoft Support für Microsoft 365.  <br/> | Stellen Sie sicher, dass Ihr neues Abonnement funktioniert und alle Daten übertragen wurden.  <br/>  [Wenden Sie sich an den Kundensupport,](../../business-video/get-help-support.md) um Ihr altes Abonnement zu kündigen.  <br/> |
...
Wenn Sie Daten von Microsoft 365 an Microsoft 365 Midsize Business oder Microsoft 365 Enterprise übertragen, sind die Administratorseiten unterschiedlich strukturiert. Sehen Sie [sich ein Video an: Einführung Microsoft 365 Enterprise](../index.yml), und wechseln Sie zu den folgenden Stellen, um sich die Administratoreinstellungen zu ansehen.
...
- Informationen zum Speichern einer Dokumentbibliothek oder eines Listeninhalts aus einer SharePoint Online-Umgebung (OneDrive for Business oder Teamwebsites) in Dateifreigaben oder auf einem lokalen Computer finden Sie unter Informationen zur manuellen Migration von [SharePoint Onlineinhalten](/sharepoint/troubleshoot/migration-tool/content-manual-migration).
...
Bitten Sie Die Benutzer, [inhalte OneDrive for Business auf](https://support.microsoft.com/office/59b1de2b-519e-4d3a-8f45-51647cf291cd)ihren Computer zu kopieren/zu synchronisieren, und fügen Sie sie dann wieder zu ihrem neuen Abonnement hinzu.

### <a name="onenote"></a>OneNote 

Bitten Sie Die [Benutzer, OneNote](https://support.microsoft.com/office/back-up-notes-f58b34b0-611d-435e-87fa-7942a1767af4?ui=en-us&rs=en-us&ad=us) und Notizen aus einer Sicherung [in ihren](https://support.microsoft.com/en-us/office/restore-notes-from-a-backup-5daf9cb0-6769-4998-a5de-f044fdd0d831?ui=en-us&rs=en-us&ad=us) neuen Abonnements wiederherzustellen.