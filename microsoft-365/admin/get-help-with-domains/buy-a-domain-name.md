...
[Aktualisieren Sie DNS-Einträge, um Ihre Website bei Ihrem aktuellen Hostinganbieter zu behalten.](../dns/update-dns-records-to-retain-current-hosting-provider.md)