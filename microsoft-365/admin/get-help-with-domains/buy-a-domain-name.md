...
> [!NOTE]
> Wenn Sie **"Domäne kaufen"** auswählen, werden Sie möglicherweise zur Website Ihres Microsoft-Partners umgeleitet, wenn der Mandant über einen Microsoft-Partner erworben/verwaltet wird.
...
Wenn Sie eine Domäne von einer anderen Domänenregistrierungsstelle als [GoDaddy](https://www.godaddy.com)erwerben möchten, empfehlen wir, eine der folgenden Domänen zu verwenden, die die automatische Einrichtung (Domain Connect) unterstützt. 
...
[Aktualisieren Sie DNS-Einträge, um Ihre Website bei Ihrem aktuellen Hostinganbieter zu behalten.](https://docs.microsoft.com/microsoft-365/admin/dns/update-dns-records-to-retain-current-hosting-provider)
