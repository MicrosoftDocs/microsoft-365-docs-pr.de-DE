...
Sie können Verteilerlisten auf Office 365 Gruppen mit Outlook aktualisieren. Dies ist eine hervorragende Möglichkeit, die Verteilerlisten Ihrer Organisation mit allen Features und Funktionen von Office 365-Gruppen auszustatten. [Warum Sie Ihre Verteilerlisten für Gruppen in Outlook aktualisieren sollten](https://support.office.com/article/7fb3d880-593b-4909-aafa-950dd50ce188.aspx)

Sie können ein Upgrade für eine einzelne Verteilerliste oder für mehrere Verteilerlisten gleichzeitig ausführen.

## <a name="upgrade-one-or-many-distribution-lists-to-office-365-groups-in-outlook"></a>Aktualisieren einer oder mehrerer Verteilerlisten für Office 365-Gruppen in Outlook

Zum Aktualisieren einer Verteilerliste müssen Sie ein Office 365 globaler Administrator oder Exchange-Administrator sein. Um ein Upgrade auf Office 365 Gruppen durchführen zu können, muss eine Verteilergruppe über einen Besitzer mit einem Postfach verfügen. 

1. Wechseln Sie zum <a href="https://go.microsoft.com/fwlink/p/?linkid=2059104" target="_blank">Exchange Admin Center</a>.

2. Wechseln Sie im Exchange Admin Center zu **Empfänger** \> **Gruppen**.<br/>Es wird ein Hinweis angezeigt, der angibt, dass Sie über Verteilerlisten (auch als **Verteilergruppen** bezeichnet) verfügen, die für die ein Upgrade auf Office 365-Gruppen geeignet sind.<br/> ![Klicken Sie auf die Schaltfläche Erste Schritte](../media/8cf838b4-2644-401f-a366-08c1eea183eb.png)
...
4. Wählen Sie das Symbol Upgrade aus.<br/>![Symbol für ein Upgrade auf Office 365 Gruppen](../media/1e28cb3d-bff3-4be3-8329-1902d2d54720.png)
...
> [!NOTE]
> Sie können auch eine einzelne Verteilerliste mithilfe des [New-Unifiedgroup PowerShell-](https://go.microsoft.com/fwlink/?LinkID=786379) Cmdlets auf eine Office 365 Gruppe aktualisieren.
...
## <a name="faq-about-upgrading-distribution-lists-to-office-365-groups-in-outlook"></a>FAQ zum Upgrade von Verteilerlisten auf Office 365-Gruppen in Outlook
...
Personen mit Office 365 globalen Administrator-oder Exchange-Administratorrechten.
