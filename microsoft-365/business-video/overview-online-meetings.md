...
Sie müssen sich mit einem Client, Kunden oder Partner treffen, können aber nicht alle an einem Ort erhalten? Machen Sie sich keine Sorgen, haben Sie eine Online-Besprechung. Wenn sie über ein Smartphone, Tablet oder Laptop verfügen, können sie mit Microsoft Teams.
...
Wenn Sie häufig eng an Projekten mit einem Client, [](team-with-guests.md) Kunden oder Partner zusammenarbeiten, sollten Sie die Erstellung eines Teams für Ihre Kunden in Betracht ziehen, sodass Sie sie problemlos zu Besprechungen einladen und auch Unterhaltungen führen, Dateien freigeben und Projekte in Microsoft Teams.
...
Verwenden Sie zum Planen von Besprechungen mit Ihren Mitarbeitern, Kunden und anderen Gästen Microsoft Teams. Versuch es:
...
Verwenden Microsoft Teams, um an Besprechungen mit Mitarbeitern in Ihrem Unternehmen und Kunden außerhalb Ihres Unternehmens teilzunehmen. Versuch es:

1. Wählen Microsoft Teams in der linken Navigationsleiste **Besprechungen aus.**
1. Öffnen Sie die Besprechung, der Sie beitreten möchten, und wählen Sie **Microsoft Teams Besprechung beitreten aus.**
...
Sie können einen Chat in einer Microsoft Teams in eine Besprechung konvertieren. Wählen Sie **einfach Videoanrufschaltfläche** :::image type="icon" source="../media/video-call-icon.png" border="false"::: oder **Audioanrufschaltfläche** :::image type="icon" source="../media/audio-call-icon.png" border="false"::: aus, um einen Anruf zu starten. Sie können dem Anruf auch Personen hinzufügen, wenn er zu einer Gruppendiskussion werden muss.
