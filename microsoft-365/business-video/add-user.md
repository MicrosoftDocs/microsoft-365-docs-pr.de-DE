...
1. Überprüfen Sie die Benutzerdetails. Wenn Sie eine zusätzliche Lizenz für diesen Benutzer erwerben müssen, wird eine Benachrichtigung auf der Rezensionsseite angezeigt. Wählen **Sie Hinzufügen fertig** stellen aus, und wählen Sie dann Schließen **aus.**
1. Stellen Sie sicher, dass der Benutzer erfolgreich erstellt wurde: Wählen Sie im Microsoft 365 Admin Center im linken Navigationsbereich Benutzer **und** dann Aktive **Benutzer aus.** Der neue Benutzer sollte zusammen mit der zugewiesenen Lizenz aufgelistet werden.