...
1. Sie können eine benutzerdefinierte Richtlinie erstellen oder mit einer Vorlage beginnen. Wenn Sie beispielsweise eine HIPAA-Richtlinie erstellen möchten, wählen Sie die Vorlage **Medizin** und Gesundheit aus, und wählen Sie dann **U.S. Health Insurance Act (HIPAA) aus.** Klicken Sie auf **Weiter**.
1. Geben Sie einen Namen und eine Beschreibung für Ihre Richtlinie ein. Klicken Sie auf **Weiter**.
1. Wählen Sie die zu scannende Speicherorte aus. Klicken Sie auf **Weiter**.
1. Wählen Sie den Inhaltstyp aus, der geschützt werden soll. Klicken Sie auf **Weiter**.
1. Wählen Sie aus, was passieren soll, wenn vertrauliche Informationen erkannt werden. Klicken Sie auf **Weiter**.
1. Passen Sie Ihre Zugriffs- und Außerkraftsetzungsberechtigungen an. Klicken Sie auf **Weiter**.
1. Wählen Sie aus, wann die Richtlinie wirksam werden soll. Klicken Sie auf **Weiter**.
