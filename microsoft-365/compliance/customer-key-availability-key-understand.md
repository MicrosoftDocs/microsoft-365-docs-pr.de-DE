...
2. Microsoft 365 wählt zufällig einen der beiden Kundenschlüssel aus dem Dep aus und sendet eine Anforderung an Azure Key Vault, um den DEP-Schlüssel mithilfe des Kundenschlüssels aufzuheben.
...
> [!IMPORTANT]
> Microsoft 365 Dienstcode verfügt immer über ein gültiges Anmeldetoken, um Kundendaten zur Bereitstellung von Mehrwert-Clouddiensten zu verwenden. Daher kann der Verfügbarkeitsschlüssel bis zum Löschen des Verfügbarkeitsschlüssels als Fallback für Aktionen verwendet werden, die von Exchange Online und Skype for Business initiiert wurden, z. B. das Erstellen von Suchindex oder verschieben von Postfächern. Dies gilt sowohl für vorübergehende FEHLER als auch für ACCESS DENIED-Anforderungen an Azure Key Vault.
...
Die Protokollierung von Verfügbarkeitsschlüsseln ist für diese Dienste noch nicht verfügbar. Für SharePoint Online-, OneDrive for Business- und Teams-Dateien wird der Verfügbarkeitsschlüssel nur von Microsoft aktiviert, wenn Sie von Ihnen angewiesen werden, für Wiederherstellungszwecke. Daher kennen Sie bereits jedes Ereignis, in dem der Verfügbarkeitsschlüssel für diese Dienste verwendet wird.
