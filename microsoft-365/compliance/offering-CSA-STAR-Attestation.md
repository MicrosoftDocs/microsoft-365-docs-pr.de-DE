...
---
# <a name="compliance-offering-cloud-security-alliance-csa-star-attestation"></a>Complianceangebot: Cloud Security Alliance (CSA) STAR-Nachweis
...
Für den STAR-Nachweis ist eine strenge, unabhängige Prüfung der Sicherheitslage eines Cloudanbieters basierend auf einer SOC 2 Typ 2-Prüfung mit den CCM-Kriterien erforderlich. Der unabhängige Prüfer, der die Angebote eines Cloudanbieters im Hinblick auf den STAR-Nachweis bewertet, muss ein Certified Public Accountant (CPA) sein und mit dem CSA Certificate in Cloud Security Knowledge (CCSK) ausgezeichnet sein.  
  
Eine SOC 2 Typ 2-Prüfung basiert auf den American Institute of Certified Public Accountants (AICPA) Trust Services Principles and Criteria, einschließlich Sicherheit, Verfügbarkeit, Vertraulichkeit und Integritätsverarbeitung, sowie auf den Kriterien der CCM. Der STAR-Nachweis stellt die Ergebnisse eines Prüfers im Hinblick auf die Designeignung und Betriebseffektivität der SOC 2-Kontrollen in Microsoft Cloud Services bereit. Das Ziel besteht darin, sowohl die oben beschriebenen AICPA-Kriterien als auch die CCM-Anforderungen zu erfüllen.

## <a name="microsoft-in-scope-cloud-services"></a>Microsoft-Clouddienste im Leistungsumfang

Microsoft Azure und Microsoft Intune erhielten den CSA STAR-Nachweis. Der STAR-Nachweis stellt die Ergebnisse eines Prüfers im Hinblick auf die Designeignung und Betriebseffektivität der SOC 2-Kontrollen in Microsoft Cloud Services bereit.
...
- **Stufe 2**: **CSA STAR-Zertifizierung**: Azure, Cloud App Security, Intune und Microsoft Power BI. Für die STAR-Zertifizierung ist das Erreichen der ISO/IEC 27001-Zertifizierung und die Erfüllung der in der CCM angegebenen Kriterien erforderlich. Sie wird nach strenger Bewertung der Sicherheitskontrollen und Methoden eines Clouddienstanbieters durch Dritte erteilt.
