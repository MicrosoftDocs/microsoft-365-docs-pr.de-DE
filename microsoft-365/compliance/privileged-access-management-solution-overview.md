...
Verwenden Sie die folgenden Schritte, um die Verwaltung privilegierter Zugriffe für Ihre Organisation zu konfigurieren:
...
5. Übermitteln/Genehmigen von [Privilegierten Zugriffsanforderungen](privileged-access-management-configuration.md#step-4-submitapprove-privileged-access-requests)

## <a name="more-information-about-privileged-access-management"></a>Weitere Informationen zur Verwaltung privilegierter Zugriffe

- [Häufig gestellte Fragen zur Verwaltung privilegierter Zugriffe](privileged-access-management-overview.md#frequently-asked-questions)