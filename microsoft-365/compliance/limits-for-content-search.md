...
|Die maximale Anzahl von Speicherorten in einer Inhaltssuche, aus der Sie Elemente exportieren können. Wenn die Inhaltssuche, die Sie exportieren möchten, mehr Speicherorte als diesen Grenzwert aufweist, schlägt der Export fehl. Weitere Informationen finden Sie unter [Exportieren von Inhalts Suchergebnissen](export-search-results.md).  <br/> |100.000  <br/> |
