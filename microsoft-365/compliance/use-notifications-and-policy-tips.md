...
- Anzeigen eines Richtlinientipps für Inhalte, die mit der DLP-Richtlinie in Konflikt stehen:
  ...
  - Bei Dokumenten in einem OneDrive for Business Konto oder SharePoint Onlinewebsite wird der Richtlinientipp durch ein Warnsymbol angezeigt, das auf dem Element angezeigt wird. Um weitere Informationen anzuzeigen, können Sie ein  Element auswählen und dann in der oberen rechten Ecke der Seite das Symbol ![ "Informationsbereich" ](../media/50b6d51b-92b4-4c5f-bb4b-4ca2d4aa3d04.png) auswählen, um den Detailbereich zu öffnen.

  - Für Excel-, PowerPoint- und Word-Dokumente, die auf einer OneDrive for Business Website oder SharePoint Onlinewebsite gespeichert sind, die in der DLP-Richtlinie enthalten ist, wird der Richtlinientipp in der Nachrichtenleiste und in der Backstage-Ansicht (**Dateimenü** \> **Info**) angezeigt.
...
6. Führen Sie einen der folgenden Schritte aus, um die Speicherorte auszuwählen, die die DLP-Richtlinie schützen soll:
   ...
   Um einen gesamten Speicherort wie alle Exchange E-Mails oder alle OneDrive Konten einzuschließen oder auszuschließen, aktivieren oder deaktivieren Sie den **Status** dieses Speicherorts.

   Um nur bestimmte SharePoint Websites oder OneDrive Konten einzuschließen, wechseln Sie zu **"Status",** und klicken Sie dann auf die Links unter **"Einschließen",** um bestimmte Websites oder Konten auszuwählen.
...
|**Wenn die DLP-Richtlinienregel dies tut...**|**In der Standardbenachrichtigung für SharePoint- oder OneDrive for Business-Dokumente wird folgendes angezeigt...**|**Die Standardbenachrichtigung für Outlook Nachrichten lautet dann wie folgt...**|
|:-----|:-----|:-----|
...
|%%ContentURL%%  <br/> |Die URL des Dokuments auf der SharePoint Onlinewebsite oder OneDrive for Business Website.  <br/> |
...
Beispielsweise kann eine DLP-Richtlinie auf OneDrive for Business Websites angewendet werden, die personenbezogene Informationen (PII) erkennt, und diese Richtlinie hat drei Regeln:
...
## <a name="policy-tips-on-onedrive-for-business-sites-and-sharepoint-online-sites"></a>Richtlinientipps zu OneDrive for Business Websites und SharePoint Onlinewebsites

Wenn ein Dokument auf einer OneDrive for Business Website oder SharePoint Onlinewebsite mit einer Regel in einer DLP-Richtlinie übereinstimmt und diese Regel Richtlinientipps verwendet, werden in den Richtlinientipps spezielle Symbole im Dokument angezeigt:
...
- Das Office Dokument wird auf einer OneDrive for Business Website oder SharePoint Onlinewebsite gespeichert.
...
> [!NOTE]
> Office Desktop-Apps dokumente selbst überprüfen, um festzustellen, ob DLP-Richtlinientipps angezeigt werden sollen; Sie zeigen keine Richtlinientipps an, die SharePoint Onlinewebsites oder OneDrive for Business Websites bereits festgelegt haben, dass sie in einer Datei angezeigt werden sollen. Daher wird möglicherweise nicht immer ein DLP-Richtlinientipp in den Desktop-Apps angezeigt, die auf den SharePoint Onlinewebsites oder OneDrive for Business-Websites angezeigt werden. Im Gegensatz dazu zeigen die Office Anwendungen im Web nur DLP-Richtlinientipps an, die SharePoint Onlinewebsites oder OneDrive for Business Websites bereits ermittelt haben, angezeigt werden sollten.
