...
- Microsoft-Sicherheitspraktiken für Kundendaten, die in einem Office 365. 
    
- Unabhängige Auditberichte von Drittanbietern Office 365. 
    
- Implementierungs- und Testdetails für Sicherheits-, Datenschutz- und Compliancekontrollen, die Office 365 zum Schutz Ihrer Daten verwendet werden. 
    
Sie können auch herausfinden, wie Office 365 Kunden dabei helfen können, Standards, Gesetze und Vorschriften branchenübergreifend einzuhalten, z. B.:
 ...
 **O365-Abonnementmitglieder** können standardmäßig auf den Abschnitt Service Assurance im Office 365 Protection Center zugreifen. Die Dienstsicherung stellt Berichte und Dokumente zur Verfügung, in denen die Sicherheitspraktiken von Microsoft für Kundendaten beschrieben werden, die in einem Office 365. Außerdem werden unabhängige Auditberichte von Drittanbietern zu Office 365.
...
1. Nachdem Sie auf Service Assurance zugegriffen **haben,** wählen Einstellungen und die Seite Regionen- und Brancheneinstellungen wird angezeigt, wie im folgenden Screenshot gezeigt. 
    
    ![Zeigt die Seite "Einstellungen für das Schutzcenter" an.](../media/101716e8-9c0a-4839-a2c0-f6aacf64eb9d.png)
  
2. Wählen Sie **auf Einstellungen** Seite den Pfeil nach unten neben **Region** aus, und überprüfen Sie die entsprechenden Regionen für Ihre Organisation. 
...
- **Complianceberichte** zum Anzeigen unabhängiger Prüfungen und Bewertungen von Office 365 und anderen Microsoft Cloud Services, wie im folgenden Screenshot dargestellt. 
    
    ![Zeigt die Seite "Dienstsicherheit" an: Dienst-Compliance-Berichte.](../media/149f2181-a558-4963-85e5-8d5ebc7cdac8.png)
  
- **Vertrauen Sie Dokumenten,** um Informationen zur Funktionsweise von Microsoft Office 365 wie im folgenden Screenshot gezeigt. 
...
- **Überwachte Steuerelemente** zum Anzeigen von Informationen darüber, Office 365, wie Steuerelemente Sicherheits-, Compliance- und Datenschutzanforderungen erfüllen, wie im folgenden Screenshot dargestellt. 
...
|:-----|:-----|:-----|
|Complianceberichte  <br/> | FedRamp  <br/>  GRC-Bewertung  <br/>  ISO  <br/>  SOC/SSAE  <br/> |Verwenden Sie Dienstkonformitätsberichte, um Von unabhängigen Prüfern von Drittanbietern durchgeführte Auditbewertungen von Office 365 Service Delivery Operations zu überprüfen.  <br/> |
...
|Überwachte Steuerelemente  <br/> |Globale Standards und Vorschriften, die Office 365 implementiert wurden.  <br/> | Helfen Sie bei der Risikobewertung beim Auswerten, Onboarding oder verwenden Office 365 Dienste. Finde heraus:  <br/> <br/>– Wie Office 365 Sicherheits-, Compliance- und Datenschutzanforderungen erfüllen.  <br/>- Informationen zum Testen von Steuerelementen in Office 365, den Ergebnissen dieser Tests und dem Abschluss dieser Tests.  <br/> |
