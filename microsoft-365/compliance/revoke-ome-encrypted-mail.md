...
Administratoren und Nachrichtensender können verschlüsselte E-Mails widerrufen, wenn der Empfänger eine linkbasierte verschlüsselte E-Mail mit Markennamen empfangen hat. Wenn der Empfänger in einem unterstützten Client eine systemeigene Inlineerfahrung Outlook hat, können Sie die Nachricht nicht widerrufen.
...
Administratoren und Nachrichtensender können Nachrichten widerrufen, die mithilfe der verschlüsselungsintegiert werden, die direkt von Outlook im Web angewendet wird. Beispielsweise Nachrichten, die mit der Option Nur verschlüsseln verschlüsselt werden.
...
Nachdem eine E-Mail widerrufen wurde, erhält der Empfänger einen Fehler, wenn er über das Office 365-Nachrichtenverschlüsselung-Portal auf die verschlüsselte E-Mail zukommt: "Die Nachricht wurde vom Absender widerrufen".
...
Sie können eine E-Mail, die Sie an einen Empfänger gesendet haben, der ein Arbeits- oder Schulkonto verwendet, nicht von Office 365 oder Microsoft 365 oder einem Benutzer widerrufen, der ein Microsoft-Konto verwendet, z. B. ein outlook.com Konto. 

Führen Sie die folgenden Schritte aus, um eine von Ihnen gesendete verschlüsselte Nachricht zu widerrufen

1. Navigieren Outlook im Web im Ordner  Gesendet zu der Nachricht, die Sie widerrufen möchten.
...
Führen Sie die folgenden Schritte aus, um zu überprüfen, ob Sie eine bestimmte E-Mail-Nachricht mithilfe Windows PowerShell widerrufen können.
...
Sobald Sie die Nachrichten-ID der E-Mail kennen, die Sie widerrufen möchten, und sie überprüft haben, ob die Nachricht wieder aufrufbar ist, können Sie die E-Mail über das Security Compliance Center oder &amp; Windows PowerShell.
...
Verwenden Sie das cmdlet Set-OMEMessageRevocation, um eine E-Mail Windows PowerShell zu widerrufen.

1. Verwenden Sie ein Arbeits- oder Schulkonto, das über globale Administratorberechtigungen in Ihrer Organisation verfügt, [Verbinden, Exchange Online PowerShell zu verwenden.](/powershell/exchange/connect-to-exchange-online-powershell)
