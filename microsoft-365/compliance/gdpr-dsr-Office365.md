...
-   **Kronos** – StaffHub unterstützt Verbindungen mit [Kronos](http://www.kronos.com/), einem Drittanbietertool für Belegschaftsverwaltung. StaffHub und Kronos sind unabhängige Verarbeiter, die die Daten entsprechend den eigenen Bedingungen verarbeiten, denen Sie jeweils zugestimmt haben. Wenn Ihr Antrag einer betroffenen Person Daten betrifft, die in Kronos gespeichert sind, müssen Sie sich zwecks Unterstützung bei Anträgen betroffener Personen an Kronos wenden. Dasselbe gilt für StaffHub.
...
-   **Profildaten**: Dies sind die Profilinformationen aus der globalen Adressliste Ihrer Organisation in das Azure Active Directory sowie optionale Informationen, die Benutzer über sich selbst hinzugefügt haben. Um auf Profildaten in Delve zuzugreifen oder sie zu exportieren, kann ein Benutzer auf **Mich** \> **Profil aktualisieren** klicken. Sie können entweder den Inhalt direkt von der Seite kopieren oder einen Screenshot machen.
...
- **Daten der Liste „Personen“**: Dies sind die Personen, die der Benutzer in Delve angesehen hat. Die Liste **Personen** wird im linken Bereich auf der Startseite angezeigt. Benutzer können die Liste der Personen exportieren, die sie zuletzt in Delve angesehen haben.

- **Daten der „Favoriten“**: Hierbei handelt es sich um Boards und Dokumente, die der Benutzer als seinen Favoriten gekennzeichnet hat. Die Seite **Favoriten** zeigt Boards und Dokumente an, die der Benutzer zu seinen Favoriten hinzugefügt hat. Benutzer können eine Liste ihrer aktuellen Favoritenboards und -dokumente exportieren.
