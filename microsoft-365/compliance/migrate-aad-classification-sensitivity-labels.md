---
title: Azure Active Directory Klassifizierungs- und Vertraulichkeitsbezeichnungen für Microsoft 365 Gruppen
ms.reviewer: vijagan
ms.author: mikeplum
...
description: In diesem Artikel werden klassische Azure Active Directory Klassifizierungs- und Vertraulichkeitsbezeichnungen behandelt.
...
---
# <a name="azure-active-directory-classification-and-sensitivity-labels-for-microsoft-365-groups"></a>Azure Active Directory Klassifizierungs- und Vertraulichkeitsbezeichnungen für Microsoft 365 Gruppen

In diesem Artikel werden klassische Azure Active Directory Klassifizierungs- und Vertraulichkeitsbezeichnungen behandelt.
...
Weitere Informationen zu Vertraulichkeitsbezeichnungen und deren Verhalten für Websites und Microsoft 365-Gruppen finden Sie unter [Use sensitivity labels to protect content in Microsoft Teams, Microsoft 365 groups, and SharePoint sites](sensitivity-labels-teams-groups-sites.md).
...
- Der Mandantenadministrator erstellt die Vertraulichkeitsbezeichnungen im [Microsoft 365 Compliance Center](https://compliance.microsoft.com).
    ...
    - Mandantenadministratoren können Microsoft 365 Gruppen auswählen und SharePoint online websitebezogene Aktionen auf die Vertraulichkeitsbezeichnungen festlegen.
...
> [!NOTE]
> Im Fall von Outlook Desktopclient (Win 32), nachdem der Administrator Vertraulichkeitsbezeichnungen für seinen Mandanten aktiviert hat und sich der Benutzer auf einer älteren Version des Outlook-Desktopclients befindet (Win 32):
>
> - Dem Benutzer werden Vertraulichkeitsbezeichnungen auf der älteren Version des Outlook angezeigt.
...
>
> Es wird empfohlen, dass Ihre Benutzer auf einer alten Version von Outlook auf die neuere Version aktualisieren.
...
2. Verwenden Sie das PowerShell-Cmdlet, um diese Vertraulichkeitsbezeichnungen mithilfe der Namenszuordnung auf vorhandene Microsoft 365 und SharePoint anzuwenden.
...
2. Ein Administrator kann dieselben Dokument- und E-Mail-Vertraulichkeitsbezeichnungen verwenden, um Datenschutz und externen Benutzerzugriff auf die Gruppe/Website/das Team durch Angeben verwandter Gruppeneinstellungen zu erzwingen:
    1. Wählen Sie [Microsoft 365 Compliance Center](https://compliance.microsoft.com)die Registerkarte Websites und **Gruppen** aus.
