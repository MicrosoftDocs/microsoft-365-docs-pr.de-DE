...
**Teil 1: Reaktion auf Anforderungen von betroffenen Personen (DSR) nach bezüglich personenbezogener Daten, die in Kundendaten enthalten sind.** Teil 1 dieses Leitfadens erläutert, wie auf personenbezogene Daten in Dynamics 365-Anwendungen (Software as a Service) zugegriffen, wie diese berichtigt, eingeschränkt, gelöscht und exportiert werden können, die als Teil der Kundendaten verarbeitet werden, die Sie dem Onlinedienst zur Verfügung gestellt haben.

**Teil 2: Reaktion auf Anforderungen von betroffenen Personen bezüglich pseudonymisierter Daten.** Wenn Sie Enterprise-Dienste von Dynamics 365 nutzen, erstellt Microsoft Informationen (in diesem Dokument als *vom System generierte Protokolle* bezeichnet), die dem Dienst bereitgestellt werden, die auf den Fußabdruck des Benutzers begrenzt sind, die der Endbenutzer hinterlässt, um die Aktionen im System zu ermitteln. Obwohl diese Daten nicht ohne Verwendung weiterer Informationen einer bestimmten betroffenen Person zugeordnet werden kann, können manche dieser Daten gemäß der DSGVO als personenbezogen klassifiziert werden. Teil 2 dieses Leitfadens erläutert, wie auf vom System generierte Protokolle von Dynamics 365 zugegriffen werden kann und wie diese gelöscht und exportiert werden können.

### <a name="preparing-for-data-subject-rights-investigations"></a>Vorbereiten auf die Überprüfung bezüglich Anforderungen betroffener Personen
...
- Bestätigen Sie, dass die Anfrage den Anforderungen Ihres Unternehmens für die Erfüllung oder Ablehnung der Anforderung einer betroffenen Person entspricht. Zum Beispiel müssen Sie sicherstellen, dass die Ausführung der Anforderung nicht im Widerspruch zu anderen rechtlichen, finanziellen oder regulatorischen Verpflichtungen steht, die Sie haben, oder die Rechte und Freiheiten anderer verletzt.

- Vergewissern Sie sich, dass Sie über die Informationen verfügen, die sich auf die Anforderungen beziehen.

## <a name="part-1-responding-to-data-subject-rights-requests-for-personal-data-includced-in-customer-data"></a>Teil 1: Reaktion auf Anforderungen von betroffenen Personen bezüglich personenbezogenen Daten, die in Kundendaten enthalten sind.

In den folgenden Artikeln finden Sie Informationen zur Vorbereitung und Beantwortung von Anforderungen betroffener Personen zu personenbezogenen Daten, die in den von Dynamics 365 verarbeiteten Kundendaten enthalten sind. Es ist zu beachten, dass personenbezogene Daten in anderen Kategorien von Daten enthalten sein können, die von Microsoft im Rahmen eines Abonnements für Onlinedienste verarbeitet werden, wie z. B. Administratordaten oder Unterstützungsdaten, die in den Microsoft-Datenschutzbestimmungen definiert sind. Dieses Dokument ist darauf beschränkt, Sie bei der Ermittlung und Verwaltung von Anforderungen betroffener Personen zu unterstützen, die personenbezogene Daten betreffen, die in den Kundendaten enthalten sind, die Sie Dynamics 365 zur Verfügung gestellt haben.
...
Die angemessene Klassifizierung von Kundendaten ist der Grundstein für die Arbeit mit personenbezogenen Daten in Microsoft Dynamics 365 Customer Engagement. Dynamics 365 for Customer Engagement bietet Flexibilität beim Aufbau einer Anwendungserweiterung rund um die Datenklassifizierung. Die richtige Klassifizierung ermöglicht es Ihnen, Informationen als personenbezogene Daten zu identifizieren, um sie bei der Beantwortung von Anforderungen einer betroffenen Person zu finden und abzurufen. Es kann auch dazu beitragen, die Einhaltung gesetzlicher und behördlicher Vorschriften für die Erhebung und Verwaltung personenbezogener Daten zu ermöglichen.
...
<span id="_Toc511225657" class="anchor"></span>***Dynamics 365 for Customer Engagement*** bietet Ihnen mehrere Methoden, um in Datensätzen nach personenbezogenen Daten zu suchen, z. B: Erweiterte Suche, Relevanzsuche und Suche nach Datensätzen. Diese Funktionen ermöglichen es Ihnen, personenbezogene Daten zu identifizieren (zu finden).
...
<span id="_Toc511225660" class="anchor"></span>***Dynamics 365 for Talent*** bietet erweiterte Such- und Filterfunktionen, um bestimmte personenbezogene Daten und Microsoft Office-Exportfunktionen zu finden, um diese Informationen mit Hilfe von Browser-Erweiterungen in ein .pdf zu exportieren oder zu drucken.
...
Kundendaten in ***Dynamics 365 for Customer Engagement*** können mit den umfangreichen Exportfunktionen exportiert werden. Kundendaten können in eine statische Excel-Datei exportiert werden, um die Datenübertragbarkeit zu erleichtern. Mit Excel können Sie dann die personenbezogenen Daten, die in die Anforderung auf Datenübertragbarkeit aufgenommen werden sollen, bearbeiten und dann in einem gängigen, maschinenlesbaren Format wie .csv oder.xml speichern.
...
Kundendaten in ***Dynamics 365 for Finance and Operations*** können mit den umfangreichen Exportfunktionen der Einheit exportiert werden. Mit [*Datenverwaltungs- und Integrationseinheiten*](https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/data-entities/data-management-integration-data-entity) kann der Mandantenadministrator bereitgestellte Einheiten verwenden, neue erstellen oder bestehende Einheiten für einen wiederholbaren Export personenbezogener Daten nach Excel oder in eine Reihe anderer gängiger Formate unter Verwendung von [*Datenimport- und -exportaufträgen*](https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/data-entities/data-import-export-job) erweitern. Alternativ können viele Listen in eine statische Excel-Datei exportiert werden, um die Datenübertragbarkeit zu erleichtern. Wenn Kundendaten nach Excel exportiert werden, können Sie die personenbezogenen Daten, die in die Anfrage auf Datenübertragbarkeit aufgenommen werden sollen, bearbeiten und dann die Datei in einem gängigen, maschinenlesbaren Format wie .csv oder .xml speichern. Sie können auch den *Personensuchbericht * verwenden, um der betroffenen Person Daten zur Verfügung zu stellen, die Sie als personenbezogene Daten klassifiziert haben. 
...
In ***Dynamics 365 for Talent*** können Sie [Den Personensuchbericht erweitern](https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/gdpr/gdpr-extend-person-search-report), um Informationen zur Unterstützung einer Anforderung nach einer Kopie der personenbezogenen Daten der betroffenen Person zu sammeln.

### <a name="rectifying-customer-data"></a>Berichtigen von Kundendaten

<span id="_Toc511225663" class="anchor"></span>***Dynamics 365 for Customer Engagement*** gibt Ihnen folgende Möglichkeiten, ungenaue oder unvollständige Kundendaten zu korrigieren oder Kundendaten zu löschen:
...
<span id="_Toc511225664" class="anchor"></span>***Dynamics 365 Business Central*** bietet zwei Möglichkeiten, ungenaue oder unvollständige Kundendaten zu korrigieren.
...
<span id="_Toc511225669" class="anchor"></span>***Dynamics 365 for Finance and Operations*** bietet [Datenverwaltungs- und Integrationseinheiten](https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/data-entities/data-management-integration-data-entity), die einen wiederholbaren Export von personenbezogenen Daten nach Excel oder eine Reihe anderer gängiger Formate unter Verwendung von [Datenimport- und -exportaufträgen](https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/data-entities/data-import-export-job) ermöglichen.  Alternativ können viele Listen in eine statische Excel-Datei exportiert werden, um die Datenübertragbarkeit zu erleichtern. Wenn Kundendaten auf diese Weise nach Excel exportiert werden, können Sie die personenbezogenen Daten, die in die Anfrage auf Datenübertragbarkeit aufgenommen werden sollen, bearbeiten und dann die Datei in einem gängigen, maschinenlesbaren Format wie .csv oder .xml speichern.
...
- <span id="_Toc511225670" class="anchor"></span>***Dynamics 365 Business Central*** bietet die folgenden Funktionen:
...
- Autoren-Tags, die von Mitarbeitern von Social Engagement verwendet werden, um Autoren zu gruppieren und zu klassifizieren - zum Beispiel als Influencer, Konkurrenten oder Fans.
...
-   Einem Benutzerprofil: Gehen Sie zum [Office 365 Admin Center](https://portal.office.com/adminportal/home). Wählen Sie im **Admin Center** **Benutzer** aus. Suchen Sie auf der Seite **Aktive Benutzer** nach dem Benutzer in der Liste.  
    Social Engagement: Gehen Sie zu **Einstellungen\>, Benutzerverwaltung**, um Informationen anzuzeigen, die von Office 365 automatisch synchronisiert werden.
...
Die DSGVO gibt den betroffenen Personen das Recht, auf Anforderung eine Kopie der personenbezogenen Daten zu erhalten. Nachdem Sie Kundeninhalte gefunden haben, die Daten enthalten, die möglicherweise auf die Anforderung passen, liegt es an Ihnen und Ihrem Unternehmen, zu entscheiden, ob Sie der betroffenen Person eine Kopie zur Verfügung stellen.

#### <a name="social-media-users-authors"></a>Für Benutzer von sozialen Medien (Autoren)

- Um Autoren personenbezogene Daten zu exportieren, führen Sie die Schritte in [Autoreninformationen exportieren](https://docs.microsoft.com/dynamics365/customer-engagement/social-engagement/manage-authors#export-author-information) durch, um die Daten in eine Excel-Datei zu exportieren.
...
- Kundendaten aus Benutzerprofilen: Gehen Sie zum [Office 365 Admin Center](https://portal.office.com/adminportal/home). Wählen Sie im **Admin Center** die Option **Benutzer.** Suchen Sie auf der Seite **Aktive Benutzer** nach dem Benutzer, dessen Daten Sie exportieren möchten. Löschen Sie alle Benutzer außer dem Zielbenutzer, und wählen Sie dann **Export**, um die Daten in eine .csv-Datei zu exportieren, in der Sie die Informationen mit Excel anzeigen können.

- E-Mail-Adressen eines Benachrichtigungsempfängers (die einzigen Kundendaten in einer Benachrichtigung): folgen Sie den Schritten in [Benachrichtungsempfänger als Administrator verwalten](https://docs.microsoft.com/dynamics365/customer-engagement/social-engagement/email-alerts#manage-alert-recipients-as-administrator). Wählen Sie dann **Export**, um eine Excel-Liste der Benachrichtigungen herunterzuladen, die diesen Empfänger enthalten.
...
-   Benutzerprofile: Um Änderungen an den Kundendaten in einem Benutzerprofil vorzunehmen, siehe [Benutzername und E-Mail-Adresse in Office 365](https://support.office.com/article/change-a-user-name-and-email-address-in-office-365-fb5ac074-e203-4e1f-9843-b9d1a3e03297) und [Fügen Sie Ihr Profilbild zu Office 365](https://support.office.com/article/add-your-profile-photo-to-office-365-2eaf93fd-b3f1-43b9-9cdc-bdcd548435b7) hinzu.  
    Diese Änderungen werden in Social Engagement automatisch synchronisiert. Um sie zu finden, gehen Sie zu **Einstellungen**, \> **Benutzerverwaltung**.
...
>[Hinweis] Wenn Sie aufgefordert werden, Informationen über einen bestimmten Autor zu entfernen, empfehlen wir Ihnen, zunächst die Identität dieses Autors zu validieren, um die Anfrage zu bestätigen. Um ihre Identität zu validieren, können Sie eine private Nachricht vom Autor über sein Konto in sozialen Medien anfordern.
...
## <a name="part-2-responding-to-dsrs-for-system-generated-logs"></a>Teil 2: Beantworten von Anforderungen betroffener Personen für vom System generierte Protokolle
...
<tbody>
<tr class="odd">
<td align="left"><strong>Wie lange benötigt das Tool für den Datenprotokollexport von Microsoft, um eine Anforderung abzuschließen?</strong>
<td align="left">Dies hängt von mehreren Faktoren ab. In den meisten Fällen sollte der Abschluss in einem oder zwei Tagen möglich sein, es kann jedoch auch bis zu 30 Tage dauern.</td>
</tr>
<tr class="odd">
<td align="left"><strong>Welches Format weist die Ausgabe auf?</strong></td>
<td align="left">Die Ausgabe ist in maschinenlesbaren Dateien, z. B. XML, CSV oder JSON, strukturiert.</td>
</tr>
<tr class="even">
<td align="left"><strong>Welche Daten werden durch das Tool für den Datenprotokollexport ausgegeben?</strong></td>
<td align="left">Das Datenprotokollexport-Tool gibt vom System generierte Protokolle aus, die von Microsoft gespeichert werden. Die exportierten Daten erstrecken sich über verschiedene Microsoft-Dienste wie Office 365, Azure und Dynamics.</td>
</tr>
<tr class="odd">
<td align="left"><strong>Wer hat Zugriff auf das Tool für den Datenprotokollexport und kann Zugriffsanforderungen für vom System generierte Protokolle senden?</strong></td>
<td align="left">Globale Administratoren von Dynamics 365  haben Zugriff auf das DSGVO-Hilfsprogramm zur Verwaltung von Protokollen.</td>
</tr>
<tr class="even">
<td align="left"><strong>Wie werden Daten an den Benutzer zurückgegeben?</strong></td>
<td align="left">Die Daten werden an den Azure-Speicherort Ihrer Organisation exportiert; es ist Sache der Administratoren in Ihrer Organisation, zu bestimmen, wie sie diese Daten den Benutzern anzeigen/bereitstellen.</td>
</tr>
<tr class="odd">
<td align="left"><strong>Wie werden Daten in vom System generierten Protokollen dargestellt?</strong></td>
<td align="left"><p>Beispiel für ein vom System generiertes Protokoll im JSON-Format:</p>
<p>[{</p>
