...
ms.locfileid: "53322365"
---
# <a name="learn-about-communication-compliance-in-microsoft-365"></a>Informationen zur Kommunikationscompliance in Microsoft 365
...
- **Unterstützung für neues maschinelles Lernen:** Integrierte Klassifizierungen in Fällen von Gewalt, Bedrohung, Belästigung, Anstößigkeit und [Bildklassifizierungen](classifier-get-started-with.md) tragen dazu bei, falsch klassifizierte Inhalte in gescannten Nachrichten zu reduzieren, wodurch Prüfern während des Untersuchungs- und Behebungsprozesses Zeit gespart wird.
...
- **Verbesserte Nachrichtenansichten:** Untersuchungs- und Korrekturaktionen sind jetzt schneller mit neuen Nachrichtenquell-, Text- und Anmerkungsansichten. Nachrichtenanlagen können jetzt angezeigt werden, um beim Ausführen von Korrekturmaßnahmen den vollständigen Kontext bereitzustellen.
...
- **Überwachungsunterstützung:** Ein vollständiges Protokoll der Richtlinien- und Überprüfungsaktivitäten wird ganz einfach aus der Microsoft 365 Compliance Center exportiert, um Überwachungsüberprüfungsanforderungen zu unterstützen.
...
- **Skype for Business Online:** Richtlinien zur Kommunikationscompliance unterstützen das Scannen der Chatkommunikation und zugehöriger Anlagen in [Skype for Business Online.](/SkypeForBusiness/skype-for-business-online)
...
- **Beheben**: Nachdem Sie ein Problem überprüft haben, können Sie es beheben, indem Sie die Warnung auflösen. Durch das Auflösen einer Warnung wird sie aus der ausstehenden Warnungswarteschlange entfernt, und die Aktion wird als Eintrag in der *aufgelösten Warteschlange* für die übereinstimmende Richtlinie beibehalten. Warnungen werden automatisch aufgelöst, nachdem die Warnung als falsch klassifiziert markiert, eine Benachrichtigung an einen Benutzer über die Warnung gesendet oder ein neuer Fall für die Warnung geöffnet wurde.
...
- **Bericht als falsch klassifiziert:** Nachrichten, die fälschlicherweise als Übereinstimmungen mit Compliancerichtlinien erkannt wurden, werden gelegentlich in den Überprüfungsprozess übertragen. Sie können diese Arten von Warnungen als falsch klassifiziert kennzeichnen, Feedback zu der fehlklassifizierung an Microsoft senden, um die globalen Klassifizierungen zu verbessern, und das Problem automatisch beheben.
