...
- [Hinzufügen importierter Dateien zu aktueller oder neuer Last](set-up-loads-to-add-imported-files.md) , die dem Relevanz-Training hinzugefügt werden. Bei einer Last handelt es sich um einen neuen Batch mit Dateien, die einem Fall hinzugefügt und dann für die Relevanz-Schulung verwendet werden. 
...
Nachdem Sie das Training eingerichtet haben, können Sie das Modul "Relevanz" ausführen und die Effektivität der Trainingseinstellungen bewerten. Dies führt zu einer Relevanz-Rangfolge, mit der Sie entscheiden können, ob Sie zusätzliche Schulungen durchführen müssen, oder ob Sie bereit sind, mit der Kennzeichnung von Dateien zu beginnen, die für Ihren Fall relevant sind.
  
- [Erfahren Sie mehr über den Prozess der Relevanz](use-relevance-in-advanced-ediscovery.md) und den iterativen Prozess der Bewertung, Tagging, Nachverfolgung und Umschulung basierend auf einem Beispiel für Dateisätze 
