...
Sie können die **Seite** Berichte anzeigen im Security & Compliance Center verwenden, um schnell auf Überwachungsberichte für Ihre SharePoint Online- und Exchange Online zugreifen. Sie können auch auf Azure Active Directory (AD)-Benutzer-Anmeldeberichte, Benutzeraktivitätsberichte und das Azure AD-Überwachungsprotokoll über die Seite Berichte **anzeigen** zugreifen. Dies liegt daran, dass Microsoft 365 abonnement ein kostenloses Abonnement für Microsoft Azure. Wenn Sie zum ersten Mal versuchen, auf diese Azure-Berichte zu zugreifen, müssen Sie einen einmaligen Registrierungsprozess abschließen. 
