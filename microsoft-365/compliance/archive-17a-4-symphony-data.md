...
---
# <a name="set-up-a-connector-to-archive-symphony-data-preview"></a>Einrichten eines Connectors zum Archivieren von Druckdaten (Vorschau)

Verwenden Sie [die "Computers DataParser"](https://www.17a-4.com/Symphony-dataparser/) von 17a-4 LLC zum Importieren und Archivieren von Kommunikationsdaten in Benutzerpostfächern in Ihrer Microsoft 365 Organisation. Der DataParser enthält einen Konnektor , der so konfiguriert ist, dass Elemente aus einer Datenquelle eines Drittanbieters erfasst und diese Elemente in Microsoft 365 importiert werden. Der Vorgangs-DataParser-Connector konvertiert Nachrichtendaten in ein E-Mail-Nachrichtenformat und importiert diese Elemente dann in Benutzerpostfächer in Microsoft 365.
...
3. Der von Ihnen im Microsoft 365 Compliance Center erstellte Connectors stellt eine Verbindung mit DataParser her und überträgt die Nachrichten an einen sicheren Azure Storage Ort in der Microsoft-Cloud.
...
Der Verbindungs-DataParser-Connector ordnen Benutzer automatisch ihren Microsoft 365 E-Mail-Adressen zu, bevor Daten in Microsoft 365 importiert werden.

## <a name="step-4-monitor-the-symphony-dataparser-connector"></a>Schritt 4: Überwachen des DataParser-Connectors

Nachdem Sie einen Vorgang DataParser-Connector erstellt haben, können Sie den Connectorstatus im Microsoft 365 Compliance Center anzeigen.
