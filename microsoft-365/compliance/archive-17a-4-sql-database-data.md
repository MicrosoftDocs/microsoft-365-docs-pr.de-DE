...
---
# <a name="set-up-a-connector-to-archive-sql-data"></a>Einrichten eines Connectors zum Archivieren SQL Daten
...
5. Melden Sie sich bei Ihrem 17a-4-Konto an, und führen Sie die Schritte im SQL DataParser-Verbindungs-Assistenten aus.
