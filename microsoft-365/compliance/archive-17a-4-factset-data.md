...
---
# <a name="set-up-a-connector-to-archive-factset-data"></a>Einrichten eines Connectors zum Archivieren von FactSet-Daten
...
Nachdem FactSet-Daten in Benutzerpostfächern gespeichert wurden, können Sie Microsoft 365 Compliancefeatures wie Beweissicherung für juristische Zwecke, eDiscovery, Aufbewahrungsrichtlinien und Aufbewahrungsbezeichnungen sowie Kommunikationscompliance anwenden. Die Verwendung eines FactSet-Connectors zum Importieren und Archivieren von Daten in Microsoft 365 kann Ihrer Organisation helfen, die Einhaltung von Behörden- und Behördlichen Richtlinien zu halten.
...
Der erste Schritt besteht darin, auf die Seite "Datenconnectors" im Microsoft 365 Compliance Center zuzugreifen und einen 17a-4-Connector für FactSet-Daten zu erstellen.
...
2. Klicken Sie auf der **FactSet DataParser-Produktbeschreibungsseite** auf **Connector hinzufügen.**
...
Der FactSet DataParser-Connector ordnen Benutzer automatisch ihren Microsoft 365 E-Mail-Adressen zu, bevor Daten in Microsoft 365 importiert werden.
