...
> [!IMPORTANT]
> Da wir weiterhin auf unterschiedliche Arten für die Aufbewahrung von Postfachinhalten investieren, kündigen wir den Ruhestand In-Place Holds in der Exchange-Verwaltungskonsole an. Das heißt, Sie sollten Beweissicherungsverfahren und Microsoft 365-Aufbewahrungsrichtlinien verwenden, um ein inaktives Postfach zu erstellen. Ab dem 1. Juli 2020 können Sie keine neuen In-Place erstellen, die in Exchange Online gespeichert sind. Sie können jedoch weiterhin die Aufbewahrungsdauer eines In-Place halten, der für ein inaktives Postfach gestellt wurde, ändern. Ab dem 1. Oktober 2020 können Sie die Aufbewahrungsdauer jedoch nicht ändern. Sie können ein inaktives Postfach nur löschen, indem Sie das In-Place Haltestatus entfernen. Vorhandene inaktive Postfächer, die sich in In-Place halten, werden weiterhin beibehalten, bis der Haltebereich entfernt wird. Weitere Informationen dazu, wann In-Place Holds in den Ruhestand gehen wird, finden Sie unter [Retirement of Legacy eDiscovery Tools](legacy-ediscovery-retirement.md).
