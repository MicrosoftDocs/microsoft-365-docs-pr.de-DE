...
- Nach dem Auftreten eines Ereignisses kann es bis zu 30 Minuten oder sogar bis zu 24 Stunden dauern, bis der entsprechende Überwachungsprotokolleintrag in den Ergebnissen der Überwachungsprotokollsuche angezeigt wird. Aus der folgenden Tabelle geht die Zeit hervor, die für die unterschiedlichen Dienste in Office 365 benötigt wird.
  ...
  |Verhinderung von Datenverlust|![Häkchen](../media/checkmark.png)||
  |Dynamics 365 CRM||![Häkchen](../media/checkmark.png)|
  |eDiscovery|![Häkchen](../media/checkmark.png)||
  |Exchange Online|![Häkchen](../media/checkmark.png)||
...
Eine Beschreibung der-App-Aktivitäten für Schicht-Aktivitäten finden Sie unter [Durchsuchen des Überwachungsprotokolls nach Ereignissen in Microsoft Teams](/microsoftteams/audit-log-events#shifts-in-teams-activities).
...
In der nachstehenden Tabelle sind die Quarantäneaktivitäten aufgeführt, nach denen Sie im Überwachungsprotokoll suchen können. Weitere Informationen zur Quarantäne finden Sie unter [In Quarantäne stellen von E-Mail-Nachrichten in Office 365](../security/defender-365-security/quarantine-email-messages.md).
...
- [Konfigurieren von Briefing-E-Mail](/Briefing/be-admin)
...
- Sie können Ereignisse auch im Exchange Admin Center anzeigen, oder durch Ausführen von **Search-AdminAuditLog** in der Exchange Online PowerShell. Dies ist eine gute Möglichkeit, um gezielt nach Aktivitäten zu suchen, die von Exchange Online-Administratoren durchgeführt wurden. Weitere Anweisungen finden Sie in:
  ...
  - [Anzeigen des Administratorüberwachungsprotokolls](/exchange/security-and-compliance/exchange-auditing-reports/view-administrator-audit-log)
