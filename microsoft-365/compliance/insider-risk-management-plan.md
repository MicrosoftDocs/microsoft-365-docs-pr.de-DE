...
Wählen Sie dedizierte Beteiligte aus, um die Warnungen und Fälle in regelmäßigen Abständen im Microsoft 365 [zu überwachen und zu überprüfen.](https://compliance.microsoft.com/) Stellen Sie sicher, dass Sie den verschiedenen Rollengruppen, die im Insider-Risikomanagement verfügbar sind, unterschiedliche Interessengruppen zuweisen.
...
**Lizenzierung:** Das Insider-Risikomanagement steht als Teil einer breiten Auswahl von Microsoft 365 zur Verfügung. Weitere Informationen finden Sie im [Artikel Erste Schritte mit Insider-Risikomanagement.](insider-risk-management-configure.md#subscriptions-and-licensing)
...
- Wenn Sie **die** Vorlage Datendiebstahl durch ausgehende Benutzer verwenden, müssen Sie einen Microsoft 365 Hr-Connector konfigurieren, um regelmäßig Informationen zu Kündigungen und Beendigungsdatum für Benutzer in Ihrer Organisation zu importieren. Schritt-für-Schritt-Anleitungen zum Konfigurieren des Microsoft 365 hr connector für Ihre Organisation finden Sie im Artikel Importieren von Daten mit dem Hr-Connector. [](import-hr-data.md)
...
- Wenn  Sie unzufriedene Benutzervorlagen verwenden, müssen Sie einen Microsoft 365 HR-Connector konfigurieren, um regelmäßig Leistungs- oder Statusinformationen für Benutzer in Ihrer Organisation zu importieren. Schritt-für-Schritt-Anleitungen zum Konfigurieren des Microsoft 365 hr connector für Ihre Organisation finden Sie im Artikel Importieren von Daten mit dem Hr-Connector. [](import-hr-data.md)
