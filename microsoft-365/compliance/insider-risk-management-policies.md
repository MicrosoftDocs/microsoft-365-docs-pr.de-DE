...
Wenn Benutzer Ihre Organisation verlassen, gibt es bestimmte Risikoindikatoren, die in der Regel mit Datendiebstahl durch ausscheidende Benutzer verknüpft sind. Diese Richtlinienvorlage verwendet Exfiltrationsindikatoren für die Risikobewertung und konzentriert sich auf Erkennung und Warnungen in diesem Risikobereich. Datendiebstahl für ausscheidende Benutzer kann das Herunterladen von Dateien von SharePoint Online, das Drucken von Dateien und das Kopieren von Daten in persönliche Cloudnachrichten- und Speicherdienste in der Nähe ihrer Kündigungs- und Endtermine umfassen. Indem Sie entweder den Microsoft 365-Personalconnector oder die Option zum automatischen Überwachen der Löschung von Benutzerkonten in Azure Active Directory für Ihre Organisation verwenden, beginnt diese Vorlage mit der Bewertung von Risikoindikatoren im Zusammenhang mit diesen Aktivitäten und deren Korrelation mit dem Status der Benutzerbeschäftigung.

>[!IMPORTANT]
>Wenn Sie diese Vorlage verwenden, können Sie einen Microsoft 365 für den regelmäßigen Import von Informationen zum Kündigungs- und Kündigungsdatum für Benutzer in Ihrer Organisation konfigurieren. Schritt-für-Schritt-Anleitungen zum Konfigurieren des Microsoft 365 hr connector für Ihre Organisation finden Sie im Artikel Importieren von Daten mit dem Hr-Connector. [](import-hr-data.md) Wenn Sie den Personalconnector nicht verwenden möchten, müssen Sie beim Konfigurieren von Triggerereignissen im Richtlinien-Assistenten die Option Benutzerkonto aus Azure AD gelöscht auswählen.

### <a name="general-data-leaks"></a>Allgemeine Datenlecks

Der Schutz von Daten und das Verhindern von Datenlecks stellt für die meisten Organisationen eine ständige Herausforderung dar, insbesondere mit dem schnellen Wachstum neuer Daten, die von Benutzern, Geräten und Diensten erstellt werden. Benutzer sind in der Lage, Informationen über Dienste und Geräte hinweg zu erstellen, zu speichern und gemeinsam zu nutzen, was die Verwaltung von Datenlecks immer komplexer und schwieriger macht. Datenlecks können versehentliche Überschatten von Informationen außerhalb Ihrer Organisation oder Datendiebstahl mit böswilliger Absicht umfassen. Mit einer zugewiesenen Richtlinie zur Verhinderung von Datenverlust (Data Loss Prevention, DLP) oder dem integrierten Triggerereignis beginnt diese Vorlage, verdächtige SharePoint Online-Datendownloads, Datei- und Ordnerfreigabe, Drucken von Dateien und Kopieren von Daten in persönliche Cloudnachrichten- und Speicherdienste in Echtzeit zu erkennen.
...
Ausgehende Benutzer, unabhängig davon, ob sie positive oder negative Konditionen verlassen, können höhere Risiken für Sicherheitsrichtlinienverletzungen haben. Zum Schutz vor unbeabsichtigten oder böswilligen Sicherheitsverstößen für ausscheidende Benutzer verwendet diese Richtlinienvorlage Defender for Endpoint-Warnungen, um Einblicke in sicherheitsrelevante Aktivitäten zu erhalten. Zu diesen Aktivitäten gehören das Installieren von Schadsoftware oder anderen potenziell schädlichen Anwendungen sowie das Deaktivieren von Sicherheitsfeatures auf ihren Geräten. Indem Sie [](import-hr-data.md) entweder den Microsoft 365-Personalconnector oder die Option zum automatischen Überwachen der Löschung von Benutzerkonten in Azure Active Directory für Ihre Organisation verwenden, beginnt diese Vorlage mit der Bewertung von Risikoindikatoren im Zusammenhang mit diesen Sicherheitsaktivitäten und deren Korrelation mit dem Status der Benutzerbeschäftigung.
...
| :------------------ | :--------------------------------- | :---------------- |
| Datendiebstahl durch ausgehende Benutzer | Anzeige des Kündigungs- oder Kündigungsdatums vom Personalabteilungsconnector | (optional) Microsoft 365 Hr Connector konfiguriert für Datumsindikatoren für Kündigung und Kündigung oder Azure Active Directory Integration aktiviert |
...
| Datenlecks durch unzufriedene Benutzer | Leistungsverbesserung, leistungsärmere Leistung oder Änderungsindikatoren auf Auftragsebene vom Personalabteilungsconnector | Microsoft 365 Für Unzufriedene Indikatoren konfigurierter Personalconnector |
...
| Sicherheitsrichtlinienverletzungen durch ausscheidende Benutzer | Kündigungs- oder Beendigungsdatumsindikatoren vom Personalconnector oder Azure Active Directory Kontolöschung | (optional) Microsoft 365 Für Datumsindikatoren für Kündigung und Kündigung konfigurierter Personalconnector <br><br> Aktives Microsoft Defender for Endpoint-Abonnement <br><br> Microsoft Defender for Endpoint-Integration in Microsoft 365 Compliance Center konfiguriert |
...
| Sicherheitsrichtlinienverletzungen durch verärgerte Benutzer | Leistungsverbesserung, leistungsärmere Leistung oder Änderungsindikatoren auf Auftragsebene vom Personalabteilungsconnector | Microsoft 365 Für Unzufriedene Indikatoren konfigurierter Personalconnector <br><br> Aktives Microsoft Defender for Endpoint-Abonnement <br><br> Microsoft Defender for Endpoint-Integration in Microsoft 365 Compliance Center konfiguriert |
...
Beispielsweise verfügt Ihre Organisation über eine dedizierte SharePoint für ein streng vertrauliches Projekt. Datenlecks für Informationen an dieser SharePoint könnten das Projekt gefährdeten und sich erheblich auf den Erfolg auswirken. Durch die Priorisierung SharePoint Website in einer Richtlinie für Datenlecks werden die Risikobewertungen für qualifizierende Aktivitäten automatisch erhöht. Diese Priorisierung erhöht die Wahrscheinlichkeit, dass diese Aktivitäten eine Insiderrisikowarnung generieren, und erhöht den Schweregrad für die Warnung.
...
- **SharePoint** Websites: Jeder Aktivität, die allen Dateitypen in definierten SharePoint zugeordnet ist, wird eine höhere Risikopunktzahl zugewiesen. 
...
Zum Erstellen einer neuen Richtlinie für insider risk management verwenden Sie den Richtlinienassistenten in **Insider Risk Management** Solution im Microsoft 365 Compliance Center.
...
Zum Aktualisieren einer vorhandenen Insider-Risikomanagementrichtlinie verwenden Sie den Richtlinien-Assistenten in **insider risk management** solution im Microsoft 365 Compliance Center.
...
1. Wechseln Sie Microsoft 365 Compliance Center zu Insider Risk Management, und wählen Sie die Registerkarte Richtlinien aus.
...
- Wenn Sie Ihren Personalconnector noch nicht konfiguriert haben, Sie jedoch mit der Zuweisung von Risikowerten zu Benutzeraktivitäten für Hr-Ereignisse beginnen möchten, indem Sie eine .csv für die Benutzer hochladen
...
7. Wenn Sie eine Liste der Benutzer importieren möchten, die den Richtlinien hinzugefügt werden, wählen Sie **Importieren** aus, um eine .csv (durch Kommas getrennte Werte) zu importieren. Die Datei muss das folgende Format haben, und Sie müssen die Benutzerprinzipalnamen in der Datei auflisten:
