...
---
# <a name="compliance-offering-cloud-security-alliance-csa-star-certification"></a>Complianceangebot: Cloud Security Alliance (CSA) STAR-Zertifizierung
...
Erfahren Sie mehr über die Vorteile der CSA STAR-Zertifizierung in Microsoft Cloud: [Hintergrundwissen zu CSA STAR-Zertifizierung herunterladen](https://aka.ms/csastar-certification-backgrounder)
...
Sie können die [CSA STAR-Zertifizierung](https://aka.ms/csastar-certification) für Azure (gilt auch für Intune und Power BI) aus der CSA Registry herunterladen.

**Welchen Bewertungsgrad haben Microsoft Cloud Services erreicht?**

Azure, Cloud App Security, Intune und Power BI haben den höchsten Gold Award für die Maturity Capability-Bewertung erhalten.
...
Benötigen Sie das Dokument mit Hintergrundwissen für dieses Angebot? Laden Sie die [PDF-Datei](https://download.microsoft.com/download/C/3/6/C36C6DBB-AF39-44A2-B6C6-50CC6E4991D7/CSA-STAR-Certification-Compliance.pdf) herunter.
