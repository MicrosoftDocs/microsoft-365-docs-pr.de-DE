...
- **Azure Security and Compliance Blueprints:** Ressourcen, die Sie bei der Erstellung sicherer und kompatibler Cloud-basierter Anwendungen unterstützen. Dieser Bereich enthält Blueprint-Anleitungen für die vertikalen Bereiche Government, Finance, Healthcare und Retail.
...
Wechseln Sie zu **Weitere #a0 Administrator** , um auf administrative Funktionen zuzugreifen, die nur für das globale Administratorkonto verfügbar sind. Diese Option ist nur sichtbar, wenn Sie als globaler Administrator angemeldet sind. Im Pulldown-Menü **Admin** gibt es zwei Optionen:
...
- **Assessment Starter Pack:** Verwenden Sie nach der Evaluierung die Checklisten und andere Anleitungen in diesem Starter Pack, um Ihre Organisation bei der Bewertung von Risiken im Zusammenhang mit Sicherheit, Compliance und Datenschutz zu unterstützen.

- **Startpaket für Überwachung:** Benutzer dieses Starter Packs finden Sie Anleitungen zur Verwendung von Überwachungs Steuerelementen und anderen Tools, um die Implementierung von Microsoft Cloud-Diensten so zu unterstützen, dass die Gefährdung Ihrer Organisation reduziert werden kann.
