...
---
# <a name="manage-cases-in-core-ediscovery"></a>Verwalten von Fällen in der zentralen eDiscovery

## <a name="create-a-case"></a>Erstellen einer Anfrage

## <a name="close-a-case"></a>Schließen einer Anfrage

## <a name="reopen-a-case"></a>Erneutes Öffnen eines Falls
