...
Wenn eine Regel abgeglichen wird, können Sie eine Benachrichtigungs-E-Mail mit Details zur Warnung an Ihren Compliance Officer (oder eine beliebige Person) senden. Diese E-Mail-Warnung enthält einen Link zum [Verwaltungsdashboard für DLP-Warnungen](dlp-configure-view-alerts-policies.md), zu dem der Compliance Officer zum Anzeigen der Details zu den Warnungen und Ereignissen wechseln kann. Das Dashboard enthält Details zu dem Ereignis, durch das die Warnung ausgelöst wurde, sowie zur entsprechenden DLP-Richtlinie und den erkannten vertraulichen Inhalten.
