...
- **Unterhaltungsansicht (Vorschau):** Diese Ansicht ist für Microsoft Teams Chatnachrichten verfügbar und zeigt bis zu fünf Nachrichten vor und nach einer Benachrichtigung an, damit Prüfer die Aktivität im Unterhaltungskontext anzeigen können. Dieser Kontext hilft Prüfern, Nachrichten schnell auszuwerten und fundiertere Entscheidungen zur Nachrichtenauflösung zu treffen. Echtzeitnachrichtenergnungen zu Unterhaltungen werden angezeigt, einschließlich aller Inlinebilder, Emojis und Aufkleber, die in Teams. Bild- oder Textdateianlagen zu Nachrichten werden nicht angezeigt. Benachrichtigungen werden automatisch für bearbeitete Nachrichten oder für Nachrichten angezeigt, die aus dem Unterhaltungsfenster gelöscht wurden. Wenn eine Nachricht aufgelöst wird, werden die zugeordneten Unterhaltungsnachrichten nicht mit der aufgelösten Nachricht beibehalten. Unterhaltungsnachrichten sind bis zu 60 Tage nach der Benachrichtigung verfügbar.
