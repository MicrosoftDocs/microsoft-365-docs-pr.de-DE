...
Nach dem Import der TPD müssen Sie sicherstellen, dass eine AD RMS-Rechterichtlinienvorlage verteilt wird. Eine verteilte Vorlage ist für Outlook im Web (früher als Outlook Web App bezeichnet) Benutzer sichtbar, die die Vorlagen dann auf eine E-Mail-Nachricht anwenden können.
...
- Verfassen Sie eine neue Nachricht in Outlook im Web und IRM schützen Sie sie, indem Sie im erweiterten Menü die Option **"Berechtigungen festlegen"** auswählen ( ![ Symbol "Weitere ](../media/ITPro-EAC-MoreOptionsIcon.gif) Optionen").
