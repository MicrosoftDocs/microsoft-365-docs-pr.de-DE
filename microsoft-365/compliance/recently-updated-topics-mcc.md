...
Ähnlich wie bei den Features des Microsoft 365 Compliance Centers werden auch unsere Hilfeinhalte ständig weiterentwickelt. Wir erstellen kontinuierlich neue Artikel, aktualisieren bestehende und nehmen daran Änderungen basierend auf Ihrem Feedback vor. Sehen Sie sich die Neuerungen und Updates in diesem Monat an.
...
[Erweiterte Überwachung in Microsoft 365](advanced-audit.md) (neu)<br>Die erweiterte Überwachung ist für Organisationen mit einem Office 365 E5- oder Microsoft 365 Enterprise E5-Abonnement verfügbar. Sie erweitert vorhandene Überwachungsfunktionen durch Features wie lange Aufbewahrungszeiträume für Überwachungsprotokolle, neue Aufbewahrungsrichtlinien für Überwachungsprotokolle und eine neue Postfachüberwachungsaktion zum Nachverfolgen von E-Mail-Lesevorgängen.

[Verwalten von Aufbewahrungsrichtlinien für Überwachungsprotokolle](audit-log-retention-policies.md) (neu)<br>Details zur Verwaltung von Aufbewahrungsrichtlinien für Überwachungsprotokolle, dem neuen erweiterten Überwachungsfeature, das es Ihnen ermöglicht, Überwachungsdatensätze aus unterschiedlichen Diensten für bis zu ein Jahr zu speichern.
...
[ENISA Information Assurance Framework](offering-enisa.md) (neu)<br>Neues Thema zur Unterstützung des Information Assurance Framework (IAF) der European Network and Information Security Agency (ENISA).

[Service Organization Controls (SOC)](offering-SOC.md) (aktualisiert)<br>Neue Überwachungsreferenzen hinzugefügt.

[Australian Prudential Regulation Authority (APRA)](offering-APRA-Australia.md) (aktualisiert)<br>Inhalte an neue gesetzliche Normen angepasst.
...
[Versionshinweise für die öffentliche Vorschau der Datenklassifizierung (Vorschau)](data-classification-pub-preview-relnotes.md) (neu)<br>Versionshinweise für die öffentliche Vorschau, mit der eine neue Funktionalität eingeführt wird, mit der das Überprüfen Ihrer vertraulichen und beschrifteten Inhalte beginnt, bevor Sie Richtlinien erstellen. Auf diese Weise können Sie überprüfen, wie vorhandene Aufbewahrungs- und Vertraulichkeitsbezeichnungen sich auf Ihre Organisation auswirken, um Ihre Anforderungen in puncto Schutz- und Governance-Richtlinie besser zu beurteilen.

### <a name="gdpr"></a>DSGVO

[Anträge betroffener Personen für Office 365 im Rahmen der DSGVO und des CCPA](gdpr-dsr-Office365.md) (aktualisiert)<br>Verweise auf Microsoft StaffHub wurden aufgrund der [Einstellung dieser Anwendung](https://docs.microsoft.com/microsoftteams/expand-teams-across-your-org/shifts/microsoft-staffhub-to-be-retired) entfernt.

In den folgenden Artikeln wurden Compliance Manager-Verweise und aktualisierte Links zur Compliancebewertung hinzugefügt.<br>
[Zusammenfassung Datenschutz-Grundverordnung](gdpr.md) (Artikel enthält außerdem neue häufig gestellte Fragen aus dem Trust Center.)<br>
[DSGVO-Aktionsplan für Microsoft 365: die wichtigsten Prioritäten für die ersten 30 Tage, 90 Tage und danach](gdpr-action-plan.md)<br>
[Unterstützung des DSGVO-Programms mit Prüflisten zu den Verantwortlichkeiten](gdpr-arc.md)<br>
[Azure-Prüfliste zu den Verantwortlichkeiten für die DSGVO](gdpr-arc-Azure.md)<br>
[Dynamics 365-Prüfliste zu den Verantwortlichkeiten für die DSGVO](gdpr-arc-Dynamics365.md)<br>
[Prüfliste zu den Verantwortlichkeiten für die DSGVO für Microsoft Office 365](gdpr-arc-Office365.md)<br>

### <a name="insider-risk-management"></a>Insider-Risikomanagement

Die folgenden Artikel wurden zur Unterstützung der offiziellen Veröffentlichung des Insider-Risikomanagements aktualisiert.<br>
[Informationen zum Insider-Risikomanagement in Microsoft 365](insider-risk-management.md)<br>
[Erste Schritte mit dem Insider-Risikomanagement](insider-risk-management-configure.md)<br>
[Erstellen und Verwalten von Insider-Risikorichtlinien](insider-risk-management-policies.md)<br>
[Untersuchen von Insider-Risikowarnungen](insider-risk-management-alerts.md)<br>
[Maßnahmen bei Insider-Risikofällen ergreifen](insider-risk-management-cases.md)<br>
[Überprüfen von Daten mit dem Inhalts-Explorer für Insider-Risiken](insider-risk-management-content-explorer.md)<br>
[Hinzufügen von Benutzern zu Insider-Risikorichtlinien](insider-risk-management-users.md)<br>
[Erstellen von Benachrichtigungen zu Insider-Risiken](insider-risk-management-notices.md)<br>
...
[Erste Schritte mit Vertraulichkeitsbezeichnungen](get-started-with-sensitivity-labels.md) (neu)<br>Umfasst Anleitungen für Azure Information Protection-Kunden, eine allgemeine Übersicht über den Vorgang und die Schritte zur Bereitstellung von Vertraulichkeitsbezeichnungen, Berechtigungen zum Erstellen und Verwalten von Bezeichnungen, eine Liste allgemeiner Szenarien, die Bezeichnungen unterstützen, sowie eine Liste verfügbarer Endbenutzerdokumentationen.

[ Informationen zu Vertraulichkeitsbezeichnungen](sensitivity-labels.md) (aktualisiert)<br>Neuer Titel (zuvor "Übersicht über Vertraulichkeitsbezeichnungen") und die Informationen aus dem Abschnitt "Erste Schritte" in den neuen Artikel [Erste Schritte mit Vertraulichkeitsbezeichnungen](get-started-with-sensitivity-labels.md) verschoben.

[Erstellen und Konfigurieren von Vertraulichkeitsbezeichnungen und deren Richtlinien](create-sensitivity-labels.md) (aktualisiert)<br>Informationen zu Berechtigungen wurden in den neuen Artikel [Erste Schritte mit Vertraulichkeitsbezeichnungen](get-started-with-sensitivity-labels.md) verschoben.

[Einschränken des Zugriffs auf Inhalte mithilfe von Vertraulichkeitsbezeichnungen zur Verschlüsselung](encryption-sensitivity-labels.md) (aktualisiert)<br>Die neuen Optionen "Keine" und "Entfernen" ersetzen die Umschaltfläche "Verschlüsselung"; die Option "Alle authentifizierten Benutzer hinzufügen" wurde als neue Berechtigung hinzugefügt, die nun erteilt werden kann. Der Abschnitt über das Zulassen, dass Benutzer Berechtigungen erteilen, wurde dahingehend aktualisiert, dass nun die Aufforderung an Benutzer, benutzerdefinierte Berechtigungen in Word, PowerPoint und Excel auszuwählen, in der Vorschau für Windows und Mac bereitgestellt wird. Neuer Abschnitt für Beispielkonfigurationen zum Konfigurieren der Verschlüsselungseinstellungen für spezifische Anwendungsfälle. Neuer Abschnitt mit Überlegungen zum Verschlüsseln von Inhalten.
...
[Verwenden von Vertraulichkeitsbezeichnungen in Office-Apps](sensitivity-labels-office-apps.md) (aktualisiert)<br>Die Funktionstabellen wurden so aktualisiert, dass Benutzer Berechtigungen zuweisen können und eine Bezeichnung automatisch auf Inhalte angewendet werden kann. Außerdem wurde aufgrund von Kundenfeedback für E-Mail-Anlagen, die eine Bezeichnung erben, eine Ausnahme hinzugefügt.

### <a name="service-descriptions"></a>Dienstbeschreibungen

[Microsoft 365-Lizenzierungsleitfaden für Sicherheit und Compliance](https://docs.microsoft.com/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-tenantlevel-services-licensing-guidance/microsoft-365-security-compliance-licensing-guidance) (aktualisiert)<br>Neuer Titel (zuvor "Microsoft 365-Dienste auf Mandantenebene – Leitfaden zur Lizenzierung"), um den Inhalt besser darzustellen.
