...
|Empfehlung  |E3  |E5  |
|---------|---------|---------|
|**Richten Sie die mehrstufige Authentifizierung ein, und verwenden Sie empfohlene Richtlinien** für bedingten Zugriff, einschließlich Anmelderisikorichtlinien. Microsoft empfiehlt und hat eine Reihe von Richtlinien getestet, die zum Schutz aller Cloud-Apps zusammenarbeiten, einschließlich Office 365- und Microsoft 365-Diensten. Weitere [Informationen finden Sie unter Identitäts- und Gerätezugriffskonfigurationen.](./defender-365-security/microsoft-365-policies-configurations.md) | |![grünes Häkchen](../media/green-check-mark.png)|
