...
Sie konfigurieren die meisten Einstellungen für sichere Links in Richtlinien für sichere Links. Anweisungen finden Sie unter [Set up Safe Links policies in Microsoft Defender for Office 365](set-up-safe-links-policies.md).

Safe Links verwendet jedoch auch die folgenden globalen Einstellungen, die Sie außerhalb der Richtlinien für sichere Links selbst konfigurieren:

- The **Block the following URLs** list. Diese Einstellung gilt für alle Benutzer, die in aktiven Richtlinien für sichere Links enthalten sind. Weitere Informationen finden Sie unter ["Blockieren der folgenden URLs" für sichere Links.](safe-links.md#block-the-following-urls-list-for-safe-links)
- Schutz für sichere Links für Office 365 Apps. Diese Einstellungen gelten für alle Benutzer in der Organisation, die für Defender for Office 365 lizenziert sind, unabhängig davon, ob die Benutzer in aktiven Richtlinien für sichere Links enthalten sind oder nicht. Weitere Informationen finden Sie unter [Einstellungen für sichere Links für Office 365 Apps](safe-links.md#safe-links-settings-for-office-365-apps).
...
- Es gibt keine integrierte oder standardmäßige Richtlinie für sichere Links, daher müssen Sie mindestens eine Richtlinie für sichere Links erstellen, damit die Liste der folgenden **URLs** blockieren aktiv ist. Anweisungen finden Sie unter [Set up Safe Links policies in Microsoft Defender for Office 365](set-up-safe-links-policies.md).
...
- Verwenden Sie zum Hinzufügen von Werten, die vorhandene Einträge ersetzen, die folgende Syntax in Exchange Online PowerShell oder Exchange Online Protection PowerShell:
...
## <a name="configure-safe-links-protection-for-office-365-apps-in-the-security--compliance-center"></a>Konfigurieren des Schutzes sicherer Links Office 365 Apps im Security & Compliance Center

Der Schutz sicherer Links für Office 365 gilt für Dokumente in unterstützten Office Desktop-, Mobile- und Web-Apps. Weitere Informationen finden Sie unter [Einstellungen für sichere Links für Office 365 Apps](safe-links.md#safe-links-settings-for-office-365-apps).

1. Wechseln Sie im Security & Compliance Center **zu** Richtlinie für die Bedrohungsverwaltung \>  \> **ATP Sichere Links,** und klicken Sie dann auf **Globale Einstellungen**.

2. Konfigurieren Sie **in** der angezeigten Richtlinie für sichere Links für Ihre Organisation die folgenden Einstellungen in der Einstellungen, die für Inhalte außer E-Mail **gelten:**

   - **Office 365:** Überprüfen Sie, ob der Umschalter rechts ist, um sichere Links für unterstützte Office 365 zu ![ aktivieren: Umschalten auf ](../../media/scc-toggle-on.png) .

   - **Nicht nachverfolgen,** wenn Benutzer auf sichere Links klicken: Verschieben Sie die Umschalte nach links, um Benutzerklicks im Zusammenhang mit blockierten URLs in unterstützten Office 365 zu verfolgen: ![ Umschalten aus ](../../media/scc-toggle-off.png) .

   - Benutzer dürfen nicht auf sichere Links zur ursprünglichen **URL** klicken: Vergewissern Sie sich, dass die Umschalte rechts ist, um zu verhindern, dass Benutzer auf die ursprüngliche blockierte URL in unterstützten Office 365-Apps klicken: Umschalten ![ auf ](../../media/scc-toggle-on.png) .

   Klicken Sie nach Abschluss des Vorgangs auf **Speichern**.

### <a name="configure-safe-links-protection-for-office-365-apps-in-powershell"></a>Konfigurieren des Schutzes sicherer Links für Office 365 in PowerShell
...
In diesem Beispiel werden die folgenden Einstellungen für den Schutz sicherer Links in Office 365 konfiguriert:
...
- Benutzer dürfen in unterstützten Office 365-Apps nicht auf die ursprüngliche blockierte URL klicken (wir verwenden den _Parameter AllowClickThrough_ nicht, und der Standardwert ist $false).
...
Gehen Sie wie folgt vor, um zu überprüfen, ob Sie die globalen Einstellungen für sichere Links erfolgreich konfiguriert haben (die Liste der folgenden **URLs** blockieren und die Office 365-App-Schutzeinstellungen):
...
- Führen Exchange Online PowerShell oder Exchange Online Protection PowerShell den folgenden Befehl aus, und überprüfen Sie die Einstellungen:
