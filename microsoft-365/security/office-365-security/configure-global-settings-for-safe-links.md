...
- The **Block the following URLs** list. Weitere Informationen finden Sie unter ["Blockieren der folgenden URLs" für sichere Links.](atp-safe-links.md#block-the-following-urls-list-for-safe-links)
...
3. Konfigurieren Sie einen oder mehrere Einträge, wie unter [Entry syntax for the "Block the following URLs" list beschrieben.](atp-safe-links.md#entry-syntax-for-the-block-the-following-urls-list)
...
Weitere Informationen zur Eintragssyntax finden Sie unter [Entry syntax for the "Block the following URLs" list](atp-safe-links.md#entry-syntax-for-the-block-the-following-urls-list).
