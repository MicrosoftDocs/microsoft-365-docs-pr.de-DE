...
|Massen-E-Mail-Filterung|EoP verwendet den Massen Reklamations Schwellenwert (BCL), um Massen-e-Mails als Spam zu markieren. Weitere Informationen hierzu finden Sie in den folgenden Themen: <br/><br/> [Worin besteht der Unterschied zwischen Junk-E-Mail und Massen-E-Mail?](what-s-the-difference-between-junk-email-and-bulk-email.md) <br/> [Massen Reklamations Ebene (BCL) in EoP](bulk-complaint-level-values.md) <br/> [Konfigurieren von Antispamrichtlinien](configure-your-spam-filter-policies.md)|
