...
- Sie müssen Berechtigungen in Exchange Online zugewiesen werden, bevor Sie die Verfahren in diesem Artikel ausführen können. Sie benötigen insbesondere die **Empfängerrichtlinien** oder Rollen für **e-Mail-Empfänger** , die standardmäßig der Rollengruppe " **Organisationsverwaltung** " und " **Empfängerverwaltung** " zugewiesen sind. Weitere Informationen zu Rollengruppen in Exchange Online finden Sie unter [Berechtigungen in Exchange Online](https://docs.microsoft.com/exchange/permissions-exo/permissions-exo) und [Ändern von Rollengruppen in Exchange Online](https://docs.microsoft.com/Exchange/permissions-exo/role-groups#modify-role-groups).
