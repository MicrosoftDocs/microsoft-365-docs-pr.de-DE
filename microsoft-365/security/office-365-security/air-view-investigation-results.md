...
Im Rahmen einiger Textbuch-Elemente korreliert Air e-Mail-Bedrohungen mit Geräten (z. b. gezappte Schadsoftware). Beispielsweise übergibt eine Untersuchung einen bösartigen Datei Hash an [Microsoft Defender](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection
...
|Untersuchung von URL-Klicks| Untersuchen von Klicks von Benutzern, die durch [sichere Links in Microsoft Defender](atp-safe-links.md) geschützt sind, für Office 365 in Ihrer Organisation|
...
- [Informationen zur automatischen Untersuchung und Antwort in Microsoft 365 Defender](https://docs.microsoft.com/microsoft-365/security/mtp/mtp-autoir)
