...
- Bevor Sie die in diesem Artikel besprochenen Verfahren ausführen können, müssen Ihnen Berechtigungen zugewiesen werden:
  ...
  - Wenn Sie Anti-Spam-Richtlinien hinzufügen, ändern und löschen möchten, müssen Sie Mitglied einer der folgenden Rollengruppen sein:
  ...
  - Für den schreibgeschützten Zugriff auf Anti-Spam-Richtlinien müssen Sie Mitglied einer der folgenden Rollengruppen sein:
...
5. (Optional) Erweitern Sie den Abschnitt **Zulassungslisten**, um Nachrichtenabsender anhand der E-Mail-Adresse oder der E-Mail-Domäne zu konfigurieren, die die Spamfilterung überspringen dürfen:
   ...
   > [!CAUTION]
   >
   > - Überlegen Sie es sich genau, bevor Sie hier Domänen hinzufügen. Weitere Informationen finden Sie unter [Erstellen sicherer Absenderlisten in EOP](create-safe-sender-lists-in-office-365.md).
   >
