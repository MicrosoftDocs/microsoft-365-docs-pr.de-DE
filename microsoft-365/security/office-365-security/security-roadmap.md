...
|:-----|:-----|
|Bereich|Aufgaben|
|Sicherheitsverwaltung|* Check Secure Score und notieren Sie sich Ihre aktuelle[https://securescore.office.com](https://securescore.office.com)Punktzahl ().  <br/>  * Aktivieren Sie die Überwachungsprotokollierung für Office 365. Weitere Informationen finden Sie unter [Durchsuchen des Überwachungsprotokolls](../../compliance/search-the-audit-log-in-security-and-compliance.md).  <br/> * [Konfigurieren Sie Microsoft 365 für mehr Sicherheit](tenant-wide-setup-for-increased-security.md) .  <br/>  * Regelmäßige Überprüfung von Dashboards und Berichten im Microsoft 365 Security Center und in der Cloud-App-Sicherheit.|
