...
Um Schadsoftware in E-Mails zu sehen, die nach Microsoft 365 Technologie sortiert sind, verwenden Sie die [E-Mail-> Schadsoftwareansicht](threat-explorer-views.md#email--malware) des Explorers (oder Echtzeiterkennungen). Schadsoftware ist die Standardansicht, sodass sie möglicherweise ausgewählt wird, sobald Sie Explorer öffnen.

1. Wählen Sie im Microsoft 365 Defender-Portal ( <https://security.microsoft.com> ) **E-Mail-&** \> **Zusammenarbeits-Explorer (oder Echtzeiterkennungen)** aus.  (In diesem Beispiel wird Explorer verwendet.) Wenn Sie sich im zusammengeführten Microsoft 365 Defender-Portal befinden ( scrollen Sie https://security.microsoft.com/) zu **E-Mail & Zusammenarbeits-Explorer**  >  .
...
2. Wählen Sie im Menü **"Ansicht"** die Option **"Schadsoftware"** unter **"E-Mail"** aus.
