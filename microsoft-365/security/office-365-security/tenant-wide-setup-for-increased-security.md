...
|**Sichere Anlagen in Microsoft Defender für Office 365**|Nein|Klicken Sie auf der Hauptseite für sichere Anlagen auf **globale Einstellungen** , und aktivieren Sie diese Einstellung: <br/> &ensp;&ensp;**Aktivieren von ATP für SharePoint, OneDrive und Microsoft Teams** <br/><br/> Erstellen Sie mit den folgenden Einstellungen eine Richtlinie für sichere Anlagen: <br/> &ensp;&ensp;* **Block** : Wählen Sie als unbekannte Malware Antwort **blockieren** aus. <br/> &ensp;&ensp;* **Umleitung aktivieren** : Aktivieren Sie dieses Kontrollkästchen, und geben Sie eine e-Mail-Adresse ein, beispielsweise ein Administrator-oder Quarantäne Konto. <br/> &ensp;&ensp;* **Anwenden der obigen Auswahl, wenn die Malwareüberprüfung nach Anlagen ein Timeout oder ein Fehler auftritt** : Aktivieren Sie dieses Kontrollkästchen. <br/> &ensp;&ensp;* **Angewendet auf** : **die Empfängerdomäne ist die** \> Domäne auswählen. <br/><br/> Weitere Informationen: [ATP für SharePoint, OneDrive und Microsoft Teams](atp-for-spo-odb-and-teams.md) und [Einrichten von Richtlinien für sichere Anlagen](set-up-atp-safe-attachments-policies.md)|
|**Sichere Links in Microsoft Defender für Office 365**|Ja|Klicken Sie auf der Hauptseite für sichere Links auf **globale Einstellungen** : <br/> &ensp;&ensp;* **Verwenden Sie sichere Links in: Office 365 Anwendungen** : Vergewissern Sie sich, dass diese Einstellung aktiviert ist. <br/> &ensp;&ensp;* **Nicht nachverfolgen, wenn Benutzer auf sichere Links klicken** : Deaktivieren Sie diese Einstellung, um Benutzerklicks nachzuverfolgen.<br/><br/>Erstellen Sie eine Richtlinie für sichere Links mit den folgenden Einstellungen: <br/> &ensp;&ensp;* **Wählen Sie die Aktion für unbekannte potenziell bösartige URLs in Nachrichten** aus: Vergewissern Sie sich, dass diese Einstellung **eingeschaltet** ist. <br/> &ensp;&ensp;* **Wählen Sie die Aktion für unbekannte oder potenziell bösartige URLs in Microsoft Teams** : überprüfen, ob diese Einstellung **eingeschaltet** ist. <br/> &ensp;&ensp;* **Echt Zeit-URL-Überprüfung für verdächtige Links und Links, die auf Dateien verweisen, anwenden** : Aktivieren Sie dieses Kontrollkästchen. <br/> &ensp;&ensp;&ensp;&ensp;*  **Warten Sie, bis die URL-Überprüfung abgeschlossen ist, bevor Sie die Nachricht** übermitteln: Aktivieren Sie dieses Kontrollkästchen. <br/> &ensp;&ensp;* **Anwenden von sicheren Links auf e-Mail-Nachrichten, die innerhalb der Organisation gesendet werden** : Aktivieren Sie dieses Kontrollkästchen. <br/> &ensp;&ensp;* **Benutzer dürfen nicht auf die ursprüngliche URL klicken** : Aktivieren Sie dieses Kontrollkästchen. <br/> &ensp;&ensp;* **Angewendet auf** : **die Empfängerdomäne ist die** \> Domäne auswählen. <br/><br/> Weitere Informationen: [Richtlinien für sichere Links einrichten](set-up-atp-safe-links-policies.md).|
