...
|---|---|
|[Dashboard für die Bedrohungsverwaltung](security-dashboard.md)|Verwenden Sie dieses Dashboard im Abschnitt **"Bedrohungsmanagement"** des Microsoft 365 Defender-Portals, um Bedrohungen anzuzeigen, die bereits behandelt wurden, und als praktisches Tool für die Meldung an Entscheidungsträger in Unternehmen, welche Bedrohungsuntersuchungs- und Reaktionsfunktionen bereits zur Sicherung Ihres Unternehmens unternommen wurden.|
