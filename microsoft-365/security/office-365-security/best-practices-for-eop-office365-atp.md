...
---
# <a name="best-practices-for-eop-and-office-365-atp-security"></a>Bewährte Methoden für EoP und Office 365 ATP-Sicherheit
...
|EnableAuthenticationSoftPassSafetyTip|False|Richtig|Diese Einstellung ist nur in PowerShell verfügbar.|
|EnableSuspiciousSafetyTip|False|Richtig|Diese Einstellung ist nur in PowerShell verfügbar.|
|TreatSoftPassAsAuthenticated|Richtig|False|Diese Einstellung ist nur in PowerShell verfügbar.|
