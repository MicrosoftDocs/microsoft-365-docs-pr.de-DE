...
Wenn ein Benutzer eines der oben genannten Symptome meldet, sollten Sie weitere Untersuchungen durchführen. [Microsoft 365 Defender](https://security.microsoft.com) und das Azure-Portal bieten Tools, mit denen Sie die Aktivität eines Benutzerkontos untersuchen können, von dem Sie vermuten, dass es angegriffen wurde.
...
5. Suchen Sie den Benutzer und wählen Sie ihn aus. Das Flyout mit den Postfachdetails wird geöffnet. Führen Sie dort die folgenden Schritte aus:
   - Blockieren Sie im Abschnitt **E-Mail-Apps** alle verfügbaren Einstellungen, indem Sie die Umschaltfläche nach rechts auf ![Deaktivieren](../../media/scc-toggle-on.png) verschieben:
     - **Outlook im Web**
...
3. Öffnen Sie das EAC unter <https://admin.exchange.microsoft.com>, und führen Sie die folgenden Schritte aus:
   ...
   2. Wählen Sie auf der Seite **Administratorrollen** die einzelnen Rollengruppen und im Detailbereich die Registerkarte **Zugewiesen** aus, um die Benutzerkonten zu überprüfen. Führen Sie die folgenden Schritte aus, wenn die Rollengruppe das Benutzerkonto enthält:
      ...
      2. Klicken Sie auf das ![Symbol „Löschen“](../../media/m365-cc-sc-delete-icon.png).
