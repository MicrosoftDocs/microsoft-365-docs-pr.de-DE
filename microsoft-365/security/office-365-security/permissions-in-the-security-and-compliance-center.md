...
|**Communication Compliance Analysts**|Analysten der Kommunikationskonformität, die Richtlinienkonformität untersuchen, Nachrichtenmetadaten anzeigen und Abhilfemaßnahmen ergreifen können.|Analyse der Kommunikationskonformität <p> Kommunikationskonformitätsfallverwaltung|
...
|**Viewer für die Kommunikationskonformität**|Anzeige der Kommunikationskonformität, die auf die verfügbaren Berichte und Widgets zugreifen kann.|Kommunikationskonformitätsfallverwaltung <p> Kommunikations-Compliance-Viewer|
...
|**Datenschutzverwaltung**|Verwalten der Zugriffssteuerung für die Datenschutzverwaltungslösung im Microsoft 365 Compliance Center.|Datenschutzverwaltungsadministrator <p> Datenschutzverwaltungsanalyse <p> Untersuchung des Datenschutzmanagements <p> Dauerhafter Beitrag zur Datenschutzverwaltung <p> Temporärer Beitrag zur Datenschutzverwaltung <p> Privacy Management Viewer|
|**Datenschutzverwaltungsadministratoren**|Administratoren der Datenschutzverwaltungslösung, die Richtlinien erstellen/bearbeiten und globale Einstellungen definieren kann.|Datenschutzverwaltungsadministrator|
|**Datenschutzverwaltungsanalysten**|Analysten einer Datenschutzverwaltungslösung, die Richtlinien übereinstimmungen untersuchen, Nachrichtenmetadaten anzeigen und Abhilfemaßnahmen ergreifen kann.|Datenschutzverwaltungsanalyse|
|**Mitwirkende für die Datenschutzverwaltung**|Verwalten des Teilnehmerzugriffs für Datenschutzverwaltungsfälle.|Dauerhafter Beitrag zur Datenschutzverwaltung <p> Temporärer Beitrag zur Datenschutzverwaltung|
|**Datenschutzverwaltungsermittler**|Analysten einer Datenschutzverwaltungslösung, die Richtlinien übereinstimmungen untersuchen, Nachrichteninhalte anzeigen und Abhilfemaßnahmen ergreifen kann.|Untersuchung des Datenschutzmanagements|
|**Viewer für die Datenschutzverwaltung**|Viewer der Datenschutzverwaltungslösung, die auf die verfügbaren Dashboards und Widgets zugreifen kann.|Privacy Management Viewer|
...
- Datenschutzverwaltungsanalyse
- Untersuchung des Datenschutzmanagements
- Dauerhafter Beitrag zur Datenschutzverwaltung
...
|**Überwachungsprotokolle**|Aktivieren und konfigurieren Sie die Überwachung für die Organisation, zeigen Sie die Überwachungsberichte der Organisation an, und exportieren Sie dann diese Berichte in eine Datei.|Organisationsverwaltung <p> Sicherheitsadministrator|
|**Fallverwaltung**|Erstellen, Bearbeiten, Löschen und Steuern des Zugriffs auf eDiscovery-Fälle.|Kommunikationscompliance <p> Kommunikations-Compliance-Ermittler <p> Complianceadministrator <p>eDiscovery-Manager <p> Insider-Risikomanagement <p> Administratoren des Insider-Risikomanagements <p> Insider Risk Management Analysts <p> Ermittler des Insider-Risikomanagements <p> Organisationsverwaltung|
...
|**Analyse der Kommunikationskonformität**|Wird verwendet, um Untersuchungen und Korrekturen der Nachrichtenverstöße im Feature "Kommunikationskonformität" durchzuführen. Kann nur Nachrichtenmetadaten anzeigen.|Kommunikationscompliance <p> Communication Compliance Analysts <p> Kommunikations-Compliance-Ermittler|
|**Kommunikationskonformitätsfallverwaltung**|Wird für den Zugriff auf Kommunikationskonformitätsfälle verwendet.|Kommunikationscompliance <p> Kommunikationskonformitätsadministratoren <p> Communication Compliance Analysts <p> Kommunikations-Compliance-Ermittler <p> Viewer für die Kommunikationskonformität|
...
|**Kommunikations-Compliance-Viewer**|Wird für den Zugriff auf Berichte und Widgets im Feature "Kommunikationskonformität" verwendet.|Kommunikationscompliance <p> Viewer für die Kommunikationskonformität|
...
|**Datenklassifizierungsfeedback reviewer**|Ermöglicht die Überprüfung von Feedback von Klassifikatoren im Feedback-Explorer.|Complianceadministrator|
...
|**Analyse des Insider-Risikomanagements**|Zugriff auf alle Vorlagen für Insider-Risikomanagement, -fälle und -benachrichtigungen.|Insider-Risikomanagement <p> Insider Risk Management Analysts|
...
|**Untersuchung des Insider-Risikomanagements**|Zugriff auf alle Warnungen, Fälle, Benachrichtigungsvorlagen und den Inhalts-Explorer für alle Fälle.|Insider-Risikomanagement <p> Ermittler des Insider-Risikomanagements|
...
|**Verwalten von Warnungen**|Anzeigen und Bearbeiten von Einstellungen und Berichten für Warnungen.|Complianceadministrator <p> Kompatibilitätsdatenadministrator <p> Organisationsverwaltung <p> Sicherheitsadministrator <p> Sicherheitsoperator|
...
|**Datenschutzverwaltungsadministrator**|Wird zum Verwalten von Richtlinien in der Datenschutzverwaltungslösung verwendet und hat Zugriff auf alle Funktionen der Lösung.|Datenschutzverwaltung <p> Datenschutzverwaltungsadministratoren|
|**Datenschutzverwaltungsanalyse**|Wird verwendet, um Untersuchungen und Korrekturen der Nachrichtenverstöße in der Datenschutzverwaltungslösung durchzuführen. Kann nur Nachrichtenmetadaten anzeigen.|Datenschutzverwaltung <p> Datenschutzverwaltungsanalysten|
|**Untersuchung des Datenschutzmanagements**|Wird verwendet, um Untersuchungen, Korrekturen und Verstöße gegen Nachrichten in der Datenschutzverwaltungslösung durchzuführen. Kann Nachrichtenmetadaten anzeigen, & nachricht vollständig ist.|Datenschutzverwaltung <p> Datenschutzverwaltungsermittler|
|**Dauerhafter Beitrag zur Datenschutzverwaltung**|Wird für den Zugriff auf den Fall "Datenschutzverwaltung" als dauerhafter Mitwirkender verwendet.|Datenschutzverwaltung <p> Mitwirkende für die Datenschutzverwaltung|
|**Temporärer Beitrag zur Datenschutzverwaltung**|Wird für den Zugriff auf den Fall "Datenschutzverwaltung" als temporärer Mitwirkender verwendet.|Datenschutzverwaltung <p> Mitwirkende für die Datenschutzverwaltung|
|**Privacy Management Viewer**|Wird für den Zugriff auf Dashboards & Widgets in der Datenschutzverwaltungslösung verwendet.|PrivacyManagement <p> Viewer für die Datenschutzverwaltung|
...
|**Aufsichtsüberprüfungsadministrator**|Verwalten von Aufsichtsüberprüfungsrichtlinien, einschließlich der zu überprüfende Mitteilungen und der Personen, die die Überprüfung vor sich haben sollen.|Aufsichtsüberprüfung|
...
|**Nur-Ansicht-Fall**||Kommunikationscompliance <p> Kommunikations-Compliance-Ermittler <p> Complianceadministrator <p> Insider-Risikomanagement <p> Administratoren des Insider-Risikomanagements <p> Insider Risk Management Analysts <p> Insider RiskManagement Investigators <p> Organisationsverwaltung|
...
|**Verwaltung der Nur-Ansicht-Aufbewahrung**|Anzeigen der Konfiguration von Aufbewahrungsrichtlinien, Aufbewahrungsbezeichnungen und Aufbewahrungsbezeichnungsrichtlinien.|Complianceadministrator <p> Kompatibilitätsdatenadministrator <p> Globaler Administrator <p> Organisationsverwaltung|
|
