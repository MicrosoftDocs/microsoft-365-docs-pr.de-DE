...
---
# <a name="threat-explorer-and-real-time-detections-basics"></a>Grundlagen für den Bedrohungs-Explorer und die Echtzeiterkennung
...
Wenn Ihre Organisation [Microsoft Defender für Office 365](defender-for-office-365.md)hat und Sie über die Berechtigungen verfügen, können Sie den Bedrohungs-Explorer (explorer genannt) oder **Echtzeiterkennungen** verwenden, um Bedrohungen zu erkennen und zu abwehren. [](#required-licenses-and-permissions)  
...
- *Echtzeiterkennungen ist ein Berichterstellungstool,* das in Defender für Office 365 Plan 1 verfügbar ist. *Threat Explorer* ist ein Tool zur Bedrohungssuche und -behebung, das in Defender for Office 365 Plan 2 verfügbar ist.
...
- Explorer ist jedoch nur in Defender für Office 365 Plan 2 enthalten.
