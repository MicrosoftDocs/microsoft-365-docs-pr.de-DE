...
- Wenn Sie ein Administrator in einer Organisation mit Exchange Online Postfächern sind, verwenden Sie das Übermittlungsportal im Security & Compliance Center. Weitere Informationen finden Sie unter ["Verwenden der Administratorübermittlung" zum Übermitteln von verdächtigem Spam, Phishing, URLs und Dateien an Microsoft.](admin-submission.md)
...
1. Wählen Sie die Auslassungspunkte **"Weitere Aktionen"** in der oberen rechten Ecke der ausgewählten Nachricht aus, wählen Sie im Dropdownmenü die Option **"Nachricht** melden" aus, und wählen Sie dann **"Nicht Junk"** aus.
