...
1. Wechseln Sie im portal Microsoft 365 Defender zu **E-Mail-&** \> **Zusammenarbeitsrichtlinien &** \> **Regel-Bedrohungsrichtlinien** Seite \> **Regeln** Abschnitt \> **Erweiterte Zustellung**.
...
### <a name="use-powershell-to-modify-the-phishing-simulation-override-policy"></a>Verwenden von PowerShell zum Ändern der Richtlinie zur Außerkraftsetzung der Phishingsimulation

Verwenden Sie die folgende Syntax, um die Richtlinie zur Außerkraftsetzung der Phishingsimulation zu ändern:
