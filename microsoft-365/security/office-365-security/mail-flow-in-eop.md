...
In Microsoft 365-Organisationen mit Exchange Online-Postfächern oder eigenständigen Exchange Online Protection (EOP)-Organisationen ohne Exchange Online-Postfächer werden alle an Ihre Organisation gesendeten Nachrichten über EOP übergeben, bevor sie ihren Mitarbeitern angezeigt werden. Sie haben Optionen zum Routen von Nachrichten, die EOP zur Verarbeitung passieren, bevor sie an Ihre Postausgangsmitarbeiter geroutet werden.
