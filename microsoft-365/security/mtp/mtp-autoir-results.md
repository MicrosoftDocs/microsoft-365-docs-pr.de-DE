...
| **Benachrichtigungen**    | Listet die mit der Untersuchung verbundenen Warnungen auf. Warnungen können von Bedrohungsschutzfeatures auf dem Computer eines Benutzers, in Office-Apps, Cloud App Security und anderen Microsoft 365 Defender-Features stammen.|
...
- [Überprüfen von Wartungsaktionen](mtp-remediation-actions.md)
