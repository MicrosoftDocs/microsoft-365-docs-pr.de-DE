...
Der Zugriff auf Microsoft 365 Defender kann gemeinsam mithilfe globaler Rollen [in Azure Active Directory (AAD) verwaltet werden.](mtp-permissions.md)
...
- Microsoft Defender for Endpoint – [Bearbeiten von Rollen in Microsoft Defender for Endpoint](/windows/security/threat-protection/microsoft-defender-atp/user-roles)
...
- [Verwalten des Zugriffs auf Microsoft 365 Defender](mtp-permissions.md)
