...
* **Ergebnisänderungen** : Anzahl der erreichten Punkte, rückläufige Punkte und Änderungen an der Punktzahl im angegebenen Datumsbereich.
...
- **Organisationen wie Ihre**: eine durchschnittliche Punktzahl anderer Mandanten (vorausgesetzt, es müssen mindestens fünf Mandanten miteinander verglichen werden), die mit den folgenden Kriterien qualifiziert sind:
    1. Gleiche Branche
...
- **Benutzerdefinierter Vergleich**: muss durch Auswählen von **Vergleichs Vergleich** basierend auf den folgenden Kriterien eingerichtet werden:
...
Wenn Sie eine benutzerdefinierte Auswahl getroffen haben, aber die Ergebnisse weniger als fünf andere Mandanten haben, mit denen wir vergleichen können, sehen Sie "aufgrund von begrenzten Daten nicht verfügbar".
