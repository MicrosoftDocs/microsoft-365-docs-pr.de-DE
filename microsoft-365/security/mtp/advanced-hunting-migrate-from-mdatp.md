...
>[!TIP]
>Zusätzlich zu den Spalten in der folgenden Tabelle enthält die Tabelle viele weitere Spalten, die ein ganzheitliches Bild von Warnungen `AlertEvidence` aus verschiedenen Quellen liefern. [Anzeigen aller AlertEvidence-Spalten](advanced-hunting-alertevidence-table.md) 
