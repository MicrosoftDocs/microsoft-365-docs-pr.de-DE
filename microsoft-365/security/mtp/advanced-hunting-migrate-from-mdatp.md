...
>[!NOTE]
>Die meisten Microsoft Defender for Endpoint-Kunden können [Microsoft 365 Defender ohne zusätzliche Lizenzen verwenden.](prerequisites.md#licensing-requirements) Aktivieren Sie [Microsoft 365 Defender,](mtp-enable.md)um mit dem Übergang ihrer workflows für die erweiterte Suche von Defender for Endpoint zu beginnen.
