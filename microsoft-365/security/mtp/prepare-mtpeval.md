...
|![Phase 2: Setup](../../media/setup.png) <br>[Phase 2: Setup](setup-mtpeval.md) | Einrichten Ihres Microsoft Threat Protection-Testlabors oder einer Pilotumgebung
|:-------|:-----|
