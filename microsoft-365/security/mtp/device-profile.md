...
* **Initiieren der Liveantwortsitzung** – Lädt eine Remoteshell auf dem Gerät für [eingehende Sicherheitsuntersuchungen.](/windows/security/threat-protection/microsoft-defender-atp/live-response)
...
* [Untersuchen von Entitäten auf Geräten mithilfe von Liveantworten](/windows/security/threat-protection/microsoft-defender-atp/live-response)
