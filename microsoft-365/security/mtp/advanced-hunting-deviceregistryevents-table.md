...
| `RegistryValueType` | Zeichenfolge | Datentyp (beispielsweise binary oder String) des Registrierungswerts, auf den die aufgezeichnete Aktion angewendet wurde |
...
| `PreviousRegistryValueName` | Zeichenfolge | Ursprünglicher Name des Registrierungswerts vor der Änderung |
