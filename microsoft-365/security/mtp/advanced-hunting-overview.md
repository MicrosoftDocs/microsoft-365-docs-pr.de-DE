...
Um erweiterte Suche oder andere [Microsoft 365 Defender-Funktionen](microsoft-threat-protection.md) zu verwenden, benötigen Sie eine entsprechende Rolle in Azure Active Directory. Außerdem wird Ihr Zugriff auf Endpunktdaten durch rollenbasierte Zugriffssteuerungseinstellungen in Microsoft Defender for Endpoint bestimmt. [Informationen zum Verwalten des Zugriffs auf Microsoft 365 Defender](mtp-permissions.md)
