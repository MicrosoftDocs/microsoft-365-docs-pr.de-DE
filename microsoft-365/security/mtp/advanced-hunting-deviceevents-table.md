...
| `ProcessTokenElevation` | string | Tokentyp, der das Vorhandensein oder Fehlen der Rechteerweiterung der Benutzerzugriffssteuerung (UAC) angibt, die auf den neu erstellten Prozess angewendet wird |
