...
8. Stellen Sie sicher, dass die Option Nicht **nachverfolgen, wenn** Benutzer auf sichere Links klicken, nicht ausgewählt ist, während die restlichen Optionen ausgewählt sind. Weitere [Informationen finden Sie unter Einstellungen für sichere](../office-365-security/recommended-settings-for-eop-and-office365-atp.md) Links. Klicken Sie auf **Speichern**. 
...
Eine umfassendere Anleitung finden Sie unter [Turn on Microsoft 365 Defender](mtp-enable.md). 
