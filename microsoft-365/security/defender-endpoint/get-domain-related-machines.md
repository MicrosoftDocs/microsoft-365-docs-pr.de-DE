...
---
# <a name="get-domain-related-machines-api"></a>API zum Abrufen domänenbezogener Computer
...
Ruft eine Sammlung von [Computern](machine.md) ab, die mit oder von einer bestimmten Domänenadresse kommuniziert haben.
...
>- Die Antwort enthält nur Geräte, auf die der Benutzer zugreifen kann, basierend auf Gerätegruppeneinstellungen (Weitere Informationen finden Sie unter [Erstellen und Verwalten von Gerätegruppen).](machine-groups.md)
...
Wenn erfolgreich und Domäne vorhanden – 200 OK mit Liste der Computerentitäten. [](machine.md) Wenn Domäne nicht vorhanden – 404 Nicht gefunden.
