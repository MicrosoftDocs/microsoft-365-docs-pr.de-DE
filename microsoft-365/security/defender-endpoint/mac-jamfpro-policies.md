...
<span data-ttu-id="eb6d7-108">Sie müssen die folgenden Schritte ausführen:</span><span class="sxs-lookup"><span data-stu-id="eb6d7-108">You'll need to take the following steps:</span></span>
...
3. <span data-ttu-id="eb6d7-133">Geben Sie die folgenden Details ein:</span><span class="sxs-lookup"><span data-stu-id="eb6d7-133">Enter the following details:</span></span>
...
8. <span data-ttu-id="eb6d7-149">Wählen Sie die Registerkarte **Bereich** aus.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-149">Select the **Scope** tab.</span></span>
...
8. <span data-ttu-id="eb6d7-189">Wählen Sie **die Computergruppe von Contoso** aus.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-189">Select **Contoso's Machine Group**.</span></span>
...
1. <span data-ttu-id="eb6d7-200">Verwenden Sie die folgenden Konfigurationseinstellungen für Microsoft Defender für Endpunkt:</span><span class="sxs-lookup"><span data-stu-id="eb6d7-200">Use the following Microsoft Defender for Endpoint configuration settings:</span></span>
    ...
    - <span data-ttu-id="eb6d7-204">Ausschlüsse</span><span class="sxs-lookup"><span data-stu-id="eb6d7-204">exclusions</span></span>
...
4. <span data-ttu-id="eb6d7-223">Geben Sie die folgenden Details ein:</span><span class="sxs-lookup"><span data-stu-id="eb6d7-223">Enter the following details:</span></span>
    ...
    - <span data-ttu-id="eb6d7-225">Name: MDATP MDAV-Konfigurationseinstellungen</span><span class="sxs-lookup"><span data-stu-id="eb6d7-225">Name: MDATP MDAV configuration settings</span></span>
...
7. <span data-ttu-id="eb6d7-235">Geben Sie in **"Einstellungsdomäne"** `com.microsoft.wdav` Hochladen **PLIST-Datei** ein.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-235">In **Preferences Domain**, enter `com.microsoft.wdav`, then select  **Upload PLIST File**.</span></span>
...
9. <span data-ttu-id="eb6d7-239">Wählen Sie die **MDATP_MDAV_configuration_settings.plist** aus, und wählen Sie dann **Öffnen** aus.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-239">Select the **MDATP_MDAV_configuration_settings.plist**, then select **Open**.</span></span>
...
14. <span data-ttu-id="eb6d7-253">Wählen Sie **die Computergruppe von Contoso** aus.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-253">Select **Contoso's Machine Group**.</span></span> 
...
1. <span data-ttu-id="eb6d7-296">Verwenden Sie die folgenden Konfigurationseinstellungen für Microsoft Defender für Endpunkt:</span><span class="sxs-lookup"><span data-stu-id="eb6d7-296">Use the following Microsoft Defender for Endpoint configuration settings:</span></span>
...
7. <span data-ttu-id="eb6d7-495">Klicken Sie auf **Öffnen**.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-495">Select **Open**.</span></span> <span data-ttu-id="eb6d7-496">Legen Sie den **Anzeigenamen** auf **Microsoft Defender Advanced Threat Protection und Microsoft Defender Antivirus** fest.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-496">Set the **Display Name** to **Microsoft Defender Advanced Threat Protection and Microsoft Defender Antivirus**.</span></span>
    ...
    <span data-ttu-id="eb6d7-499">**Registerkarte "Optionen"**</span><span class="sxs-lookup"><span data-stu-id="eb6d7-499">**Options tab**</span></span><br> <span data-ttu-id="eb6d7-500">Behalten Sie standardwerte bei.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-500">Keep default values.</span></span>

    <span data-ttu-id="eb6d7-501">**Registerkarte "Einschränkungen"**</span><span class="sxs-lookup"><span data-stu-id="eb6d7-501">**Limitations tab**</span></span><br> <span data-ttu-id="eb6d7-502">Behalten Sie standardwerte bei.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-502">Keep default values.</span></span>
    
     ![Abbildung der Registerkarte "Einschränkung der Konfigurationseinstellungen"](images/56dac54634d13b2d3948ab50e8d3ef21.png)
   
8. <span data-ttu-id="eb6d7-504">Wählen Sie **Speichern**.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-504">Select **Save**.</span></span> <span data-ttu-id="eb6d7-505">Das Paket wird in Jamf Pro hochgeladen.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-505">The package is uploaded to Jamf Pro.</span></span> 

   ![Abbildung der Konfigurationseinstellungen packen upl jamf pro](images/33f1ecdc7d4872555418bbc3efe4b7a3.png)

   <span data-ttu-id="eb6d7-507">Es kann einige Minuten dauern, bis das Paket für die Bereitstellung verfügbar ist.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-507">It can take a few minutes for the package to be available for deployment.</span></span>
   
   ![Abbildung des Pakets der Konfigurationseinstellungen](images/1626d138e6309c6e87bfaab64f5ccf7b.png)

9. <span data-ttu-id="eb6d7-509">Navigieren Sie zur Seite **"Richtlinien".**</span><span class="sxs-lookup"><span data-stu-id="eb6d7-509">Navigate to the **Policies** page.</span></span>

    ![Abbildung der Konfigurationseinstellungen](images/f878f8efa5ebc92d069f4b8f79f62c7f.png)

10. <span data-ttu-id="eb6d7-511">Wählen Sie **+Neu** aus, um eine neue Richtlinie zu erstellen.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-511">Select **+ New** to create a new policy.</span></span>

    ![Abbildung der neuen Richtlinie für Konfigurationseinstellungen](images/847b70e54ed04787e415f5180414b310.png)


11. <span data-ttu-id="eb6d7-513">Geben Sie **im Allgemeinen** die folgenden Details ein:</span><span class="sxs-lookup"><span data-stu-id="eb6d7-513">In **General** Enter the following details:</span></span>

    - <span data-ttu-id="eb6d7-514">Anzeigename: MDATP Onboarding Contoso 200329 v100.86.92 oder höher</span><span class="sxs-lookup"><span data-stu-id="eb6d7-514">Display name: MDATP Onboarding Contoso 200329 v100.86.92 or later</span></span>

    ![<span data-ttu-id="eb6d7-515">Abbildung der Konfigurationseinstellungenmdatponboard</span><span class="sxs-lookup"><span data-stu-id="eb6d7-515">Image of configuration settingsmdatponboard</span></span> ](images/625ba6d19e8597f05e4907298a454d28.png)

12. <span data-ttu-id="eb6d7-516">Wählen Sie **wiederkehrendes Einchecken aus.**</span><span class="sxs-lookup"><span data-stu-id="eb6d7-516">Select **Recurring Check-in**.</span></span> 
    
    ![Abbildung der Erneuten Überprüfung der Konfigurationseinstellungen](images/68bdbc5754dfc80aa1a024dde0fce7b0.png)

  
13. <span data-ttu-id="eb6d7-518">Wählen Sie **Speichern**.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-518">Select **Save**.</span></span> 
 
14. <span data-ttu-id="eb6d7-519">Wählen Sie **Pakete aus, > konfigurieren.**</span><span class="sxs-lookup"><span data-stu-id="eb6d7-519">Select **Packages > Configure**.</span></span>
 
    ![Abbildung des Konfigurierten Konfigurationseinstellungspakets](images/8fb4cc03721e1efb4a15867d5241ebfb.png)

15. <span data-ttu-id="eb6d7-521">Wählen Sie die Schaltfläche **"Hinzufügen"** neben **Microsoft Defender Advanced Threat Protection und Microsoft Defender Antivirus** aus.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-521">Select the **Add** button next to **Microsoft Defender Advanced Threat Protection and Microsoft Defender Antivirus**.</span></span>

    ![Abbildung der Konfigurationseinstellungen, die MDATP und MDA hinzufügen](images/526b83fbdbb31265b3d0c1e5fbbdc33a.png)

16. <span data-ttu-id="eb6d7-523">Wählen Sie **Speichern**.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-523">Select **Save**.</span></span>

    ![Abbildung der Konfigurationseinstellungensavimg](images/9d6e5386e652e00715ff348af72671c6.png)

17. <span data-ttu-id="eb6d7-525">Wählen Sie die Registerkarte **Bereich** aus.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-525">Select the **Scope** tab.</span></span>  

    ![Abbildung der Konfigurationseinstellungen scptab](images/8d80fe378a31143db9be0bacf7ddc5a3.png)

18. <span data-ttu-id="eb6d7-527">Wählen Sie die Zielcomputer aus.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-527">Select the target computers.</span></span>

    ![Abbildung der Konfigurationseinstellungen tgtcomp](images/6eda18a64a660fa149575454e54e7156.png)

    <span data-ttu-id="eb6d7-529">**Scope**</span><span class="sxs-lookup"><span data-stu-id="eb6d7-529">**Scope**</span></span>
    
    <span data-ttu-id="eb6d7-530">Wählen Sie **Hinzufügen**.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-530">Select **Add**.</span></span>
    ...
    <span data-ttu-id="eb6d7-533">**Self-Service**</span><span class="sxs-lookup"><span data-stu-id="eb6d7-533">**Self-Service**</span></span>
    
    ![Abbildung des Selfservice der Konfigurationseinstellungen](images/c9f85bba3e96d627fe00fc5a8363b83a.png)

19. <span data-ttu-id="eb6d7-535">Wählen Sie **Fertig** aus.</span><span class="sxs-lookup"><span data-stu-id="eb6d7-535">Select **Done**.</span></span> 
