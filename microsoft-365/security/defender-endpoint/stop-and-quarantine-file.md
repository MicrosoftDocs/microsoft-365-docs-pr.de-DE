...
---
# <a name="stop-and-quarantine-file-api"></a>Api zum Beenden und Isolieren von Dateien
...
:---|:---|:---
Anwendung |   Machine.StopAndQuarantine | "Stop and Quarantine"
Delegiert (Geschäfts-, Schul- oder Unikonto) | Machine.StopAndQuarantine | "Stop and Quarantine"
