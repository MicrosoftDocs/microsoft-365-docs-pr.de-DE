...
Wenn Sie planen, von McAfee Endpoint Security (McAfee) zu [Microsoft Defender for Endpoint](microsoft-defender-endpoint.md) (Microsoft Defender for Endpoint) zu wechseln, sind Sie an der richtigen Stelle. Verwenden Sie diesen Artikel als Leitfaden.
...
|[Onboarding bei Microsoft Defender for Endpoint](mcafee-to-microsoft-defender-onboard.md) |Während der [**Onboardphase**](mcafee-to-microsoft-defender-onboard.md) integrieren Sie Ihre Geräte in Microsoft Defender for Endpoint, vergewissern Sie sich, dass Microsoft Defender Antivirus im passiven Modus ausgeführt wird, und vergewissern Sie sich, dass Ihre Endpunkte mit Defender for Endpoint kommunizieren. Anschließend deinstallieren Sie McAfee, und stellen Sie sicher, dass Defender for Endpoint ordnungsgemäß funktioniert. |
