...
Erfahren Sie, wie Sie Defender for Endpoint-Features konfigurieren und verwalten, um den besten Sicherheitsschutz für Ihre Organisation zu erhalten.

Praktische Hinweise zum Verbinden neuer Geräte in Ihrer Organisation finden Sie unter [Onboard devices to the Microsoft Defender for Endpoint service](./onboard-configure.md).
