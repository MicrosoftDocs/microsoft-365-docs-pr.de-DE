...
Stellen Windows Server 2008 R2 SP1 sicher, dass Sie die folgenden Anforderungen erfüllen:
...
> [!IMPORTANT]
>
> - Wenn Sie Azure Security Center zum Überwachen von Servern verwenden, wird automatisch ein Defender for Endpoint-Mandant erstellt (in den USA für US-Benutzer, in der EU für europäische und britische Benutzer).
...
> - Nach der Konfiguration können Sie den Speicherort ihrer Daten nicht mehr ändern. Wenn Sie Ihre Daten an einen anderen Speicherort verschieben müssen, müssen Sie den Microsoft Support kontaktieren, um den Mandanten zurückzusetzen.
...
1. Laden Sie Folgendes herunter und platzieren Sie sich im Ordner MMA:

    **Update für Kundenerfahrung und Diagnosetelemetrie (Windows Server 2008 R2 und Windows Server 2012 R2)**
...
Erstellen Sie eine neue Gruppenrichtlinie speziell für Onboardinggeräte wie "Microsoft Defender for Endpoint Onboarding".
...
- Erstellen eines Gruppenrichtlinienordners mit dem Namen "c:\windows\MMA"
    ...
    **Dadurch wird auf jedem Server, auf dem das Gruppenrichtlinienobjekt angewendet wird, ein neuer Ordner mit dem Namen MMA hinzugefügt und in c:\windows gespeichert. Dies enthält die Installationsdateien für das MMA, die Voraussetzungen und das Installationsskript.**

- Erstellen Sie eine Gruppenrichtliniendateien-Einstellung für jede der dateien, die in der Net-Anmeldung gespeichert sind.

     :::image type="content" source="images/grppolicyconfig2.png" alt-text="Gruppenrichtlinienbild1":::

Es kopiert die Dateien aus DOMAIN\NETLOGON\MMA\filename in C:\windows\MMA\filename – die Installationsdateien sind also auf dem Server **lokal:**
...
Wie in der Onboardingdokumentation für Server speziell für Server 2008 R2 erwähnt, lesen Sie bitte unten:

Stellen Windows Server 2008 R2 PS1 sicher, dass Sie die folgenden Anforderungen erfüllen:
