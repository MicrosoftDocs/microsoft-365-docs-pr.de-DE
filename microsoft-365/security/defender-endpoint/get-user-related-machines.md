...
Ruft eine Sammlung von Geräten ab, die mit einer bestimmten Benutzer-ID verbunden sind.
...
>- Die Antwort umfasst nur Geräte, auf die der Benutzer basierend auf den Gerätegruppeneinstellungen zugreifen kann. Weitere Informationen finden Sie unter [Create and manage device groups](machine-groups.md).
...
**Die ID ist nicht der vollständige UPN, sondern nur der Benutzername. (z. B. zum Abrufen von Computern für user1@contoso.com /api/users/user1/machines)**
...
Wenn erfolgreich und Benutzer vorhanden ist – [](machine.md) 200 OK mit der Liste der Computerentitäten im Textkörper. Wenn der Benutzer nicht vorhanden ist - 404 Nicht gefunden.
