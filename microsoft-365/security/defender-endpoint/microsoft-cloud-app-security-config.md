...
## <a name="view-the-data-collected"></a>Anzeigen der erfassten Daten

Informationen zum Anzeigen und Zugreifen auf Microsoft Defender for Endpoint-Daten in Microsoft Cloud Apps Security finden Sie unter Untersuchen von Geräten [in Cloud App Security](https://docs.microsoft.com/cloud-app-security/mde-integration#investigate-devices-in-cloud-app-security).
