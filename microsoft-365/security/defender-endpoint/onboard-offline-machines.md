...
> - Darüber hinaus muss Windows 10 oder Windows Server 2019 in getrennten Umgebungen in der Lage sein, Zertifikatvertrauenslisten über eine interne Datei oder einen Webserver offline zu aktualisieren.
...
## <a name="on-premises-devices"></a>Lokale Geräte
...
- Richten Sie Azure Log Analytics (früher ALS OMS-Gateway bezeichnet) als Proxy oder Hub ein:
  ...
  - [Installieren und Konfigurieren Microsoft Monitoring Agent (MMA)-Punkts](configure-server-endpoints.md#install-and-configure-microsoft-monitoring-agent-mma-to-report-sensor-data-to-microsoft-defender-for-endpoint) auf den Defender for Endpoint Workspace-Schlüssel &-ID
