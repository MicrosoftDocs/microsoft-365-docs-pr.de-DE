...
Microsoft Defender for Endpoint bietet eine umfassende Serverschutzlösung, einschließlich EDR (EDR) auf Windows Servern.
...
Microsoft Cloud App Security nutzt Microsoft Defender for Endpoint-Endpunktsignale, um eine direkte Sichtbarkeit der Cloudanwendungsnutzung zu ermöglichen, einschließlich der Verwendung nicht unterstützter Clouddienste (Shadow-IT) von allen überwachten Microsoft Defender for Endpoint-Geräten.
...
>[!NOTE]
> Defender for Office 365 daten werden für Ereignisse innerhalb der letzten 30 Tage angezeigt. Bei Warnungen wird Defender Office 365 daten basierend auf der ersten Aktivitätszeit angezeigt. Danach sind die Daten in Defender for Office 365.

### <a name="skype-for-business"></a>Skype for Business
Die Skype for Business bietet Analysten die Möglichkeit, über eine einfache Schaltfläche über das Portal mit einem potenziell gefährdeten Benutzer oder Gerätebesitzer zu kommunizieren.
...
- [Microsoft 365 Übersicht über Defender](https://docs.microsoft.com/microsoft-365/security/defender/microsoft-threat-protection)
