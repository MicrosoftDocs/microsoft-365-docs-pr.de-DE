...
6. Fügen Sie der Anwendung einen geheimen Schlüssel hinzu.
   ...
   - Klicken Sie auf **Zertifikate & geheimen Schlüssel,** fügen Sie dem geheimen Schlüssel eine Beschreibung hinzu, und klicken Sie auf **"Hinzufügen".**
...
- Sanity Check:
  ...
  - Wechseln Sie in Ihrem Browser zu: <https://jwt.ms/>
  - Kopieren Sie das Token (den Inhalt der Latest-token.txt-Datei).
  - In das obere Feld einfügen.
...
- Das folgende Skript verwendet **Get-Token.ps1** für den Zugriff auf die API und erhält die Benachrichtigungen der letzten 48 Stunden.
