...
---
# <a name="deploy-microsoft-defender-for-endpoint-for-linux-with-ansible"></a>Bereitstellen von Microsoft Defender for Endpoint für Linux mit Ansible
...
- Erstellen Sie die Ansible-Installation und deinstallieren Sie YAML-Dateien.
    ...
    - Verwenden Sie für yum-basierte Verteilungen die folgende YAML-Datei:
...
- [Hinzufügen oder Entfernen von YUM-Repositorys](https://docs.ansible.com/ansible/2.3/yum_repository_module.html)

- [Verwalten von Paketen mit dem yum-Paket-Manager](https://docs.ansible.com/ansible/latest/modules/yum_module.html)

- [Hinzufügen und Entfernen von APT-Repositorys](https://docs.ansible.com/ansible/latest/modules/apt_repository_module.html)

- [Verwalten von apt-packages](https://docs.ansible.com/ansible/latest/modules/apt_module.html)
