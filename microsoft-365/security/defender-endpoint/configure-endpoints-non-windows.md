...
- [Systemanforderungen für Microsoft Defender for Endpoint für Linux](microsoft-defender-endpoint-linux.md#system-requirements)  
- [Microsoft Defender for Endpoint für Mac Systemanforderungen](microsoft-defender-endpoint-mac.md#system-requirements).
...
1. Wählen Sie Ihre bevorzugte Methode für das Onboarding aus:
   ...
   - Für macOS-Geräte können Sie das Onboarding über Microsoft Defender ATP oder über eine Drittanbieterlösung auswählen. Weitere Informationen finden Sie unter [Microsoft Defender for Endpoint für Mac](https://docs.microsoft.com/microsoft-365/security/defender-endpoint/microsoft-defender-atp-mac).
