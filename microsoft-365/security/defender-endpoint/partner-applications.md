---
title: Partneranwendungen in Microsoft Defender for Endpoint
ms.reviewer: ''
...
### <a name="security-information-and-analytics"></a>Sicherheitsinformationen und Analysen

Logo |Partnername   | Beschreibung 
:---|:---|:---
![Abbildung des AttackIQ-Logos](images/attackiq-logo.png)| [AttackIQ-Plattform](https://go.microsoft.com/fwlink/?linkid=2103502) | Die AttackIQ-Plattform überprüft, ob Defender for Endpoint ordnungsgemäß konfiguriert ist, indem kontinuierliche Angriffe sicher auf Produktionsressourcen gestartet werden.
![Abbildung des Azure Sentinel-Logos](images/sentinel-logo.png)| [AzureSentinel](https://go.microsoft.com/fwlink/?linkid=2135705) | Streamen von Warnungen von Microsoft Defender for Endpoint in Azure Sentinel 
![Abbildung des Cymulate-Logos](images/cymulate-logo.png) | [Cymulate](https://go.microsoft.com/fwlink/?linkid=2135574)| Korrelieren von Defender for Endpoint-Ergebnissen mit simulierten Angriffen, um eine genaue Erkennung und effektive Reaktionsaktionen zu überprüfen
...
### <a name="orchestration-and-automation"></a>Orchestrierung und Automatisierung
...
### <a name="threat-intelligence"></a>Bedrohungsintelligenz

Logo |Partnername   | Beschreibung 
:---|:---|:---
![Image of MISP Malware Information Sharing Platform)logo](images/misp-logo.png) | [MISP (Malware Information Sharing Platform)](https://go.microsoft.com/fwlink/?linkid=2127543) | Integrieren von Bedrohungsindikatoren aus der Open Source Threat Intelligence Sharing Platform in Ihre Defender for Endpoint-Umgebung
![Bild des Palo Alto Networks-Logos](images/paloalto-logo.png) | [Palo Alto Networks](https://go.microsoft.com/fwlink/?linkid=2099582) | Erweitern Des Endpunktschutzes durch Erweitern von Autofokus und anderen Bedrohungsfeeds auf Defender for Endpoint mithilfe von MineMeld
![Abbildung des ThreatConnect-Logos](images/threatconnect-logo.png) | [ThreatConnect](https://go.microsoft.com/fwlink/?linkid=2114115) | Warnung und/oder Blockierung von benutzerdefinierter Bedrohungsintelligenz von ThreatConnect Playbooks mithilfe von Defender for Endpoint-Indikatoren
...
Logo |Partnername   | Beschreibung 
:---|:---|:---
![Bild des Bitdefender-Logos](images/bitdefender-logo.png)| [Bitdefender](https://go.microsoft.com/fwlink/?linkid=860032)| Bitdefender GravityZone ist eine mehrschichtige Endpunktschutzplattform der nächsten Generation, die umfassenden Schutz vor dem vollständigen Spektrum anspruchsvoller Cyberbedrohungen bietet.
...
## <a name="other-integrations"></a>Andere Integrationen

Logo |Partnername   | Beschreibung 
:---|:---|:---
![Abbildung des Cyren Web Filter-Logos](images/cyren-logo.png)| [Cyren Web Filter](https://go.microsoft.com/fwlink/?linkid=2108221)| Verbessern Ihres Defender for Endpoint durch erweiterte Webfilterung
![Abbildung des Morphisec-Logos](images/morphisec-logo.png)| [Morphisec](https://go.microsoft.com/fwlink/?linkid=2086215)| Bietet moving target defense-powered advanced threat prevention. Integriert forensische Daten direkt in WD Security Center-Dashboards, um Warnungen zu priorisieren, die Risikobewertung für Geräte zu ermitteln und die vollständige Angriffszeitachse einschließlich interner Speicherinformationen zu visualisieren.
![Abbildung des THOR Cloud-Logos](images/nextron-thor-logo.png)| [THOR Cloud](https://go.microsoft.com/fwlink/?linkid=862988)| Bietet On-Demand-Liveforensikscans mithilfe einer Signaturbasis mit Fokus auf beständigen Bedrohungen
...
## <a name="ticketing-and-it-service-management"></a>Ticketing und VERWALTUNG von IT-Diensts 
...
## <a name="security-orchestration-and-automation-response-soar-integration"></a>Integration von Sicherheits orchestrierung und Automatisierungsreaktion (SoAR) 
...
## <a name="external-alert-correlation-and-automated-investigation-and-remediation"></a>Korrelation externer Warnungen und automatisierte Untersuchung und Behebung  
...
## <a name="indicators-matching"></a>Indikatorenvergleich
