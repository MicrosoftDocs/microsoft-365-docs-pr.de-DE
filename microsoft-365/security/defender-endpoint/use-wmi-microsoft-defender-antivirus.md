...
---
# <a name="use-windows-management-instrumentation-wmi-to-configure-and-manage-microsoft-defender-antivirus"></a>Verwenden Windows Management Instrumentation (WMI) zum Konfigurieren und Verwalten von Microsoft Defender Antivirus
...
Windows Die Verwaltungsinstrumentation (Management Instrumentation, WMI) ist eine Skriptschnittstelle, mit der Sie Einstellungen abrufen, ändern und aktualisieren können.
