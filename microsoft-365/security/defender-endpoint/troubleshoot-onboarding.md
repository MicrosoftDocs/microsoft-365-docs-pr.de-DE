...
`15` | Sense-Dienst konnte nicht gestartet werden | Wenn die Meldung des Fehlers lautet: Systemfehler 577 oder Fehler 1058 aufgetreten ist, müssen Sie den Microsoft Defender Antivirus ELAM-Treiber aktivieren. Anweisungen finden Sie unter ["Sicherstellen, dass Microsoft Defender Antivirus nicht durch eine Richtlinie deaktiviert ist".](#ensure-that-microsoft-defender-antivirus-is-not-disabled-by-a-policy)
...
Ereigniskennung | Meldung | Lösungsschritte
:---:|:---|:---
