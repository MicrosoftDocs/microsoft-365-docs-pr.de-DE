...
---
# <a name="use-next-generation-technologies-in-microsoft-defender-antivirus-through-cloud-delivered-protection"></a>Verwenden von Technologien der nächsten Generation in Microsoft Defender Antivirus durch Cloud-basierten Schutz
...
Um die Leistung und Geschwindigkeit dieser Technologien der nächsten Generation zu nutzen, arbeitet Microsoft Defender Antivirus nahtlos mit Microsoft Cloud Services zusammen. Diese Cloudschutzdienste, die auch als Microsoft Advanced Protection Service (MAPS) bezeichnet werden, verbessern den standardmäßigen Echtzeitschutz und bieten die wohl beste Antivirenabwehr. 
...
Organisationen mit Windows 10 E5 können auch dynamische Notfallupdates nutzen, die nahezu Echtzeitschutz vor neuen Bedrohungen bieten. Wenn Sie den in der Cloud zugestellten Schutz aktivieren, können Korrekturen für Schadsoftwareprobleme innerhalb von Minuten über die Cloud übermittelt werden, anstatt auf das nächste Update zu warten.
...
In der folgenden Tabelle werden die Unterschiede beim cloudbasierten Schutz zwischen den letzten Versionen von Windows und Configuration Manager beschrieben.
...
|System Center 2012 Configuration Manager  |      Nicht zutreffend         |Abhängig von der Windows-Version         |Nicht konfigurierbar |
|Microsoft Endpoint Manager (Current Branch)         |Cloudschutzdienst         |Abhängig von der Windows-Version          |Konfigurierbar         |
|Microsoft Intune     |Microsoft Advanced Protection Service         |Abhängig von der Windows-Version         |Konfigurierbar         |

Sie können Microsoft Defender Antivirus auch so konfigurieren, dass neue Schutzupdates basierend auf [Berichten von unserem Clouddienst automatisch empfangen werden.](manage-event-based-updates-microsoft-defender-antivirus.md#cloud-report-updates)
...
- [Geben Sie die in der Cloud zugestellte Schutzstufe an.](specify-cloud-protection-level-microsoft-defender-antivirus.md) Sie können das Von der Cloud gebotene Schutzniveau mit Gruppenrichtlinien und Microsoft Endpoint Configuration Manager angeben. Die Schutzstufe wirkt sich auf die Menge der in der Cloud freigegebenen Informationen und darauf aus, wie aggressiv neue Dateien blockiert werden.
...
- [Konfigurieren Sie den Zeitraum für das Timeout für Cloudblocks.](configure-cloud-block-timeout-period-microsoft-defender-antivirus.md) Microsoft Defender Antivirus kann die Ausführung verdächtiger Dateien blockieren, während es unseren in der Cloud zugestellten Schutzdienst abfragt. Sie können den Zeitraum konfigurieren, für den die Datei nicht mit Microsoft Endpoint Manager und Gruppenrichtlinien ausgeführt werden kann.