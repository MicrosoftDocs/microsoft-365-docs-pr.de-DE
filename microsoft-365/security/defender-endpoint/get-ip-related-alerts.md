...
---
# <a name="get-ip-related-alerts-api"></a>API zum Abrufen von IP-bezogenen Warnungen
...
Wenn erfolgreich und IP vorhanden – 200 OK mit Liste der Warnungsentitäten im Textkörper. [](alerts.md) Wenn ip nicht vorhanden – 404 Nicht gefunden.
