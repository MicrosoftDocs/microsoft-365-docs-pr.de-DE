...
>[!NOTE]
>Intune verwendet Azure Active Directory (Azure AD)-Gruppen zum Verwalten von Geräten und Benutzern. Als Intune-Administrator können Sie Gruppen für Ihre Organisatorischen Anforderungen einrichten.<br>
...
3.  Nachdem die Dienste auf dem Gerät ausgeführt wurden, wird das Gerät in Microsoft Defender Security Center angezeigt.
...
3.  Öffnen Sie nach dem Anwenden der Richtlinie eine PowerShell-Windows, und geben Sie `(Get-MpPreference).EnableNetworkProtection` sie ein.
