...
1. Beschreibung: Definiert, ob eine Benachrichtigung angezeigt werden soll.
...
1. Optionen: 0-4. Wenn "Zulassen" oder "Verweigern" ausgewählt ist:
...
Mit dem Feature "Wechselbare Storage Zugriffssteuerung" können Sie Richtlinien über Gruppenrichtlinien entweder auf Benutzer oder Geräte oder auf beides anwenden.
