...
- [Kampagnen](../defender-365-security/campaigns.md)
- [Übermittlungen](../defender-365-security/admin-submission.md)
- [Überprüfung](./m365d-action-center.md)
- [Bedrohungs-Tracker](../defender-365-security/threat-trackers.md)
...
Der Abschnitt [Erste Schritte](/microsoft-365/security/defender-365-security/defender-for-office-365.md#getting-started) im Artikel [Microsoft Defender für Office 365](/microsoft-365/security/defender-365-security/defender-for-office-365) enthält logische erste Konfigurationsblöcke, die so aussehen:
...
Zusammen mit einem [Link](../defender-365-security/protect-against-threats.md) für den Sofortstart und um schon am ersten Tag mit der Konfiguration zu beginnen.
...
- [Erstellen einer Phishing-Angriffssimulation](../defender-365-security/attack-simulation-training.md) und [Erstellen einer Nutzlast für die Schulung Ihrer Teams](../defender-365-security/attack-simulation-training-payloads.md)
