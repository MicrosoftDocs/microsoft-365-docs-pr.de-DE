...
Während Sie einige Zeit mit der Einrichtung, Implementierung und Verwaltung von Sicherheitsmaßnahmen gemäß den Standards der Organisation verbringen, können Sie Sicherheitslösungen einrichten, um Sicherheitsrisiken und Bedrohungen schnell zu identifizieren. Mit Microsoft 365 Defender können Sie Vorfälle mithilfe der Single-Pane-of-Glass-Erfahrung erkennen, verdingen und untersuchen, wo Sie die Informationen finden können, die Sie für zeitnahe Entscheidungen benötigen. 

Sobald ein Sicherheitsvorfall erkannt wurde, stellt Microsoft 365 Defender Details vor, die Sie für die Triage oder Priorisierung eines Vorfalls oder von Vorfällen gegenüber anderen Personen benötigen. Nach der Festlegung der Priorisierung können Analysten ihre Energie dann auf die Untersuchung der ihnen zugewiesenen Fälle konzentrieren.

## <a name="detection-by-microsoft-365-defender"></a>Erkennung durch Microsoft 365 Defender

Microsoft 365 Defender empfängt Warnungen und Ereignisse von mehreren Microsoft-Sicherheitsplattformen als Erkennungsquellen, um ein ganzheitliches Bild und einen kontextbezogenen Zusammenhang mit bösartigen Aktivitäten zu erstellen. Dies sind die möglichen Erkennungsquellen:

- [Microsoft Defender for Endpoint](../defender-endpoint/microsoft-defender-endpoint.md) ist eine Endpunkterkennungs- und Reaktionslösung (Endpoint Detection and Response Solution, EDR), die Microsoft Defender Antivirus sowie cloudaktivierten erweiterten Bedrohungsschutz mithilfe von Microsoft Security Graph verwendet. Defender for Endpoint ist eine einheitliche Plattform für vorbeugenden Schutz, erkennung nach Sicherheitsverletzungen, automatisierte Untersuchung und Reaktion. Es schützt Endpunkte vor Cyberangriffen, erkennt erweiterte Angriffe und Datenschutzverletzungen, automatisiert Sicherheitsvorfälle und verbessert die Sicherheitslage. 
...
- [Microsoft Defender für Office 365](../office-365-security/overview.md) schützt Ihre Organisation vor böswilligen Bedrohungen in E-Mail-Nachrichten, Links (URLs) und Tools für die Zusammenarbeit. 
...
In Microsoft 365 Defender werden Vorfälle durch Korrelieren von Warnungen aus diesen verschiedenen [Erkennungsquellen](incidents-overview.md) identifiziert. Anstatt Ressourcen zu verketten oder mehrere Warnungen in ihren jeweiligen Vorfällen zu unterscheiden, können Sie sofort mit der Warteschlange für Vorfälle in Microsoft 365 Defender beginnen. Auf diese Weise können Sie Vorfälle effizient über Endpunkte, Identitäten, E-Mails und Anwendungen hinweg verdingen und den Schaden durch einen Angriff verringern.

## <a name="triage-your-incidents"></a>Triagen Ihrer Vorfälle

Die Reaktion auf Vorfälle in Microsoft 365 Defender beginnt, sobald Sie die Liste der Vorfälle mithilfe der empfohlenen Priorisierungsmethode Ihrer Organisation ausdrangiert haben. Das Triagen bedeutet, vorfällen eine Wichtigkeits- oder Dringlichkeitsstufe zuzuordnen, die dann die Reihenfolge bestimmt, in der sie untersucht werden. 

Eine nützliche Beispielanleitung zum Bestimmen, welcher Vorfall in Microsoft 365 Defender priorisiert werden soll, kann mit der Formel zusammengefasst werden: *Schweregrad + Auswirkung = Priorität*. 

- **Der Schweregrad** ist die von Microsoft 365 Defender festgelegte Stufe und die integrierten Sicherheitskomponenten. 
...
3. Weiter unten im Seitenbereich finden Sie die zugeordneten Warnungen. Microsoft 365 Defender hat bereits die Korrelation der Warnungen zu einem einzelnen Vorfall durchgeführt, was Ihnen Zeit und Ressourcen spart, die besser für die Behebung des Angriffs verwendet werden. Warnungen sind verdächtige und daher möglicherweise bösartige Systemereignisse, die das Vorhandensein eines Angreifers in einem Netzwerk nahelegen. 
...
Es gibt mehrere Möglichkeiten zum Lesen und Analysieren von Daten mit Microsoft 365 Defender, aber das Endziel für Analysten ist es, auf Vorfälle so schnell wie möglich zu reagieren. Während Microsoft 365 Defender die mittlere Zeit bis zur Behebung [(MtTR)](https://www.microsoft.com/security/blog/2020/05/04/lessons-learned-microsoft-soc-part-3c/) durch die branchenführende automatisierte Untersuchungs- und Reaktionsfunktion erheblich reduzieren kann, gibt es immer Fälle, die eine manuelle Analyse erfordern. [](m365d-autoir.md) 
...
5.  Jede Warnung kann ausgewählt werden, um weitere Informationen zur Aktivität zu erhalten. Wenn Sie beispielsweise Aktivität **aus einer Tor-IP-Adressbenachrichtigung** auswählen, gelangen Sie zur eigenen Seite dieser Warnung. Sie ist Administratorin von Office 365, was bedeutet, dass sie über erhöhte Rechte verfügt und der Quellvorfall möglicherweise zum Zugriff auf vertrauliche Informationen geführt hat. 
