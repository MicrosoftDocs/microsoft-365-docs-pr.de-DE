...
---
# <a name="track-and-respond-to-emerging-threats-with-threat-analytics"></a>Nachverfolgen von und Reagieren auf neue Bedrohungen mit Bedrohungsanalysen 
...
- [**Risikominderungen**](#mitigations-review-list-of-mitigations-and-the-status-of-your-devices)
...
- Die Liste kann auch nach Bedrohungstags sortiert werden:

  ![lists](../../media/threat-analytics//ta-taglist-mtp.png)

- Filter sind pro Bedrohungstag und Berichtstyp verfügbar:
