...
- Führen Sie eine Analyse der Lücken in der Sicherheitsabdeckung durch.
- Bestimmen der Zuschreibung von Widersachern und Kampagnen.
- Führen Sie Trendanalysen durch.
- Identifizieren von Kompetenzlücken im Bewusstsein für Angriffsmethode.
- Erstellen Sie ein Power Automate Playbook für eine schnellere Korrektur. 

Die Aktivitäten nach dem Vorfall können auch dazu führen, dass Die Sicherheitskonfiguration und die Prozesse des Sicherheitsteams optimieren und die Reaktionsfunktionen Ihrer Organisation verbessert werden.

## <a name="next-step"></a>Nächster Schritt

Sehen Sie sich die folgenden zusätzlichen Untersuchungspfade an:

- [Phishing-E-Mail](first-incident-path-phishing.md)
- [Identitätsbasierter Angriff](first-incident-path-identity.md)
