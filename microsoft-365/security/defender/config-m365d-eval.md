...
Microsoft 365 Defender besteht aus vier Säulen. Obwohl eine Säule bereits einen Mehrwert für die Sicherheit Ihrer Netzwerkorganisation bieten kann, bietet die Aktivierung der vier Microsoft 365 Defender-Säulen Ihrer Organisation den größten Nutzen.
...
>[!NOTE]
>Überspringen Sie diesen Schritt, wenn Sie Defender for Office 365. 
...
10. Klicken **Einstellungen** klicken, und wählen Sie Ja aus, und verwenden Sie den **Standardbenachrichtigungstext,** um die Reaktion auf **schadsoftwareerkennung zu aktivieren.** Aktivieren Sie **den Filter für allgemeine Anlagentypen.** Klicken Sie auf **Speichern**.
...
12. Integrieren Sie Microsoft Defender for Office 365 in Microsoft Defender for Endpoint. Navigieren Sie [zu Office 365 Security & Compliance Center](https://protection.office.com/homepage)Threat Management Explorer, und wählen Sie Microsoft Defender for Endpoint Einstellungen in der oberen rechten Ecke des  >    >   Bildschirms  aus. Aktivieren Sie im Dialogfeld Verbindung mit Defender for Endpoint die **Verbinden Microsoft Defender for Endpoint**.
...
> [!NOTE]
> Überspringen Sie diesen Schritt, wenn Sie das Microsoft Cloud App Security. 
...
3. Wechseln Sie **zu Einstellungen**, aktivieren Sie den **Umschalter Microsoft Defender for Identity-Integration,** und klicken Sie dann auf **Speichern**. 
...
5. Onboarding Ihrer Endpunkte über Gruppenrichtlinien, Microsoft Endpoint Manager oder durch Ausführen eines lokalen Skripts in Microsoft Defender for Endpoint. Der Einfachheit halber verwendet dieses Handbuch das lokale Skript.
...
12. Besuchen Sie [Microsoft Defender Security Center](https://securitycenter.windows.com/). Wechseln Sie **zu Einstellungen,** und wählen Sie **dann Erweiterte Features aus.** 
...
>[!NOTE]
>Ab dem 1. Juni 2020 aktiviert Microsoft automatisch Microsoft 365 Defender-Features für alle berechtigten Mandanten. Weitere Informationen [finden Sie Community in](https://techcommunity.microsoft.com/t5/security-privacy-and-compliance/microsoft-threat-protection-will-automatically-turn-on-for/ba-p/1345426) diesem Microsoft Tech-Community-Artikel zur Lizenzberechtigung. 
...
![Screenshot of_Microsoft 365 Defender-Option auf der Microsoft 365 Security Center Einstellungen seite ](../../media/mtp-eval-72b.png) <br>

Eine umfassendere Anleitung finden Sie unter [Turn on Microsoft 365 Defender](m365d-enable.md). 

Glückwunsch! Sie haben gerade Ihre Microsoft 365 Testumgebung oder Pilotumgebung für Defender erstellt! Jetzt können Sie sich mit der benutzerdefinierten Microsoft 365 Von Defender vertraut machen! Erfahren Sie, was Sie aus den folgenden interaktiven Microsoft 365 von Defender lernen können, und erfahren Sie, wie Sie jedes Dashboard für Ihre täglichen Sicherheitsaufgaben verwenden.
...
- [Generieren einer Testwarnung](generate-test-alert.md) – Führen Sie eine Angriffssimulation in Microsoft 365 Defender-Testumgebung aus.