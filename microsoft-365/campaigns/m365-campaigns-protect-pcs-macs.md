...
## <a name="protect-a-computer-running-windows-10-or-a-mac"></a>Schützen eines Computers, auf dem Windows 10 oder einem Mac ausgeführt wird

<!--If you have a PC that is running Windows 10 that is not connected to Microsoft 365, or a Mac, the Microsoft 365 protections do not apply to it, but here are some things you can do to keep your data secure on these devices as well:
-->
Wenn Ihr Windows 10 oder Mac nicht von Ihrer Organisation verwaltet wird, müssen Sie diese Sicherheitsfunktionen konfigurieren.
...
Die Geräteverschlüsselung ist auf einer vielzahl von geräten Windows verfügbar und schützt Ihre Daten durch Verschlüsselung. Wenn Sie die Geräteverschlüsselung aktivieren, können nur autorisierte Personen auf Ihr Gerät und Ihre Daten zugreifen. Anweisungen [finden Sie unter Aktivieren der Geräteverschlüsselung.](https://support.microsoft.com/help/4028713/windows-10-turn-on-device-encryption)
 ...
 Wenn die Geräteverschlüsselung auf Ihrem Gerät nicht verfügbar ist, können Sie stattdessen [die Standardverschlüsselung BitLocker aktivieren.](https://support.microsoft.com/help/4028713/windows-10-turn-on-device-encryption) (BitLocker ist in der Windows 10 Home nicht verfügbar.) 

**Schützen Sie Ihr Gerät mit Windows-Sicherheit**<p>
Wenn Sie Windows 10 haben, erhalten Sie den neuesten Antivirenschutz mit Windows-Sicherheit. Wenn Sie das Windows 10 starten, ist Windows-Sicherheit aktiv und hilft aktiv, Ihren PC zu schützen, indem Sie nach Schadsoftware (Schadsoftware), Viren und Sicherheitsbedrohungen suchen. Windows-Sicherheit verwendet Echtzeitschutz, um alles zu überprüfen, was Sie auf Ihrem PC herunterladen oder ausführen.
...
Wenn Sie über eine frühere Version von Windows verfügen und Microsoft Security Essentials verwenden, sollten Sie zu Windows-Sicherheit. Weitere Informationen finden Sie unter [Hilfe zum Schutz meines](https://support.microsoft.com/help/17464/windows-10-help-protect-my-device-with-windows-security)Geräts mit Windows-Sicherheit .

**Aktivieren Windows Firewall**<p>
Sie sollten immer Windows Firewall ausführen, auch wenn eine andere Firewall aktiviert ist. Wenn Sie Windows Firewall deaktivieren, wird Ihr Gerät (und Ihr Netzwerk, falls Sie über eins verfügen) anfälliger für nicht autorisierten Zugriff. Anweisungen [finden Sie unter Windows Firewall ein- oder](https://support.microsoft.com/help/4028544/windows-10-turn-windows-defender-firewall-on-or-off) ausschalten.
