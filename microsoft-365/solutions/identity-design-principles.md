...
![Beispiel für whiteboardunterhaltung](../media/solutions-architecture-center/identity-beyond-whiteboard-example.png)
...
3. Nachdem alle Komponenten genehmigt wurden, bilden Sie diese zu einem einheitlichen Lieferumfang (Azure) [Microsoft Graph API](/azure/active-directory/develop/microsoft-graph-intro) ist Ihr bestes Freund dafür.  Nicht unmöglich, aber wesentlich komplexer, um eine Lösung zu entwerfen, die [mehrere Mandanten](/azure/active-directory/develop/single-and-multi-tenant-apps)umfasst.
...
![Allgemeine Übersicht über Azure-Komponenten für die delegierte Verwaltung](../media/solutions-architecture-center/identity-beyond-illustration-5.png)
