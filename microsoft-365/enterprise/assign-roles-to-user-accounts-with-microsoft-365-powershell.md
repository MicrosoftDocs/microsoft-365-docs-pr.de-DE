...
---
# <a name="assign-admin-roles-to-microsoft-365-user-accounts-with-powershell"></a>Zuweisen von Administratorrollen Microsoft 365 Benutzerkonten mit PowerShell

*Dieser Artikel gilt sowohl für Microsoft 365 Enterprise als auch für Office 365 Enterprise.*

Sie können Benutzerkonten problemlos Rollen zuweisen, indem Sie PowerShell für Microsoft 365.
...
Verwenden Sie zunächst ein globales Administratorkonto, um eine Verbindung [mit Ihrem Microsoft 365 herzustellen.](connect-to-microsoft-365-powershell.md#connect-with-the-azure-active-directory-powershell-for-graph-module)
...
Im Folgenden finden Sie ein Beispiel für einen abgeschlossenen Befehlssatz, der die Rolle SharePoint Dienstadministrator dem *\@ belindan-Contoso.com* zurkennt:
...
Verwenden Sie zunächst ein globales Administratorkonto, um eine Verbindung [mit Ihrem Microsoft 365 herzustellen.](connect-to-microsoft-365-powershell.md#connect-with-the-microsoft-azure-active-directory-module-for-windows-powershell)
...
Fügen Sie die Befehle in Editor. Ersetzen Sie *für $dispName* *und $roleName* den Beschreibungstext durch ihre Werte. Entfernen Sie die \< and > Zeichen, behalten Sie jedoch die Anführungszeichen bei. Fügen Sie die geänderten Zeilen in das Microsoft Azure Active Directory Module ein, Windows PowerShell sie ausführen können. Alternativ können Sie die Windows PowerShell ISE (Integrated Script Environment) verwenden.
...
- UPN des Benutzerkontos
  ...
  ```
    ...
    Dieser Befehl listet den UPN Ihrer Benutzerkonten, sortiert nach UPN, einen Bildschirm nach dem anderen auf. Sie können das **Cmdlet Where** verwenden, um die Liste zu filtern. Hier ist ein Beispiel:
...
Kopieren Sie die Befehle, und fügen Sie sie in Editor ein. Für die **$upnName** und **$roleName** Variablen. Ersetzen Sie den Beschreibungstext durch ihre Werte. Entfernen Sie die \< and > Zeichen, behalten Sie jedoch die Anführungszeichen bei. Fügen Sie die geänderten Zeilen in Microsoft Azure Active Directory Modul ein, Windows PowerShell, um sie ausführen zu können. Alternativ können Sie die ise-Windows PowerShell verwenden.
...
Erstellen Sie als Nächstes eine CSV-Textdatei (Comma-separated Value), die den Anzeigenamen oder upN- und Rollennamenfelder enthält. Sie können dies ganz einfach in Microsoft Excel.
