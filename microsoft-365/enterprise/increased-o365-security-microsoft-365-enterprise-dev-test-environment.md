...
2. Klicken Sie auf der neuen Registerkarte **Microsoft 365 Admin Center** auf **Admin Center > SharePoint**.
3. Klicken Sie auf der neuen Registerkarte **SharePoint Admin Center** auf **Zugriffssteuerung**.
...
## <a name="phase-3-examine-the-threat-management-dashboard"></a>Phase 3: Untersuchen des Dashboards für die Bedrohungs Verwaltung
