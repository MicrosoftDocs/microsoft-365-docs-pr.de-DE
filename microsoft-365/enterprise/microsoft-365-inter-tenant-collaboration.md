...
Nehmen wir an, dass zwei Organisationen, Fabrikam und Contoso, jeweils über eine Microsoft 365 business tenant verfügen und an mehreren Projekten zusammenarbeiten möchten. Einige werden für einen begrenzten Zeitraum ausgeführt, und einige davon sind noch nicht abgeschlossen. Wie können Fabrikam und Contoso ihren Personen und Teams eine effektivere Zusammenarbeit zwischen ihren verschiedenen mandanten Microsoft 365 ermöglichen? Microsoft 365 bietet in Verbindung mit Azure Active Directory (Azure AD) B2B-Zusammenarbeit mehrere Optionen. In diesem Artikel werden einige wichtige Szenarien beschrieben, die Fabrikam und Contoso in Betracht ziehen können.
  
Microsoft 365 optionen für die mandantenübergreifende Zusammenarbeit umfassen die Verwendung eines zentralen Speicherorts für Dateien und Unterhaltungen, das Freigeben von Kalendern, die Verwendung von Chats, Audio-/Videoanrufe für die Kommunikation und das Sichern des Zugriffs auf Ressourcen und Anwendungen. In den folgenden Tabellen können Sie Lösungen auswählen und auf weitere Informationen zugreifen.
...
## <a name="points-to-be-aware-of-about-microsoft-365-inter-tenant-collaboration"></a>Punkte, die sie über die zusammenarbeit Microsoft 365 Mandanten beachten sollten
...
Jede Organisation verwalte ihre eigenen Benutzerkonten, Identitäten, Sicherheitsgruppen, Abonnements, Lizenzen und Speicher. Die Benutzer verwenden die Features für die Zusammenarbeit in Microsoft 365 zusammen mit Freigaberichtlinien und Sicherheitseinstellungen, um den Zugriff auf die benötigten Informationen zu ermöglichen und gleichzeitig die Kontrolle über die Unternehmensressourcen zu erhalten.
...
- **&amp; Lizenzabonnements:** In Microsoft 365 ermöglichen Lizenzen von Lizenzierungsplänen (auch SKUs oder Microsoft 365-Pläne genannt) Benutzern Zugriff auf die Microsoft 365-Dienste, die für diese Pläne definiert sind. 
    
- **Storage:** In Microsoft 365 werden Softwarebeschränkungen und -beschränkungen für SharePoint Online getrennt von Postfachspeicherbeschränkungen verwaltet. Speicherbegrenzungen für Postfächer werden mit Exchange Online eingerichtet und verwaltet. In beiden Szenarien kann Speicher nicht mandantenübergreifend freigegeben werden. 
    
### <a name="can-we-share-domain-namespaces-across-microsoft-365-tenants"></a>Können wir Domänennamespaces für Microsoft 365 freigeben?

Nein. Organisationsdomänennamen, z. B. fabrikam.com oder tailspintoys.com, können nur einem einzelnen Mandanten zugeordnet und Microsoft 365 werden. Jeder Mandant muss über einen eigenen Namespace verfügen. UPN-, SMTP- und SIP-Namespaces können nicht mandantenübergreifend freigegeben werden.
  
### <a name="what-about-hybrid-components-and-microsoft-365-inter-tenant-collaboration"></a>Was ist mit Hybridkomponenten und Microsoft 365 Mandantenzusammenarbeit?
