...
ms.custom: ''
description: Informationen zu Identitätsoptionen und zum Konfigurieren von Azure AD Connect, um Ihre lokalen Active Directory Domain Services (AD DS) mit Azure AD zu synchronisieren.
...
In diesem Abschnitt synchronisieren Sie Ihre lokalen Active Directory Domain Services (AD DS) mit dem Azure Active Directory (Azure AD)-Mandanten, der von Ihren Office 365- Microsoft Intune- und anderen, in Microsoft 365 Enterprise-Abonnements enthaltenen cloudbasierten Diensten verwendet wird.
