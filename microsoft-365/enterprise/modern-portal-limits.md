---
title: SharePoint Beschränkungen für moderne Onlineportalwebsites
ms.author: kvice
...
---
# <a name="sharepoint-online-modern-portal-site-limits"></a>SharePoint Beschränkungen für moderne Onlineportalwebsites
...
- Laden Sie das Hosting gängiger statischer Dateien wie Bilder, Stylesheets und Skripts zu CDN
- Beschränken von Aufrufen SharePoint und externen Endpunkten auf das Erforderliche
- Vermeiden doppelter Anforderungen für denselben Inhalt

Viele der Richtlinien in diesem Artikel konzentrieren sich auf die Minimierung und Optimierung von Anrufen SharePoint Online. Wiederholte Aufrufe jedes Mal, wenn eine Seite geladen wird, beeinträchtigen die Leistung der Benutzer, da die Informationen jedes Mal vom Dienst abgerufen werden, auch wenn sie sich nicht geändert hat. Daher können Anforderungen an SharePoint entweder als Anrufe kategorisiert werden, die für alle Benutzer üblich sind, oder anrufe, die für jeden einzelnen Benutzer erforderlich sind. Die Ergebnisse dieser beiden Anrufkategorien sollten zwischengespeichert werden, um die Benutzeroberfläche zu optimieren.

>[!NOTE]
>Verwenden Sie das Tool "Seitendiagnose [für SharePoint als](./page-diagnostics-for-spo.md) Ausgangspunkt, um bestimmte Leistungsmetriken auf SharePoint Onlinewebsiteseiten zu analysieren.
...
|Webparts auf einer Seite  <br/> |20 pro Seite  <br/> |Es wird empfohlen, 20 oder weniger Webparts pro Seite insgesamt zu verwenden, einschließlich der einsatzfertigen Microsoft-Webparts und benutzerdefinierter Webparts. <br/> Weitere Informationen finden Sie unter [Optimieren der Web part-Leistung auf SharePoint modernen Online-Websiteseiten](modern-web-part-optimization.md).  <br/> |
|Dynamische Webparts auf einer Seite  <br/> |4 pro Seite  <br/> |Dynamische Webparts, die eine oder mehrere Abfragen an SharePoint, um die neuesten Daten zu abrufen, sollten auf 4 pro Seite beschränkt werden. Das  News-Webteil ist ein Beispiel für ein dynamisches Webteil. <br/> Weitere Informationen finden Sie unter [Optimieren der Web part-Leistung auf SharePoint modernen Online-Websiteseiten](modern-web-part-optimization.md).    <br/> |
...
|Aufrufe des Taxonomiediensts  <br/> |5 pro Benutzer pro Stunde  <br/> |Es wird empfohlen, keine Aufrufe pro _Anforderung_ an den Taxonomiedienst zu senden. Wenn Taxonomiedienstaufrufe erforderlich sind, speichern Sie die Informationen für die Wiederverwendung in derselben Sitzung zwischen. <br/> Weitere Informationen finden Sie unter [Optimize page calls in SharePoint Online modern and classic publishing site pages](modern-page-call-optimization.md). <br/> |
