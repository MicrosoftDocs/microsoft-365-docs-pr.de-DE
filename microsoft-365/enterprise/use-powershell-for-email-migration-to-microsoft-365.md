...
---
# <a name="how-to-use-powershell-to-migrate-email-to-microsoft-365"></a>Verwenden von PowerShell zum Migrieren von E-Mails zu Microsoft 365
...
- [Verwenden von PowerShell zum Ausführen einer IMAP-Migration zu Microsoft 365](use-powershell-to-perform-an-imap-migration-to-microsoft-365.md)
    
- [Verwenden von PowerShell zum Ausführen einer mehrstufigen Migration zu Microsoft 365](use-powershell-to-perform-a-staged-migration-to-microsoft-365.md)
