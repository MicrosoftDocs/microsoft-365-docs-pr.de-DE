...
f1.keywords:
- NOCSH
description: Office 365 setzt eine Internetverbindung voraus. Die unten aufgeführten Endpunkte sollten nur für Kunden erreichbar sein, die Office 365 Us.S. Government DoD-Pläne verwenden.
hideEdit: true
...
ms.locfileid: "52245324"
---
# <a name="office-365-us-government-dod-endpoints"></a>Office 365 DoD-Endpunkte der US-Regierung

*Gültig für Office 365 Admin*

 Office 365 setzt eine Internetverbindung voraus. Die unten aufgeführten Endpunkte sollten nur für Kunden erreichbar sein, die Office 365 Us.S. Government DoD-Pläne verwenden.
...
|||
|:-----|:-----|
|**Letzte Aktualisierung:** 29.04.2021 – ![RSS](../media/5dc6bb29-25db-4f44-9580-77c735492c4b.png) [Abonnement des Änderungsprotokolls](https://endpoints.office.com/version/USGOVDoD?allversions=true&format=rss&clientrequestid=b10c5ed1-bad1-445f-b386-b919946339a7) <br/> |**Download:** die vollständige Liste im [JSON-Format](https://endpoints.office.com/endpoints/USGOVDoD?clientrequestid=b10c5ed1-bad1-445f-b386-b919946339a7) <br/> |
...
- **ER**: Dies ist **Ja,** wenn der Endpunktsatz über Azure ExpressRoute mit Office 365 unterstützt wird. Die BGP-Community, die die angezeigten Routenpräfixe enthält, entspricht dem aufgelisteten Dienstbereich. Wenn ER **nein ist,** bedeutet dies, dass ExpressRoute für diesen Endpunktsatz nicht unterstützt wird. Es sollte jedoch nicht davon ausgegangen werden, dass keine Routen für einen Endpunktsatz angekündigt werden, bei dem ER Nein **ist.** Wenn Sie Planen der Verwendung von Azure [](/azure/active-directory/hybrid/reference-connect-instances#microsoft-azure-government) AD Verbinden, lesen Sie den Abschnitt spezielle Überlegungen, um sicherzustellen, dass Sie über die entsprechende Azure AD-Verbinden verfügen.
