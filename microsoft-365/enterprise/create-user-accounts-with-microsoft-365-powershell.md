...
|**UserPrincipalName** <br/> |Ja  <br/> |Dies ist der Kontoname, der für die Anmeldung bei Microsoft 365-Diensten verwendet wird. *CalebS contoso.onmicrosoft.com \@*.  <br/> |
|**FirstName** <br/> |Nein  <br/> ||
|**Nachname** <br/> |Nein  <br/> ||
|**LicenseAssignment** <br/> |Nein  <br/> |Dies ist der Lizenzierungsplan (auch als Lizenzplan oder SKU bezeichnet), aus dem dem Benutzerkonto eine verfügbare Lizenz zugewiesen wird. Die Lizenz definiert die Microsoft 365-Dienste, die für das Konto verfügbar sind. Sie müssen keine Lizenz einem Benutzer zuweisen, wenn Sie das Konto erstellen, aber das Konto muss über eine Lizenz für den Zugriff auf Microsoft 365-Dienste verfügen. Sie haben 30 Tage Zeit, um das Benutzerkonto zu lizenzieren, nachdem Sie es erstellt haben. |
...
|**UsageLocation** <br/> |Nein  <br/> |Dies ist ein gültiger ISO 3166-1-Alpha-2-Ländercode. Beispiel: *USA* für die USA und *FR* für Frankreich. Es ist wichtig, diesen Wert zur Verfügung zu stellen, da einige Microsoft 365-Dienste in bestimmten Ländern nicht verfügbar sind. Sie können einem Benutzerkonto nur dann eine Lizenz zuweisen, wenn dieser Wert für das Konto konfiguriert ist. Weitere Informationen finden Sie unter [Informationen zu Lizenzbeschränkungen](https://go.microsoft.com/fwlink/p/?LinkId=691730).<br/> |

>[!Note]
>[Erfahren Sie, wie Sie Benutzerkonten mithilfe](../admin/add-users/add-users.md) des Microsoft 365 Admin Centers erstellen.
> 
...
>[!Note]
>PowerShell Core unterstützt das Microsoft Azure Active Directory-Modul für Windows PowerShell und Cmdlets, die *Msol* im Namen haben, nicht. Führen Sie diese Cmdlets über Windows PowerShell aus.
>
...
In diesem Beispiel wird ein Konto für den US-Benutzer *Caleb Sills* erstellt und eine Lizenz aus dem `contoso:ENTERPRISEPACK` Lizenzierungsplan (Office 365 Enterprise E3) zugewiesen.
...
1. Erstellen Sie eine durch Kommata getrennte Wertedatei (CSV), die die erforderlichen Informationen zum Benutzerkonto enthält. Beispiel:
   ...
   >[!NOTE]
   >Die Spaltennamen und ihre Reihenfolge in der ersten Zeile der CSV-Datei sind beliebig. Stellen Sie jedoch sicher, dass die Reihenfolge der Daten in der restlichen Datei der Reihenfolge der Spaltennamen entspricht. Verwenden Sie die Spaltennamen für die Parameterwerte im PowerShell für Microsoft 365-Befehl.
...
3. Die Ergebnisse können Sie in der Ausgabedatei überprüfen. Wir haben keine Kennwörter angegeben, daher sind die zufälligen Kennwörter, die Von Microsoft 365 generiert wurden, in der Ausgabedatei sichtbar.
