...
4. Im Bereich **Mehrere Benutzer importieren** können Sie eine CSV-Beispieldatei mit oder ohne eingetragene Beispieldaten optional herunterladen.
    ...
    Ihre **Kalkulationstabelle** muss die exakt gleichen Spaltenüberschriften wie die erste Beispielüberschrift (Benutzername, Vorname und so weiter) enthalten. Wenn Sie die Vorlage verwenden, öffnen Sie sie in einem Textbearbeitungstool, z. B. Editor, und erwägen Sie, alle Daten in Zeile 1 allein zu lassen und nur Daten in den Zeilen 2 und darunter ein eingeben.
...
- **Welche Sprachen kann ich verwenden?** Beim Erstellen der Kalkulationstabelle können Sie Benutzerdatenspaltenbeschriftungen in beliebigen Sprachen oder Zeichen eingeben, aber Sie dürfen die Reihenfolge der Bezeichnungen nicht ändern, wie im Beispiel gezeigt. You can then make entries into the fields, using any language or characters, and save your file in a Unicode or UTF-8 format.
...
|:-----|:-----|
|Benutzername (erforderlich)  <br/> |79, einschließlich des At-Zeichens (@), im Format name@domain. \<extension\> . Der Alias des Benutzers darf 50 Zeichen nicht überschreiten, und der Domänenname darf 48 Zeichen nicht überschreiten.  <br/> |
|Vorname  <br/> |64  <br/> |
|Nachname  <br/> |64  <br/> |
...
[Hinzufügen von Benutzern einzeln oder in Massen zu Microsoft 365](/office365/admin/add-users/add-users)