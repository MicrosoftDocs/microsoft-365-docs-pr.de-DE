...
## <a name="office-365-portal-services-between-phase-2-and-phase-3"></a>Office 365 Portal Services zwischen Phase 2 und Phase 3

Zwischen Phase 2 und Phase 3 ist möglicherweise kein Zugriff auf das Partnerportal möglich. Während dieser Zeit kann der Partner möglicherweise nicht auf die Informationen des Mandanten im Partnerportal zugreifen. Da jede Migration anders abläuft, kann die Dauer die das Portal nicht erreichbar ist, Stunden betragen.
...
| Schritte: | Beschreibung | Auswirkung |
|:-------|:-------|:-------|
| Entfernen Sie Vertrauensstellungen der vertrauenden Gruppen aus Microsoft Cloud Deutschland AD FS. | Nach Abschluss des Umschnitts auf Azure AD verwendet die Organisation office 365-Dienste vollständig und ist nicht mehr mit Microsoft Cloud Deutschland verbunden. An diesem Punkt muss der Kunde die Vertrauensstellung der vertrauenden Gruppe zu den Microsoft Cloud Deutschland-Endpunkten entfernen. Dies kann nur geschehen, wenn keine Anwendung des Kunden auf Microsoft Cloud Deutschland-Endpunkte verweist, wenn Azure AD als Identitätsanbieter (IdP) genutzt wird. | Organisationen mit Verbundauthentifizierung | Keine |
||||
...
-->
**Gilt für:** Endbenutzer, deren Genehmigungsanforderungen für Azure AD-Gruppen in den letzten 30 Tagen vor der Migration nicht genehmigt wurden 

| Schritte: | Beschreibung | Auswirkung |
|:-------|:-------|:-------|
| Anforderungen für den Beitritt einer Azure AD-Gruppe in den letzten 30 Tagen vor der Migration müssen erneut durchgeführt werden, wenn die ursprüngliche Anforderung nicht genehmigt wurde. | Endbenutzerkunden müssen den Access-Bereich verwenden, um eine Anforderung zum erneuten Beitritt zu einer Azure AD-Gruppe zu übermitteln, wenn diese Anforderungen in den letzten 30 Tagen vor der Migration nicht genehmigt wurden. |  Als Endbenutzer: <ol><li>Navigieren Sie zum [Zugriffsbereich](https://account.activedirectory.windowsazure.com/r#/joinGroups).</li><li>Suchen Sie eine Azure AD-Gruppe, für die die Mitgliedschaftsgenehmigung während der 30 Tage vor der Migration aussteht.</li><li>Fordern Sie den Beitritt zur Azure AD-Gruppe erneut an.</li></ol> Anforderungen zum Beitreten zu einer Gruppe, die weniger als 30 Tage vor der Migration aktiv sind, können nicht genehmigt werden, es sei denn, sie werden nach der Migration erneut angefordert. |
||||
...
**Gilt für:**  Alle Kunden, die eine Aufbewahrungsrichtlinie im Rahmen von Schritten vor der Migration angewendet haben
