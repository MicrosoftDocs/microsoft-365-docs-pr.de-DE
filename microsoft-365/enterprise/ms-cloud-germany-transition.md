...
- Überprüfen Sie die Liste der Aktivitäten [vor der Arbeit](ms-cloud-germany-transition-add-pre-work.md) , um sicherzustellen, dass Ihre Organisation für die Änderungen informiert und vorbereitet ist.
...
Wenn Sie nur ein Azure-Kunde sind, können Sie die [Migration](https://docs.microsoft.com/azure/germany/germany-migration-main) ihrer Azure-Ressourcen in eine andere Region heute beginnen. 

Wenn Sie Azure mit Office 365, Dynamics 365 oder Power BI haben, müssen Sie den Migrationsprozess durchführen, um eine erfolgreiche Migration AzureAD, bevor Sie mit der Self-Directed Azure Migration beginnen. Sie müssen die Azure-Migration vor dem Dienst Abschluss durchführen, um Ihre Azure-Arbeitslasten mit ihrer AzureAD und Office 365 Organisation beizubehalten.
