...
Abrufen oder Aktualisieren von Informationen zu einem SharePoint Syntex-Dokumentverständnismodell mittels dem Modelltitel (siehe [Beispiel](rest-getbytitle-method.md#examples)).
...
Zum Abrufen ist kein Anforderungstext erforderlich.
...
### <a name="get-information-about-the-contoso-contract-model"></a>Informationen über das Contoso-Vertragsmodell abrufen

In diesem Beispiel lautet der Name des Syntex-Dokumentverständnismodells `Contoso Contract`.
...
### <a name="get-and-delete-the-contoso-contract-model-by-name"></a>Abrufen und Löschen des Contoso-Vertragsmodells anhand des Namens

In diesem Beispiel lautet der Name des Dokumentverständnismodells für den Contoso-Vertrag `Contoso Contract`.
