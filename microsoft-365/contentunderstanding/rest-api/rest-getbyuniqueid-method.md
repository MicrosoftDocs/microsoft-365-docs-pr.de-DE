...
Ruft Informationen zu einem SharePoint Syntex-Dokumentverständnismodell ab oder aktualisiert diese (siehe [Beispiel](rest-getbyuniqueid-method.md#examples)).
...
|-----|---|--------|----|-----------|
|modelUniqueId|Abfrage|True|Zeichenfolge|ID der Syntex-Modelldatei.|
...
### <a name="get-the-contoso-contract-model-by-id"></a>Erhalten des Contoso-Vertragsmodells anhand der ID
