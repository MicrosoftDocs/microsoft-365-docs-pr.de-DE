...
ms.locfileid: "53327059"
---
# <a name="introduction-to-microsoft-sharepoint-syntex"></a>Einführung in Microsoft SharePoint Syntex

SharePoint Syntex ist ein Microsoft 365-Dienst, der Unternehmen dabei unterstützt:
...
|Sehen Sie sich Beispielszenarien an, um Ihnen Ideen zur Verwendung von SharePoint Syntex in Ihrer Organisation zu geben |[Szenarien und Anwendungsfälle für SharePoint Syntex](./adoption-scenarios.md)| 
|Einrichten und Ausführen eines Testpilotprogramms für SharePoint Syntex |[Ausführen einer Testversion](./trial-syntex.md)|
...
| Diese Informationen finden Sie unter: | Hilfreiche Ressource: |
|:-----|:-----|
|Einrichten und Konfigurieren von SharePoint Syntex|[Einrichten von SharePoint Syntex](./set-up-content-understanding.md)|
...
|Anwenden einer Vertraulichkeitsbezeichnung auf Ihr Modell|[Anwenden einer Vertraulichkeitsbezeichnung auf ein Dokumentverständnismodell](./apply-a-sensitivity-label-to-a-model.md)|
