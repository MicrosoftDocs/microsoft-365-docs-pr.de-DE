...
4. Überprüfen Sie auf der nächsten Seite das Abonnement, und wählen Sie **Auschecken**aus.

5. Überprüfen Sie auf der nächsten Seite die Adresse **verkauft an** , die Informationen in **Rechnung** gestellt und die **Elemente in dieser Reihenfolge**. Wenn Sie Änderungen vornehmen müssen, wählen Sie **ändern** neben dem entsprechenden Abschnitt aus.

6. Wenn Sie fertig sind, wählen Sie **Vereinbarung annehmen & Bestellung aufgeben**aus.
...
2. Wählen Sie auf der Seite **Abonnements** die Schaltfläche **Jetzt kaufen** für das Testabonnement, das Sie kaufen möchten.

3. Überprüfen Sie die Preisinformationen, und wählen Sie **weiter**aus.

4. Geben Sie Ihre Zahlungsinformationen an, und wählen Sie dann **Bestellung aufgeben**aus.

5. Wählen Sie auf der Seite Bestätigung die Option **zu admin Home wechseln**aus.
...
4. Ihr Einkaufswagen wird geöffnet. Wenn Ihr Warenkorb nicht mehr auf dem Bildschirm angezeigt wird, wählen Sie **Warenkorb** aus, um ihn erneut zu öffnen, überprüfen Sie die Reihenfolge, und wählen Sie dann **Auschecken**aus.
...
2. Wählen Sie auf der Seite **Abonnement** die Option **Abonnements hinzufügen**aus.
    ...
    Es werden die für Ihre Organisation verfügbaren Abonnements angezeigt. Alle Abonnements, die Sie bereits erworben haben, werden als **in der Testversion** oder **gekauft**identifiziert.
  
3. Suchen Sie das Abonnement, das Sie kaufen möchten, und wählen Sie dann **Jetzt kaufen**aus.
  
4. Geben Sie die Anzahl der benötigten Benutzerlizenzen ein, wählen Sie aus, ob Sie monatlich oder für das ganze Jahr bezahlen möchten, und wählen Sie dann **zum Warenkorb hinzufügen**aus.

5. Ihr Einkaufswagen wird geöffnet. Wenn Ihr Warenkorb nicht mehr auf dem Bildschirm angezeigt wird, wählen Sie **Warenkorb** aus, um ihn erneut zu öffnen, überprüfen Sie die Reihenfolge, und wählen Sie dann **Auschecken**aus.

6. Überprüfen Sie die Preisinformationen, und wählen Sie **weiter**aus.

7. Geben Sie Ihre Zahlungsinformationen an, und wählen Sie dann **Bestellung aufgeben**aus.
