...
Um den Prozess zu beginnen, erhalten Sie die zugrunde liegende Arbeits- oder Schulkonto-ID. Diese Konto-ID ist anders als die E-Mail-Adresse, die Sie für den Zugriff auf Microsoft Teams verwenden.
...
Nachdem Sie das zugrunde liegende Arbeits- oder Schulkonto für Microsoft Teams haben, müssen Sie das Kennwort für das Konto zurücksetzen.
...
Verwenden Sie das zugrunde liegende Geschäfts- oder Schulkonto, das Sie wiederhergestellt haben, und Ihr neues Administratorkennwort, um ein Microsoft 365 business-Abonnement zu erwerben.
...
2. Suchen Sie Microsoft 365 Geschäftsprodukt, das Sie kaufen möchten.
    > [!IMPORTANT]
    > Achten Sie darauf, eine zu wählen, die Microsoft Teams.
3. Schließen Sie den Kauf ab. Denken Sie daran, genügend Lizenzen für alle Benutzer in Ihrer Microsoft Teams Kostenlose Organisation zu erwerben, die Sie nach Microsoft 365 unternehmen möchten.

## <a name="step-4-assign-new-licenses-to-users"></a>Schritt 4: Zuweisen neuer Lizenzen zu Benutzern

Nachdem Sie über ein neues Microsoft 365 business-Abonnement verfügen, können Sie den vorhandenen Benutzern in Ihrer Microsoft Teams Lizenzen zuweisen.
...
2. Wählen Sie die Benutzer aus, denen Sie Microsoft 365 unternehmenslizenzen zuweisen möchten, und wählen Sie **dann Produktlizenzen verwalten aus.**
3. Wählen Sie **im Bereich Produktlizenzen** verwalten die Option **Vorhandene Lizenzzuweisungen ersetzen aus.**
4. Suchen Sie **im** Bereich Vorhandene Produkte ersetzen nach dem Microsoft 365 business-Produkt, das Sie gekauft haben, und wechseln Sie zum Umschalten auf **Ein**.
5. Wählen **Sie Ersetzen** aus, und wählen Sie dann Schließen **aus.**

## <a name="related-content"></a>Verwandte Inhalte

[Willkommen bei Microsoft Teams](https://support.microsoft.com/office/6d79a648-6913-4696-9237-ed13de64ae3c) (Artikel)\
[Upgrade Microsoft Teams kostenlos auf Abonnementversion](/microsoftteams/upgrade-freemium) (Artikel)\
