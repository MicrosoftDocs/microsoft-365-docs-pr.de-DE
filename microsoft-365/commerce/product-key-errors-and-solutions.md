...
Wenn beim Versuch, einen Product Key für **Microsoft 365 for Business**einzulösen, eine Fehlermeldung angezeigt wird, versuchen Sie es mit den folgenden gängigen Lösungen: 
  
 **Benötigen Sie sofort Hilfe?** [Anruf beim Microsoft-Support](../admin/contact-support-for-business-products.md). 
  
 **Hilfe zu einer Microsoft 365-Produktfamilie oder einem persönlichen Product Key von Microsoft 365**finden Sie unter [Verwenden von Product Keys mit Office](https://support.office.com/article/12a5763a-d45c-4685-8c95-a44500213759.aspx).
  
## <a name="product-key-error-help-with-microsoft-365-for-business"></a>Produktschlüssel-Fehler Hilfe mit Microsoft 365 for Business
...
| "Sie haben mehr Lizenzen hinzugefügt als dieses Angebot zulässt. Die maximale Anzahl liegt bei \<x\> Benutzerlizenzen. Entfernen Sie diesen Product Key, und geben Sie einen ein, mit dem weniger Benutzerlizenzen hinzugefügt werden." | Wenden Sie sich an Ihren Händler oder Partner. Sie haben mehr Lizenzen erworben, als mit diesem Microsoft 365-Abonnement verwendet werden können. |
