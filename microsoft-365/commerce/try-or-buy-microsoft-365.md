...
> [!IMPORTANT]
> **Zahlungsoptionen für Office 365 betrieben von 21Vianet in China** Internationale Kreditkarten werden nicht akzeptiert. Sie können Ihr Abonnement wie folgt bezahlen:
>
> - Rechnung
> - Die Onlinezahlung mit Alipay oder China UnionPay Proof of Payment wird in Form von Fapiaos bereitgestellt. Sie können Ihre Fapiao-Anforderung etwa drei (3) Tage nach der Zahlung an unser [Fapiao-System](https://go.microsoft.com/fwlink/p/?LinkId=395314) übermitteln. Weitere Informationen finden Sie unter [Apply for a Fapiao for Office 365 operated by 21Vianet](../admin/services-in-china/apply-for-a-fapiao.md).
...
Sind Sie ein neuer Kunde und haben noch kein Konto bei Microsoft? Gehen Sie folgendermaßen vor, um ein Konto zu erstellen und sich für ein kostenloses Testabonnement von Microsoft 365 Business Standard, Microsoft 365 Business Premium oder Microsoft 365 Apps for Business zu registrieren.

1. Wechseln Sie zur <a href="https://www.aka.ms/office365signup" target="_blank">Website Microsoft 365 Produkte.</a>
2. Wählen Sie den Plan aus, für den Sie sich registrieren möchten, z. **B. Microsoft 365 Business Standard,** scrollen Sie die Seite nach unten, und wählen **Sie "Kostenlos testen" für 1 Monat** aus.
3. Führen Sie auf der nächsten Seite die Schritte zum Einrichten Ihres Kontos aus.
4. Der Registrierungsvorgang kann mehrere Minuten dauern. Nach \' Abschluss des Vorgangs können Sie den Setup-Assistenten für Ihr Abonnement starten. Weitere Informationen zum Einrichten Ihres Abonnements finden Sie unter ["Nächste Schritte".](#next-steps)

## <a name="buy-a-subscription-from-your-free-trial"></a>Abonnement aus Ihrer kostenlosen Testversion heraus erwerben

Am Ende des kostenlosen Testzeitraums wird Ihr Testabonnement automatisch in ein kostenpflichtiges Abonnement umgewandelt. Das kostenpflichtige Abonnement entspricht standardmäßig dem plan, den Sie derzeit haben. Sie können einen anderen Plan kaufen, indem Sie die Schritte unter ["Kaufen eines anderen Abonnements"](#buy-a-different-subscription)ausführen.

Wenn Sie Ihr Abonnement kaufen möchten, bevor Ihre Testversion beendet ist, führen Sie die folgenden Schritte aus:

1. Wechseln Sie im Microsoft 365 Admin Center zur Seite **"Abrechnung** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=842054" target="_blank">Für Ihre Produkte".</a>
...
Benötigen Sie vor dem Kauf mehr Zeit, um die Features von Microsoft 365 für Unternehmen auszuprobieren? Wenn Ihr Testabonnement innerhalb von 15 Tagen abläuft und vor Ablauf dieser Frist noch nicht verlängert wurde, können Sie Ihren Testzeitraum um weitere 30 Tage verlängern. Dies können Sie nur ein Mal durchführen.
...
Wenn Sie bereits über ein Microsoft 365 business-Abonnement verfügen, können Sie die Microsoft 365 Admin Center verwenden, um ein anderes Abonnement zu testen.

Wenn Sie ein Abonnement über die Microsoft 365 Admin Center hinzufügen, ist das neue Abonnement derselben Organisation (Domänennamespace) wie Ihr vorhandenes Abonnement zugeordnet. Diese Zuordnung erleichtert das Verschieben von Benutzern in Ihrer Organisation zwischen Abonnements oder das Zuweisen einer Lizenz für die zusätzlichen Produkte, die sie benötigen.

1. Wechseln Sie im Admin Center zur Seite **"Abrechnungskauf".** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=868433" target="_blank"></a>
...
4. Wählen Sie aus, ob Sie einen Text oder einen Anruf erhalten möchten, geben Sie Ihre Telefonnummer ein, und wählen Sie dann **"Text me"** oder **"Anruf" aus.**
...
7. Wählen Sie auf der Seite **"Bestellbestätigung"** die Option **"Weiter"** aus.
...
5. Geben Sie Ihre Zahlungsinformationen an, und wählen Sie dann **"Bestellung** \> **aufgeben" zu "Admin Home"** aus.

> [!NOTE]
> Sie müssen Benutzer von Ihrem kostenlosen Testabonnement in das neue Abonnement verschieben, bevor Die Nachfrist von 90 Tagen endet, nachdem Ihr Testabonnement abgelaufen ist. Auf diese Weise behalten Sie Ihre Daten, Konten und Konfiguration. Andernfalls werden diese Informationen gelöscht.

::: moniker range="o365-21vianet"

## <a name="payment-options"></a>Zahlungsoptionen

Sie können Ihr Abonnement wie folgt bezahlen:
...
Wenn Sie über ein neues Konto verfügen und Ihr erstes Abonnement einrichten, können Sie die Artikel zum geführten Setup verwenden, um Ihnen bei den ersten Schritten zu helfen.
...
Wenn Sie bereits über ein Abonnement verfügen und ein neues Abonnement hinzufügen, können Sie Benutzer dorthin verschieben. Weitere Informationen finden Sie unter [Verschieben von Benutzern in ein anderes Abonnement.](subscriptions/move-users-different-subscription.md)

## <a name="related-content"></a>Verwandte Inhalte

[Microsoft 365 für Business-Schulungsvideos](https://support.office.com/article/6ab4bbcd-79cf-4000-a0bd-d42ce4d12816) (Video)\
