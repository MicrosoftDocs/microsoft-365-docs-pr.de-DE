...
**Möchten Sie nur erfahren, wohin ein Rechnungsbetrag gesendet werden soll?** Wenn Sie Ihre Rechnung per Scheck oder über elektronische Überweisung bezahlen, lesen Sie [Wohin sende ich meinen Scheck oder die Zahlung per elektronischem Zahlungsverkehr?](#where-do-i-send-my-check-or-eft-payment)
...
Sie können Ihr Abonnement mit einer Kredit- oder Debitkarte oder über ein Bankkonto bezahlen. Wenn Sie mit einer dieser Zahlungsmethoden bezahlen, wird diese bis zum Ablauf oder der Kündigung des Abonnements bei fälligen Zahlungen belastet. Sie können [Zahlungsmethoden verwalten](manage-payment-methods.md), wann immer notwendig. Sie können auf Wunsch auch [eine Kopie Ihrer Rechnung per E-Mail erhalten](view-your-bill-or-invoice.md#receive-a-copy-of-your-billing-statement-in-email).

## <a name="paying-by-invoice"></a>Zahlung per Rechnung

In einigen Fällen können Sie für Ihr Abonnement per Rechnung mit Scheck oder über elektronische Überweisung bezahlen. Um zur Zahlung per Rechnung berechtigt zu sein, müssen Sie:
...
## <a name="what-if-i-have-an-outstanding-balance"></a>Was passiert, wenn noch eine Saldoforderung besteht?

Wenn keine Abbuchung über die angegebene Zahlungsmethode möglich ist, senden wir Ihnen eine E-Mail mit der Information, dass ein Problem vorliegt. In der E-Mail wird kurz erläutert, um welches Problem es sich handelt, und es ist ein Link zum Überprüfen des offenen Saldos enthalten. Es wird weiterhin über einen Zeitraum von 30 Tagen versucht, alle paar Tage die Transaktion durchzuführen. In diesem Zeitraum gilt für das Abonnement eine Nachfrist. Jedes Mal, wenn die Transaktion fehlschlägt, erhalten Sie eine E-Mail-Benachrichtigung dazu.

Wenn Sie die Zahlungsmethode, die einen Schuldsaldo aufweist, persönlich hinzugefügt haben, können Sie über die Option **Saldo ausgleichen** eine Zahlung vornehmen. Die Zahlungsmethode, die Sie zum Bezahlen des überfälligen Betrags verwenden, wird zur neuen Zahlungsmethode für alle Abonnements, für die die abgelehnte Zahlungsmethode verwendet wurde.

1. Wechseln Sie im Admin Center zur Seite **Abrechnung** > **Rechnungen und Zahlungen**, und wählen Sie dann die Registerkarte <a href="https://go.microsoft.com/fwlink/p/?linkid=2018806" target="_blank">Zahlungsmethoden</a> aus.
1. In einer Warnmeldung wird angezeigt, welche Zahlungsmethode abgelehnt wurde. Wählen Sie **Saldo ausgleichen** aus.
1. Wählen Sie im rechten Bereich eine andere Zahlungsmethode aus, oder klicken Sie auf **Zahlungsmethode hinzufügen**.
1. Nachdem Sie die Zahlungsmethodeninformationen aktualisiert haben, klicken Sie auf **Speichern**.

Wenn Sie die zum Bezahlen des Abonnements verwendete Zahlungsmethode nicht hinzugefügt haben, müssen Sie diese durch eine zuvor hinzugefügte oder eine neue Zahlungsmethode ersetzen.
...
[Überprüfen Sie Ihre Rechnung](view-your-bill-or-invoice.md) auf Zahlungsanweisungen. Sie können auch die Dropdownliste unten verwenden, um Zahlungsanweisungen für Ihr Land oder Ihre Region zu finden. Wenn Sie nicht genau wissen, wie hoch die offenen Forderungen sind, können Sie Ihre Rechnung und den Abrechnungsverlauf online auf der Registerkarte **Rechnungen** auf der Seite <a href="https://go.microsoft.com/fwlink/p/?linkid=2102895" target="_blank">Rechnungen und Zahlungen</a> überprüfen.
...
Sie können Ihre Rechnung nicht online bezahlen. Die Zahlung muss per Scheck oder elektronischer Überweisung erfolgen.
...
Sie können nicht automatisch von der Zahlung per Rechnung zu einer Zahlung mit einer anderen Zahlungsmethode wechseln. Stattdessen müssen Sie [ein anderes Abonnement kaufen](../try-or-buy-microsoft-365.md#buy-a-different-subscription), das mit einer Kreditkarte, EC-Karte oder einem Bankkonto bezahlt wird, [alle Benutzer in das neue Abonnement verschieben](../subscriptions/move-users-different-subscription.md) und dann [das alte Abonnement beenden](../subscriptions/cancel-your-subscription.md).
...
[Ihre Rechnung verstehen](understand-your-invoice2.md) (Artikel)
