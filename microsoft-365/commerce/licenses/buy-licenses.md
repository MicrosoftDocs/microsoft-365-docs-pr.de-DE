...
|Sie haben ein Testabonnement. |In einer Testversion von Microsoft 365 wird der Text "Trial" angezeigt. | Sie müssen zunächst Ihr Testabonnement kaufen und können dann weitere Lizenzen hinzufügen. Weitere Informationen finden Sie unter [erwerben eines Abonnements für Microsoft 365 for Business aus Ihrer kostenlosen Testversion](../buy-a-subscription-from-your-free-trial.md).|
...
- Sie müssen entweder ein globaler Administrator oder Rechnungsadministrator sein, um Lizenzen kaufen zu können. Weitere Informationen finden Sie unter [Informationen zu Administratorrollen](../../admin/add-users/about-admin-roles.md).
- Wenn Sie eine Lizenz erwerben und gleichzeitig einen neuen Benutzer zu Ihrem Abonnement hinzufügen möchten, finden Sie weitere Informationen unter [Hinzufügen von Benutzern einzeln oder in der Massen Version von Microsoft 365-Administratorhilfe](../../admin/add-users/add-users.md).
...
- Wenn Sie für Ihr Abonnement im Voraus mit einem Product Key bezahlt haben, können Sie weitere Lizenzen hinzufügen, indem Sie eine Kreditkarte oder ein Bankkonto zum Begleichen der zusätzlichen Kosten für die neuen Lizenzen hinzufügen. Nachdem Sie die neuen Lizenzen gekauft haben, wird ein zweites Abonnement mit der Anzahl der soeben erworbenen neuen Lizenzen hinzugefügt. Wenn Sie z. B. über ein im Voraus bezahltes Abonnement mit 5 Lizenzen verfügen und dann 10 weitere Lizenzen erworben haben, werden zwei Abonnements aufgeführt: eines mit den fünf im Voraus bezahlten Lizenzen und eines mit den 10 neuen Lizenzen.
