---
title: Konfigurieren SharePoint als Lerninhaltsquelle für Microsoft Viva Learning (Vorschau)
ms.author: chucked
...
ms.locfileid: "52782777"
---
# <a name="configure-sharepoint-as-a-learning-content-source-for-microsoft-viva-learning-preview"></a><span data-ttu-id="33ab6-103">Konfigurieren SharePoint als Lerninhaltsquelle für Microsoft Viva Learning (Vorschau)</span><span class="sxs-lookup"><span data-stu-id="33ab6-103">Configure SharePoint as a learning content source for Microsoft Viva Learning (Preview)</span></span>

> [!NOTE]
> <span data-ttu-id="33ab6-104">Dieses Feature ist in der Produktvorschau noch nicht verfügbar.</span><span class="sxs-lookup"><span data-stu-id="33ab6-104">This feature is not yet available in product preview.</span></span> 
