...
**Geräte Verwaltungsdienste und Sicherheitsfunktionen in Unternehmensklasse** :

- Unterstützt den Schutz vor externen Bedrohungen wie Phishing und ausgefeilte Schadsoftware mit Microsoft Defender für Office 365 Plan 1 und Microsoft Defender Exploit Guard.
...
**Vereinfachte Gerätebereitstellung und Benutzer Einrichtung** :
...
Microsoft 365 Business Premium kann über einen [Microsoft-Partner](https://www.microsoft.com/solution-providers/search) oder direkt von [Microsoft](https://www.microsoft.com//microsoft-365/business) erworben werden. Um auswählen, ob Sie das Produkt direkt von Microsoft oder über einen Microsoft-Partner erwerben, sollten Sie die Fähigkeiten Ihrer Mitarbeiter und den Erhalt Ihrer IT-Infrastruktur in Betracht ziehen. Ein Microsoft-Partner kann Ihnen bei der Bereitstellung und Verwaltung Ihrer IT-Infrastruktur einschließlich Microsoft-Lösungen helfen.
...
### <a name="is-there-a-cap-to-how-many-microsoft-365-business-premium-seats-a-customer-can-have"></a>Gibt es eine Obergrenze, von Microsoft 365 Business Premium Arbeitsplätzen, die ein Kunden erwerben kann?
...
Wenn die Hardware, die Sie aktuell ausführen Windows 7 Pro oder höher ist, sind die Mindestanforderungen für Microsoft 365 Business Premium wahrscheinlich erfüllt. Bestimmte Windows 10-Features wie Cortana, Windows Hello und Multi-Touch erfordern spezielle Hardware, die nur auf neueren PCs verfügbar ist. Weitere Informationen finden Sie unter der [Systemanforderungen für Windows 10 Pro](https://www.microsoft.com/windows/windows-10-specifications).

Auch die vorhandene Desktopanwendungskompatibilität (Win32) in Windows 10 ist hoch, und die meisten vorhandenen Anwendungen sollten ohne Änderungen funktionieren. Kunden und ihre vertrauenswürdigen IT-Ratgeber sollten den empfohlenen Prozess zum Testen von Anwendungen für die [Windows 10-Kompatibilität](https://docs.microsoft.com/windows/deployment/planning/windows-10-compatibility#recommended-application-testing-process) durchführen und die [Office-Systemanforderungen](https://products.office.com/office-system-requirements#subscription-plans-section) überprüfen, um einen reibungslosen Wechsel zu Microsoft 365 Business Premium sicherzustellen.
...
Microsoft 365 Business Premium steht allen Kunden und Partnern dort zur Verfügung, wo Office 365 verfügbar ist. Weitere Informationen finden Sie in der [Liste der internationalen Office 365-Verfügbarkeit für Sprachen, Ländern und Regionen](https://products.office.com/business/international-availability).
...
### <a name="what-should-customers-and-partners-know-before-running-microsoft-365-business-premium-within-their-organization"></a>Was sollten Kunden und Partner vor dem Ausführen von Microsoft 365 Business Premium innerhalb ihrer Organisation wissen?
...
### <a name="can-microsoft-365-business-premium-customers-use-microsoft-defender-for-endpoint"></a>Können Microsoft 365 Business Premium-Kunden Microsoft Defender für Endpoint verwenden?

Ja, Microsoft Defender for Endpoint steht als Add-on für Microsoft 365 Business Premium zur Verfügung, wenn es von einem [Microsoft Cloud Solution-Anbieter](https://partner.microsoft.com/membership/cloud-solution-provider/find-a-provider)erworben wurde.
...
IT-Dienstanbieter, die nicht bereits Microsoft-Partner sind, erfahren mehr über das Microsoft Cloud Solution Provider-Programm unter <https://partner.microsoft.com/membership/cloud-solution-provider>.
...
Microsoft bietet eine Vielzahl von Ressourcen für CSP-Partner, um Microsoft 365 Business Premium zu verkaufen, bereitzustellen und zu unterstützen. Sie finden sie unter <https://www.microsoft.com/microsoft-365/partners>.
...
### <a name="some-of-my-customers-have-devices-that-arent-genuine-will-microsoft-365-business-premium-make-these-devices-genuine"></a>Einige Kunden haben Geräte, die keine Originalversion sind; macht Microsoft 365 Business Premium diese Geräte zu einer Originalversion?
...
Die Datenschutz-Grundverordnung (General Data Protection Regulation, GDPR) ist ein umfassendes neues Datenschutzgesetz, das Kunden der Europäischen Union (EU) eine bessere Kontrolle über ihre „persönlichen Daten“ bietet und deren Integrität erfordert, um persönlichen Daten zu verwalten. Die DSGVO verlangt von Organisationen, die persönliche Daten kontrollieren oder steuern, die von EU-Mitgliedern stammen, dass diese nur Drittanbieter-Datenprozessoren verwenden, die den DSGVO-Anforderungen für die Verarbeitung persönlicher Daten entsprechen. März 2017 hat Microsoft vertragliche Garantien zur Verfügung gestellt, die diese Einhaltung garantieren. Kunden, die Fragen dazu haben, wie Microsoft Ihnen bei der Erfüllung ihrer zusätzlichen dsgvo-Verpflichtungen helfen kann, sollten sich über die erweiterten Konformitäts-und Sicherheitsfunktionen in Microsoft 365 Business Premium (beispielsweise Azure Information Protection, Verhinderung von Datenverlust, Defender für Office 365 usw.) und in anderen Suites (beispielsweise Microsoft 365 Enterprise E5) informieren. Weitere Informationen finden Sie auf [www.microsoft.com/gdpr](https://www.microsoft.com/gdpr).

## <a name="footnotes"></a>Fußnoten

<sup><a name="footnote1">**1**</a></sup> <small>Verfügbar in den USA, Kanada und Großbritannien.</small>
