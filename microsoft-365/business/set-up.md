...
Wenn Sie Microsoft 365 Business Premium erwerben, haben Sie die Möglichkeit, eine Domäne zu verwenden, die Sie besitzen, oder eine Domäne während der [Anmeldung zu erwerben.](sign-up.md)
...
Allen Benutzern, die Sie im Assistenten hinzufügen, wird automatisch eine Microsoft 365 Business Premium zugewiesen.

![Screenshot der Seite Neue Benutzer hinzufügen im Assistenten](../media/addnewuserspage.png)

1. Wenn Ihr Microsoft 365 Business Premium über vorhandene Benutzer verfügt (z. B. wenn Sie Azure AD Verbinden verwendet haben), erhalten Sie eine Option, um ihnen jetzt Lizenzen zu zuweisen. Setzen Sie den Vorgang fort, und fügen Sie ihnen Lizenzen hinzu.
...
1. Unter **Erhöhen des Schutzes** vor erweiterten Cyberbedrohungen wird empfohlen, dass Sie die Standardeinstellungen akzeptieren, um Office 365 [Advance Threat Protection](../security/office-365-security/defender-for-office-365.md) Dateien und Links in Office zu lassen.

    ![Screenshot der Seite Schutz erhöhen.](../media/increasetreatprotection.png)


2. Akzeptieren  Sie auf der Seite Datenlecks von vertraulichen Daten verhindern die Standardeinstellungen, um Office 365 Data Loss Prevention (DLP) zu aktivieren, um vertrauliche Daten in Office-Apps nachverfolgt und die versehentliche Freigabe dieser Daten außerhalb Ihrer Organisation zu verhindern.

3. Lassen Sie auf der Seite **Daten in Office** mobilen Apps schützen die Verwaltung mobiler Apps aktivieren, erweitern Sie die Einstellungen, und überprüfen Sie sie, und wählen Sie dann Verwaltungsrichtlinie für mobile Apps erstellen **aus.**
...
Wählen Sie im linken Navigations navi die Option **Setup** aus, und wählen Sie dann unter **Anmeldung** und Sicherheit die Option Ihre Windows 10 **aus.** Wählen **Sie Ansicht** aus, um zu beginnen. Vollständige [Anweisungen finden Sie unter Secure your Windows 10 computers.](secure-win-10-pcs.md)

## <a name="deploy-office-365-client-apps"></a>Bereitstellen Office 365 Client-Apps

Wenn Sie sich für die automatische Installation von Office-Apps während des Setups entschieden haben, werden die Apps auf den Windows 10-Geräten installiert, sobald sich die Benutzer über ihre Windows-Geräte mit ihren Arbeitsanmeldeinformationen bei Azure AD angemeldet haben.

Informationen zum Office auf mobilen iOS- oder Android-Geräten finden Sie unter Einrichten mobiler Geräte [für Microsoft 365 Business Premium Benutzer.](set-up-mobile-devices.md)
