...
---
# <a name="access-on-premises-resources-from-an-azure-ad-joined-device-in-microsoft-365-business-premium"></a>Zugriff auf lokale Ressourcen von einem Azure AD-beigetretenen Gerät in Microsoft 365 Business Premium

Dieser Artikel gilt für Microsoft 365 Business Premium.

Jedes Windows 10, dem Azure Active Directory beigetreten ist, hat Zugriff auf alle cloudbasierten Ressourcen, z. B. Ihre Microsoft 365-Apps, und kann durch Microsoft 365 Business Premium. Sie können auch zugriff auf lokale Ressourcen wie Branchen-Apps, Dateifreigaben und Drucker zulassen. Um den Zugriff zu ermöglichen, verwenden Sie [Azure AD Verbinden,](/azure/active-directory/connect/active-directory-aadconnect) um Ihr lokales Active Directory mit Azure Active Directory. 
...
2. Stellen Sie nach Abschluss der Verzeichnissynchronisierung sicher, dass die Windows 10 Azure AD beigetreten sind. Dieser Schritt wird auf jedem einzelnen Windows 10 durchgeführt. Weitere [Informationen finden Sie unter](set-up-windows-devices.md) Einrichten Windows für Microsoft 365 Business Premium Benutzer. 
    
3. Nachdem die Windows 10 Azure AD beigetreten sind, muss jeder Benutzer seine Geräte neu starten und sich mit seinen anmeldeinformationen Microsoft 365 Business Premium anmelden. Alle Geräte haben jetzt auch Zugriff auf lokale Ressourcen.
    
Es sind keine weiteren Schritte erforderlich, um Zugriff auf lokale Ressourcen für Azure AD-beigetretene Geräte zu erhalten. Diese Funktionalität ist in Windows 10. 
...
### <a name="considerations-when-you-join-windows-devices-to-azure-ad"></a>Überlegungen, wenn Sie Windows Azure AD beitreten

Wenn das Windows, dem Sie Azure-AD beigetreten sind, zuvor einer Domäne oder einer Arbeitsgruppe beigetreten ist, sollten Sie die folgenden Einschränkungen beachten:
...
[Voraussetzungen für Azure AD Verbinden](https://docs.microsoft.com/azure/active-directory/hybrid/how-to-connect-install-prerequisites)
